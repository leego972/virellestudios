...
export const FEATURE_REGISTRY: FeatureEntry[] = [
  ...
  },
  {
    ...
    icon: "🧭",
    category: "Production",
    webPath: "/projects/:id/command-center",
    description: "See what your film needs next at a glance",
    minTier: "amateur",
    hasNative: false,
    isNew: true,
  },
  {
    id: "byok-control-center",
    label: "BYOK Control Center",
    icon: "🔑",
    category: "Account",
    webPath: "/settings/byok",
    description: "Manage AI provider keys and generation preferences",
    minTier: "free",
    hasNative: false,
    isNew: true,
  },
  {
    ...
    icon: "🎯",
    category: "Production",
    webPath: "/projects/:projectId/pitch-deck",
    description: "Print-ready pitch deck for funders and partners",
    minTier: "independent",
    hasNative: false,
    isNew: true,
  },
