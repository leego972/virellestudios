...
// âââ Seed Data: Initial Actor Registry ââââââââââââââââââââââââââââââââââââââ
  ...
  export const INITIAL_ACTORS = [
    // ââ FLAGSHIP ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
    {
      ...
      variants: {"neutral":"/portraits/julian-vance/neutral.png","warm":"/portraits/julian-vance/warm.png","intense":"/portraits/julian-vance/intense.png"},
      identityLock: {"ageLock":"35-42","ethnicityLock":"British-Australian","eyeLock":"grey-green, deep-set, under strong brow","hairLock":"dark brown, swept back","skinLock":"fair Caucasian with natural texture","buildLock":"lean athletic 6'1\"","distinctiveLock":"fine scar above right eyebrow"},
    ...
    },
    {
      ...
      variants: {"neutral":"/portraits/elena-rostova/neutral.png","warm":"/portraits/elena-rostova/warm.png","intense":"/portraits/elena-rostova/intense.png"},
      identityLock: {"ageLock":"28-35","ethnicityLock":"Eastern European / Russian","eyeLock":"ice-blue, narrow, intense","hairLock":"platinum blonde, severe chignon","skinLock":"porcelain pale","buildLock":"slender, perfect posture","distinctiveLock":"razor-sharp cheekbones"},
    ...
    },
    {
      ...
      variants: {"neutral":"/portraits/sofia-reyes/neutral.png","warm":"/portraits/sofia-reyes/warm.png","intense":"/portraits/sofia-reyes/intense.png"},
      identityLock: {"ageLock":"28-34","ethnicityLock":"Latin American / Mexican-Brazilian","eyeLock":"dark brown almond-shaped","hairLock":"dark wavy chestnut, loose","skinLock":"tawny-olive warm","buildLock":"mid-height athletic","distinctiveLock":"full lips, strong cheekbones"},
    ...
    },
    {
      ...
      variants: {"neutral":"/portraits/kofi-adebayo/neutral.png","warm":"/portraits/kofi-adebayo/warm.png","intense":"/portraits/kofi-adebayo/intense.png"},
      identityLock: {"ageLock":"32-40","ethnicityLock":"West African / Ghanaian","eyeLock":"deep dark brown, intense","hairLock":"close-cropped natural","skinLock":"deep ebony","buildLock":"powerful broad-shouldered athletic","distinctiveLock":"strong square jaw"},
    ...
    // ââ CHILDREN & TEENS âââââââââââââââââââââââââââââââââââââââââââââââââââââ
    {
      ...
      priceCommercialAud: 9400,
      priceEpisodicAud: 6000,
      visualSpec: "8-year-old boy, East Asian heritage, bright curious eyes, messy black hair, gap-toothed smile, energetic and small build, dressed in a colorful striped t-shirt and denim overalls, photorealistic child features with natural skin texture and soft lighting",
      promptStyle: "bright naturalistic daylight, soft cinematic shadows, coming-of-age aesthetic",
      portraitUrl: "/portraits/leo-chen/master.png",
      variants: {"neutral":"/portraits/leo-chen/neutral.png","happy":"/portraits/leo-chen/happy.png"},
      identityLock: {"ageLock":"8","ethnicityLock":"East Asian","eyeLock":"dark brown, bright","hairLock":"black, messy","skinLock":"smooth natural child skin","buildLock":"small, energetic"},
      hook: "A spark of curiosity and childhood wonder for family dramas and adventure films.",
      tags: ["Family", "Adventure", "Child Actor"],
      chemistryWith: ["kenji-sato"],
      isActive: true,
      isFeatured: false,
      isRetired: false,
      allowCommercialUse: true,
    ...
    },
    {
      ...
      priceCommercialAud: 9400,
      priceEpisodicAud: 6000,
      visualSpec: "16-year-old girl, South Asian heritage, thoughtful expression, long dark braided hair, deep brown eyes, slender build, dressed in a modern school uniform with a blazer and tie, photorealistic teen features with natural skin texture",
      promptStyle: "soft morning light, academic setting, gentle cinematic shadows",
      portraitUrl: "/portraits/maya-patel/master.png",
      variants: {"neutral":"/portraits/maya-patel/neutral.png","thoughtful":"/portraits/maya-patel/thoughtful.png"},
      identityLock: {"ageLock":"16","ethnicityLock":"South Asian","eyeLock":"deep brown, expressive","hairLock":"dark, long braid","skinLock":"clear natural teen skin","buildLock":"slender"},
      hook: "The intellectual heart of teen dramas and coming-of-age stories.",
      tags: ["Teen", "Drama", "Coming-of-Age"],
      chemistryWith: ["priya-anand"],
      isActive: true,
      isFeatured: false,
      isRetired: false,
      allowCommercialUse: true,
    ...
    // ââ UNIQUE PHYSICALITY ââââââââââââââââââââââââââââââââââââââââââââââââââ
    {
      ...
      priceCommercialAud: 11800,
      priceEpisodicAud: 15600,
      visualSpec: "35-year-old man, Little Person (Achondroplasia), sharp features, short-cropped brown hair, blue eyes, dressed in a tailored professional suit, photorealistic features with micro-imperfections and realistic lighting",
      promptStyle: "high-contrast professional lighting, corporate noir aesthetic",
      portraitUrl: "/portraits/sam-miller/master.png",
      variants: {"neutral":"/portraits/sam-miller/neutral.png","determined":"/portraits/sam-miller/determined.png"},
      identityLock: {"ageLock":"35","ethnicityLock":"Caucasian","eyeLock":"blue, sharp","hairLock":"brown, short-cropped","skinLock":"natural adult skin","buildLock":"Little Person (Achondroplasia)"},
      hook: "A powerful, commanding presence for corporate drama and character-driven narratives.",
      tags: ["Corporate", "Drama", "Unique Physicality"],
      chemistryWith: ["celeste-vale"],
      isActive: true,
      isFeatured: true,
      isRetired: false,
      allowCommercialUse: true,
    ...
    },
    {
      ...
      priceCommercialAud: 11800,
      priceEpisodicAud: 15600,
      visualSpec: "28-year-old woman, extremely tall (6'8\"), athletic build, short platinum blonde hair, striking green eyes, dressed in high-fashion athletic gear, photorealistic features with natural skin texture and dramatic lighting",
      promptStyle: "dynamic action lighting, high-fashion aesthetic, sharp shadows",
      portraitUrl: "/portraits/tara-highsmith/master.png",
      variants: {"neutral":"/portraits/tara-highsmith/neutral.png","action":"/portraits/tara-highsmith/action.png"},
      identityLock: {"ageLock":"28","ethnicityLock":"Caucasian","eyeLock":"green, striking","hairLock":"platinum blonde, short","skinLock":"natural athletic skin","buildLock":"Extremely Tall (6'8\")"},
      hook: "A striking, formidable presence for action, sci-fi, and high-fashion storytelling.",
      tags: ["Action", "Sci-Fi", "High Fashion"],
      chemistryWith: ["viktor-saric"],
      isActive: true,
      isFeatured: true,
      isRetired: false,
      allowCommercialUse: true,
    ...
    // ââ GLOBAL ETHNICITIES ââââââââââââââââââââââââââââââââââââââââââââââââââ
    {
      ...
      priceCommercialAud: 17800,
      priceEpisodicAud: 39600,
      visualSpec: "45-year-old man, Arab heritage, distinguished features, salt-and-pepper beard, deep-set dark eyes, powerful build, dressed in a luxury silk thobe, photorealistic features with natural skin texture and warm cinematic lighting",
      promptStyle: "warm golden-hour lighting, luxury desert aesthetic, soft shadows",
      portraitUrl: "/portraits/omar-al-fayed/master.png",
      variants: {"neutral":"/portraits/omar-al-fayed/neutral.png","commanding":"/portraits/omar-al-fayed/commanding.png"},
      identityLock: {"ageLock":"45","ethnicityLock":"Arab","eyeLock":"dark, deep-set","hairLock":"salt-and-pepper, groomed beard","skinLock":"natural olive skin","buildLock":"powerful, authoritative"},
      hook: "A presence of immense wisdom and authority for political dramas and epic narratives.",
      tags: ["Drama", "Authority", "Global Lead"],
