...
export async function runAutoMigration(): Promise<void> {
  ...
  const newTables: TableDefinition[] = [
    ...
    },
    {
      ...
      // ─── v6.77 Designer Wardrobe (4 tables) ───
  ...
  const missingColumns: ColumnCheck[] = [
    ...
    // ── projects (auto-added missing columns) ──
    ...
    // ── characters (auto-added missing columns) ──
    ...
    // ── scenes (auto-added missing columns) ──
    ...
    // ── generationJobs (auto-added missing columns) ──
    ...
    // ── frameComments (auto-added missing columns) ──
    ...
    // ── scripts (auto-added missing columns) ──
    ...
    // ── soundtracks (auto-added missing columns) ──
    ...
    // ── credits (auto-added missing columns) ──
    ...
    // ── locations (auto-added missing columns) ──
    ...
    // ── moodBoardItems (auto-added missing columns) ──
    ...
    // ── subtitles (auto-added missing columns) ──
    ...
    // ── dialogues (auto-added missing columns) ──
    ...
    // ── budgets (auto-added missing columns) ──
    ...
    // ── soundEffects (auto-added missing columns) ──
    ...
    // ── collaborators (auto-added missing columns) ──
    ...
    // ── movies (auto-added missing columns) ──
    ...
    // ── directorChats (auto-added missing columns) ──
    ...
    // ── visualEffects (auto-added missing columns) ──
    ...
    // ── password_reset_tokens (auto-added missing columns) ──
    ...
    // ── blog_articles (auto-added missing columns) ──
    ...
    // ── referral_codes (auto-added missing columns) ──
    ...
    // ── referral_tracking (auto-added missing columns) ──
    ...
    // ── notifications (auto-added missing columns) ──
    ...
    // ── moderationIncidents (auto-added missing columns) ──
    ...
    // ── credit_transactions (auto-added missing columns) ──
    ...
    // ── projectSamples (auto-added missing columns) ──
    ...
    // ── marketing_settings (auto-added missing columns) ──
    ...
    // ── marketing_budgets (auto-added missing columns) ──
    ...
    // ── marketing_campaigns (auto-added missing columns) ──
    ...
    // ── marketing_content (auto-added missing columns) ──
    ...
    // ── marketing_performance (auto-added missing columns) ──
    ...
    // ── marketing_activity_log (auto-added missing columns) ──
    ...
    // ── content_creator_campaigns (auto-added missing columns) ──
    ...
    // ── content_creator_pieces (auto-added missing columns) ──
    ...
    // ── content_creator_schedules (auto-added missing columns) ──
    ...
    // ── content_creator_analytics (auto-added missing columns) ──
    ...
    // ── user_social_credentials (auto-added missing columns) ──
    ...
    // ── mailing_contacts (auto-added missing columns) ──
    ...
    // ── email_campaigns (auto-added missing columns) ──
    ...
    // ── campaign_send_log (auto-added missing columns) ──
    ...
    // ── funding_sources (auto-added missing columns) ──
    ...
    // ── film_mix_settings (auto-added missing columns) ──
    ...
    // ── film_adr_tracks (auto-added missing columns) ──
    ...
    // ── film_foley_tracks (auto-added missing columns) ──
    ...
    // ── film_score_cues (auto-added missing columns) ──
    ...
    // ── filmPages (auto-added missing columns) ──
    ...
    // ── promoAssets (auto-added missing columns) ──
    ...
    // ── creatorProfiles (auto-added missing columns) ──
    ...
    // ── collections (auto-added missing columns) ──
    ...
    // ── collectionItems (auto-added missing columns) ──
    ...
    // ── analyticsEvents (auto-added missing columns) ──
    ...
    // ── adminCurationFlags (auto-added missing columns) ──
    ...
    // ── submissionReviews (auto-added missing columns) ──
    ...
    // ── conversionEvents (auto-added missing columns) ──
    ...
    // ── abuseFlags (auto-added missing columns) ──
    ...
    // ── assetPurchases (auto-added missing columns) ──
    ...
    // ── signatureCastActors (auto-added missing columns) ──
    ...
    // ── signatureCastEntitlements (auto-added missing columns) ──
    ...
    // ── signatureCastEvents (auto-added missing columns) ──
    ...
    // ── featureCuts (auto-added missing columns) ──
    ...
    // ── featureCutScenes (auto-added missing columns) ──
    ...
    // ── actGroups (auto-added missing columns) ──
    ...
    // ── shotPackages (auto-added missing columns) ──
    ...
    // ── continuityRecords (auto-added missing columns) ──
    ...
    // ── featureAudioPlans (auto-added missing columns) ──
    ...
    // ── filmCompileJobs (auto-added missing columns) ──
    ...
    // ── characterArcs (auto-added missing columns) ──
    ...
    // ── shootDays (auto-added missing columns) ──
    ...
    // ── crewContacts (auto-added missing columns) ──
    ...
    // ── activityLog (auto-added missing columns) ──
    ...
    // ── approval_chain (auto-added missing columns) ──
    ...
    // ── asset_versions (auto-added missing columns) ──
    ...
    // ── recaps (auto-added missing columns) ──
    ...
    // ── recapSegments (auto-added missing columns) ──
    ...
    // ── creditReservations (auto-added missing columns) ──
    ...
    // ── projectBrands (auto-added missing columns) ──
    ...
    // ── designerProfiles (auto-added missing columns) ──
    ...
    // ── designerCollections (auto-added missing columns) ──
    ...
    // ── wardrobeItems (auto-added missing columns) ──
  ...
  try {
    ...
    if (rowCount > 94) {
      console.log(`[AutoMigrate] funding_sources has ${rowCount} rows (duplicates detected) — truncating and reseeding`);
      await db.execute(sql.raw(`TRUNCATE TABLE funding_sources`));
    } else if (rowCount === 94) {
      console.log(`[AutoMigrate] funding_sources already has 94 rows — skipping seed`);
      return;
    }
    ...
    // ─── Expansion pack: high-leverage global funders, US state offices, AI/Web3 rails, crowdfunding ───
    const expansionInserts: string[] = [
      // — US state film offices / production incentives
      `('United States (CA)', 'California Film Commission', 'State public agency', 'Film and TV production tax credit', 'Production', 'Tax credit', 'United States (CA)', 'https://film.ca.gov', 'CA tax credit program 4.0', 'Incentive / Commission Pack', 'English', 'California Film Commission — Application Pack', 'Applicant / Company | Project Title | Format / Genre / Runtime | Synopsis / Treatment | Producer Statement / Finance Strategy | Budget & Finance Plan | Schedule & Deliverables | Co-production / Eligibility | Declarations / Signatures', 'Application form; production company details; local spend budget; finance evidence; shooting schedule; script/treatment; vendor plan; residency/tax docs; incentive declarations', 'Use for rebates, commissions, and production incentives. Focus on eligible spend, local hires, schedule, and legal compliance.')`,
      `('United States (NY)', 'New York State Film Tax Credit', 'State public agency', 'Film/TV production', 'Production/Post', 'Tax credit', 'United States (NY)', 'https://esd.ny.gov/film-tax-credit-program', 'Up to 30% on qualified production costs', 'Incentive / Commission Pack', 'English', 'NY State Film Tax Credit — Application Pack', 'Applicant / Company | Project Title | Format / Genre / Runtime | Synopsis / Treatment | Producer Statement / Finance Strategy | Budget & Finance Plan | Schedule & Deliverables | Eligibility | Declarations / Signatures', 'Application form; production company details; local spend budget; finance evidence; shooting schedule; script/treatment; vendor plan; residency/tax docs; incentive declarations', 'Stress local hires, qualified post spend, schedule, and compliance.')`,
      `('United States (NY)', 'NYSCA Electronic Media & Film', 'State arts council', 'Independent film/media', 'Development/Production/Post', 'Grant', 'United States (NY)', 'https://arts.ny.gov', 'New York State Council on the Arts', 'Public Agency Pack', 'English', 'NYSCA Electronic Media & Film — Application Pack', 'Applicant / Company | Project Title | Format / Genre / Runtime | Logline | Synopsis / Treatment | Director Statement | Producer Statement / Finance Strategy | Creative Package & Key Team | Budget & Finance Plan | Schedule & Deliverables | Audience / Distribution / Impact | Declarations / Signatures', 'Application form; project narrative; statements; budget; finance plan; team bios; declarations', 'NY-based artists. Emphasize artistic merit and community impact.')`,
    ...
    for (const values of expansionInserts) {
      try {
        ...
        console.error(`[AutoMigrate] Funding expansion insert failed:`, insertErr.message);
      }
    }
    const [finalCount] = await db.execute(sql.raw(`SELECT COUNT(*) as cnt FROM funding_sources`)) as any;
    const total = finalCount?.[0]?.cnt ?? "?";
    console.log(`[AutoMigrate] Film funding sources seeded (${total} total sources with pack metadata, INSERT IGNORE)`);
  } catch (err: any) {
