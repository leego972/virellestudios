/**
 * v6.78 â Global Film & Cinema Funding Sources expansion
 ...
 *
 * Notes are kept neutral and funding-focused â no political commentary
 * (per brief).
 */
...
const ROWS: FundingRow[] = [
  /* ââ International / global âââââââââââââââââââââââââââââââââââââââ */
  ...
  { country: "International", organization: "SÃ¸rfond", type: "Public-interest film fund", supports: "Feature films from countries on DAC list", stage: "Production", fundingForm: "Grant", eligibility: "Director from eligible country, Norwegian co-producer required", officialSite: "https://sorfond.no/en", notes: "Run by Norwegian Film Institute and FilmFromSouth.", packType: "Co-Production Fund Pack", primaryLanguage: "English" },
  { country: "International", organization: "Hot DocsâBlue Ice Group Documentary Fund", type: "Documentary fund", supports: "Documentary projects by African filmmakers", stage: "Development/Production", fundingForm: "Grant", eligibility: "African filmmakers", officialSite: "https://hotdocs.ca/industry/funds-and-awards", notes: "Hot Docs runs several documentary funds and the Forum market.", packType: "Documentary Fund Pack", primaryLanguage: "English" },
  ...
  { country: "International", organization: "Cannes La Cinef / CinÃ©fondation Atelier", type: "Lab / market", supports: "Student short films and feature project labs", stage: "Development", fundingForm: "Selection / lab", eligibility: "Film schools and selected directors", officialSite: "https://www.festival-cannes.com/en/cinef", notes: "Atelier supports project finance during MarchÃ© du Film.", packType: "Market/Lab Pack", primaryLanguage: "English" },
  ...
  { country: "International", organization: "Tribeca Film Institute / Tribeca All Access (where active)", type: "Lab / fund", supports: "Underrepresented voices in narrative and documentary", stage: "Development", fundingForm: "Grant / lab", eligibility: "Open by call cycle; verify current programmes", officialSite: "https://tribecafilm.com/festival/about", notes: "Programme line-up changes year to year â verify current open calls.", packType: "Market/Lab Pack", primaryLanguage: "English" },
  ...
  /* ââ North America â United States ââââââââââââââââââââââââââââââââ */
  ...
  { country: "United States (California)", organization: "California Film Commission â Film & TV Tax Credit", type: "State tax incentive", supports: "Feature films, TV series, recurring TV, indie features", stage: "Production", fundingForm: "Tax credit", eligibility: "California production spend", officialSite: "https://film.ca.gov/tax-credit", notes: "Program 3.0 / 4.0 â verify current allocation cycle.", packType: "Tax Incentive Pack", primaryLanguage: "English" },
  ...
  /* ââ Canada (provinces missing from existing seed) ââââââââââââââââ */
  ...
  /* ââ United Kingdom / Ireland âââââââââââââââââââââââââââââââââââââ */
  ...
  { country: "Ireland", organization: "Screen Ireland / FÃ­s Ãireann", type: "National screen agency", supports: "Film, TV drama, animation, documentary, talent", stage: "Development/Production/Distribution", fundingForm: "Grant / loan", eligibility: "Irish production companies / co-productions", officialSite: "https://www.screenireland.ie", notes: "National film & TV development agency.", packType: "Public Agency Pack", primaryLanguage: "English" },

  /* ââ France âââââââââââââââââââââââââââââââââââââââââââââââââââââââ */
  { country: "France", organization: "CNC â Centre National du CinÃ©ma", type: "National public agency", supports: "Cinema, TV, animation, video games, immersive", stage: "Development/Production/Distribution/Exhibition", fundingForm: "Selective aid + automatic aid", eligibility: "French production / qualifying co-productions", officialSite: "https://www.cnc.fr/professionnels/aides-et-financements", notes: "Largest film funder in France.", packType: "Public Agency Pack", primaryLanguage: "French" },
  { country: "France (Ãle-de-France)", organization: "RÃ©gion Ãle-de-France â Aide aprÃ¨s rÃ©alisation / fonds de soutien", type: "Regional fund", supports: "Production filmed in Ãle-de-France", stage: "Production/Post-production", fundingForm: "Grant", eligibility: "Production spending in Ãle-de-France", officialSite: "https://www.iledefrance.fr/aide-aux-films", notes: "Several distinct schemes by format.", packType: "Public Agency Pack", primaryLanguage: "French" },
  { country: "France", organization: "ARTE France CinÃ©ma", type: "Broadcaster co-production", supports: "Auteur-driven feature films", stage: "Development/Production", fundingForm: "Co-production investment", eligibility: "Producers in coordination with French sales/distribution", officialSite: "https://cinema.arte.tv", notes: "Subsidiary of ARTE France focused on cinema co-production.", packType: "Streamer Commission Pack", primaryLanguage: "French" },
  { country: "France (PACA)", organization: "RÃ©gion Provence-Alpes-CÃ´te d'Azur â Aide cinÃ©ma", type: "Regional fund", supports: "Production filmed in PACA region", stage: "Development/Production", fundingForm: "Grant", eligibility: "Filming in PACA region", officialSite: "https://www.maregionsud.fr/aides-et-appels-a-projets/detail/aide-au-cinema-et-a-laudiovisuel", notes: "CNC-partnered regional aid (1 â¬ / 2 â¬ convention).", packType: "Public Agency Pack", primaryLanguage: "French" },

  /* ââ Germany (extras) âââââââââââââââââââââââââââââââââââââââââââââ */
  { country: "Germany", organization: "FFA â German Federal Film Board", type: "National public agency", supports: "Production, distribution, exhibition, sales", stage: "Production/Distribution", fundingForm: "Grant / loan", eligibility: "Productions registered in Germany", officialSite: "https://www.ffa.de/funding.html", notes: "Self-administered industry levy.", packType: "Public Agency Pack", primaryLanguage: "German" },
  { country: "Germany", organization: "DFFF â German Federal Film Fund", type: "National incentive", supports: "Theatrical films produced in Germany", stage: "Production", fundingForm: "Production grant (rebate)", eligibility: "Min German production spend", officialSite: "https://www.dfff-ffa.de/en.html", notes: "DFFF I and DFFF II for international co-productions.", packType: "Tax Incentive Pack", primaryLanguage: "German" },
  ...
  /* ââ Benelux ââââââââââââââââââââââââââââââââââââââââââââââââââââââ */
  ...
  { country: "Belgium (Wallonia)", organization: "Centre du CinÃ©ma et de l'Audiovisuel â FÃ©dÃ©ration Wallonie-Bruxelles", type: "Regional public fund", supports: "Film, documentary, TV", stage: "Development/Production", fundingForm: "Grant", eligibility: "Producers in Wallonia-Brussels Federation", officialSite: "https://audiovisuel.cfwb.be", notes: "Selective aid + co-production support.", packType: "Public Agency Pack", primaryLanguage: "French" },
  ...
  /* ââ Southern Europe ââââââââââââââââââââââââââââââââââââââââââââââ */
  { country: "Spain", organization: "ICAA â Instituto de la CinematografÃ­a y de las Artes Audiovisuales", type: "National public agency", supports: "Feature film, documentary, short, talent, distribution", stage: "Development/Production/Distribution", fundingForm: "Grant / selective aid", eligibility: "Spanish producers / qualifying co-productions", officialSite: "https://www.cultura.gob.es/cultura/areas/cine.html", notes: "Selective + automatic aid programmes.", packType: "Public Agency Pack", primaryLanguage: "Spanish" },
  { country: "Italy", organization: "Direzione Generale Cinema e Audiovisivo â MiC", type: "National public agency", supports: "Cinema and audiovisual production, development, distribution", stage: "Development/Production/Distribution", fundingForm: "Grant / tax credit", eligibility: "Italian productions / qualifying co-productions", officialSite: "https://cinema.cultura.gov.it", notes: "Includes selective contributions and tax credit.", packType: "Public Agency Pack", primaryLanguage: "Italian" },
  { country: "Italy", organization: "Istituto Luce CinecittÃ ", type: "Public producer / promoter", supports: "Italian cinema international promotion + co-production", stage: "Development/Production/Distribution", fundingForm: "Co-production / promotion", eligibility: "Italian and co-production projects", officialSite: "https://www.cinecittaluce.it", notes: "Linked to MiC; runs Italian Pavilion at major festivals.", packType: "Public Agency Pack", primaryLanguage: "Italian" },
  ...
  { country: "Croatia", organization: "Croatian Audiovisual Centre (HAVC)", type: "National screen agency", supports: "Feature film, documentary, animation, short, distribution", stage: "Development/Production/Distribution", fundingForm: "Grant + cash rebate", eligibility: "Croatian productions / qualifying co-productions", officialSite: "https://www.havc.hr/eng", notes: "Operates national 25â30 % cash rebate.", packType: "Public Agency Pack", primaryLanguage: "Croatian" },
  ...
  /* ââ Central / Eastern Europe âââââââââââââââââââââââââââââââââââââ */
  ...
  /* ââ Australia / NZ (state extras) ââââââââââââââââââââââââââââââââ */
  ...
  /* ââ East Asia ââââââââââââââââââââââââââââââââââââââââââââââââââââ */
  ...
  { country: "Japan", organization: "Agency for Cultural Affairs â Japanese Film Production Support", type: "Government cultural agency", supports: "Japanese feature films and documentaries", stage: "Production", fundingForm: "Grant", eligibility: "Japanese producers", officialSite: "https://www.bunka.go.jp/english/", notes: "Bunka-cho administers cultural-affairs support including film.", packType: "Public Agency Pack", primaryLanguage: "Japanese" },
  ...
  /* ââ South / Southeast Asia âââââââââââââââââââââââââââââââââââââââ */
  ...
  { country: "Thailand", organization: "Thailand Film Office â Production Incentive", type: "National incentive", supports: "International film, TV, streaming productions", stage: "Production", fundingForm: "Cash rebate", eligibility: "Min Thai production spend", officialSite: "https://thailandfilmoffice.go.th", notes: "Cash rebate scheme administered by Department of Tourism.", packType: "Tax Incentive Pack", primaryLanguage: "English" },
  { country: "Malaysia", organization: "FINAS â National Film Development Corporation Malaysia", type: "National screen agency", supports: "Local film + Film in Malaysia Incentive (FIMI)", stage: "Production", fundingForm: "Grant + cash rebate", eligibility: "Malaysian producers / international productions filming in Malaysia", officialSite: "https://www.finas.gov.my/en/film-in-malaysia-incentive-fimi", notes: "30 % cash rebate via FIMI.", packType: "Public Agency Pack", primaryLanguage: "English" },
  ...
  /* ââ Middle East / North Africa (extras) ââââââââââââââââââââââââââ */
  ...
  { country: "Saudi Arabia", organization: "Saudi Film Commission â Daw'i / Production Incentive", type: "Government film commission", supports: "Saudi and international films/series shooting in KSA", stage: "Production", fundingForm: "Cash rebate / grant", eligibility: "KSA-qualified production spend", officialSite: "https://film.moc.gov.sa/en", notes: "40 % production cash rebate scheme.", packType: "Tax Incentive Pack", primaryLanguage: "English" },
  { country: "United Arab Emirates", organization: "Abu Dhabi Film Commission â Production Rebate", type: "Government incentive", supports: "Films, TV, web series shooting in Abu Dhabi", stage: "Production", fundingForm: "Cash rebate", eligibility: "Abu Dhabi-qualified spend", officialSite: "https://film.gov.ae", notes: "Up to 30 % cash-back rebate.", packType: "Tax Incentive Pack", primaryLanguage: "English" },
  ...
  { country: "Jordan", organization: "Royal Film Commission â Jordan", type: "Government film commission", supports: "Local + international productions in Jordan", stage: "Development/Production", fundingForm: "Grant + cash rebate", eligibility: "Jordan-qualified spend", officialSite: "https://film.jo", notes: "Operates national cash rebate up to 25 %.", packType: "Public Agency Pack", primaryLanguage: "English" },
  { country: "MENA", organization: "AFAC â Arab Fund for Arts and Culture (Cinema Programs)", type: "Regional cultural fund", supports: "Arab cinema: documentary and narrative", stage: "Development/Production/Post-production", fundingForm: "Grant", eligibility: "Arab filmmakers", officialSite: "https://www.arabculturefund.org", notes: "Includes Arab Documentary Film Program with IDFA Bertha and Sundance.", packType: "Public Agency Pack", primaryLanguage: "Arabic" },
  ...
  { country: "Israel", organization: "CoPro â Documentary Marketing Foundation", type: "Documentary market / forum", supports: "Israeli and international documentary projects", stage: "Development/Production", fundingForm: "Pitching forum / market", eligibility: "Selected projects via annual open call", officialSite: "https://copro.co.il", notes: "Annual CoPro pitching forum brings international commissioners to Tel Aviv.", packType: "Documentary Fund Pack", primaryLanguage: "English" },
  { country: "Israel", organization: "Docaviv Industry â Tel Aviv International Documentary Film Festival", type: "Festival industry / market", supports: "Israeli documentary projects (selected)", stage: "Development/Post-production", fundingForm: "Awards / market access", eligibility: "Selected Israeli documentary projects", officialSite: "https://www.docaviv.co.il/en", notes: "Industry programme runs alongside the Docaviv festival each spring.", packType: "Documentary Fund Pack", primaryLanguage: "English" },

  /* ââ Africa âââââââââââââââââââââââââââââââââââââââââââââââââââââââ */
  ...
  { country: "Senegal", organization: "FOPICA â Fonds de Promotion de l'Industrie CinÃ©matographique et Audiovisuelle", type: "National film fund", supports: "Senegalese cinema and audiovisual production", stage: "Development/Production/Post-production", fundingForm: "Grant", eligibility: "Senegalese filmmakers and producers", officialSite: "https://www.culture.gouv.sn", notes: "Administered under the Ministry of Culture.", packType: "Public Agency Pack", primaryLanguage: "French" },
  ...
  { country: "International (Africa)", organization: "Realness Institute â Episodic Lab / Screenwriters' Residency", type: "Lab / residency", supports: "African screenwriters and directors", stage: "Development", fundingForm: "Lab / residency", eligibility: "African filmmakers via open call", officialSite: "https://realness.institute", notes: "Multi-programme institute supporting African storytelling.", packType: "Market/Lab Pack", primaryLanguage: "English" },

  /* ââ Latin America / Caribbean ââââââââââââââââââââââââââââââââââââ */
  ...
  { country: "Chile", organization: "Fondo Audiovisual â Ministerio de las Culturas, las Artes y el Patrimonio", type: "National public fund", supports: "Chilean audiovisual production, training, distribution, exhibition", stage: "Development/Production/Distribution", fundingForm: "Grant", eligibility: "Chilean producers / qualifying co-productions", officialSite: "https://www.cultura.gob.cl/fondos/fondo-audiovisual", notes: "Annual open call; multiple categories.", packType: "Public Agency Pack", primaryLanguage: "Spanish" },
  { country: "Colombia", organization: "ProimÃ¡genes Colombia â Fondo para el Desarrollo CinematogrÃ¡fico (FDC)", type: "National public fund", supports: "Colombian feature film, documentary, short, distribution", stage: "Development/Production/Distribution", fundingForm: "Grant", eligibility: "Colombian producers / qualifying co-productions", officialSite: "https://www.proimagenescolombia.com/secciones/fdc", notes: "Operates alongside CINA / FILMA cash-rebate schemes.", packType: "Public Agency Pack", primaryLanguage: "Spanish" },
  { country: "Mexico", organization: "IMCINE â Instituto Mexicano de CinematografÃ­a", type: "National screen agency", supports: "Feature film, documentary, short, talent, distribution", stage: "Development/Production/Distribution", fundingForm: "Grant", eligibility: "Mexican producers / qualifying co-productions", officialSite: "https://www.imcine.gob.mx", notes: "Administers Foprocine, Fidecine and other federal cinema funds.", packType: "Public Agency Pack", primaryLanguage: "Spanish" },
  { country: "Mexico", organization: "EFICINE â EstÃ­mulo Fiscal a la Industria CinematogrÃ¡fica", type: "Federal tax incentive", supports: "Mexican feature film, distribution and exhibition", stage: "Production/Distribution", fundingForm: "Tax incentive", eligibility: "Eligible Mexican audiovisual projects", officialSite: "https://www.imcine.gob.mx/cine-mexicano/eficine-produccion", notes: "Tax-incentive scheme run by SHCP via IMCINE.", packType: "Tax Incentive Pack", primaryLanguage: "Spanish" },
  { country: "Uruguay", organization: "ICAU â Instituto del Cine y el Audiovisual del Uruguay", type: "National screen agency", supports: "Uruguayan film and audiovisual production", stage: "Development/Production/Distribution", fundingForm: "Grant + Programa Uruguay Audiovisual incentive", eligibility: "Uruguayan producers / qualifying co-productions", officialSite: "https://www.icau.mec.gub.uy", notes: "Administers PUA cash rebate alongside selective grants.", packType: "Public Agency Pack", primaryLanguage: "Spanish" },
  { country: "Peru", organization: "DAFO â DirecciÃ³n del Audiovisual, la FonografÃ­a y los Nuevos Medios", type: "National public agency", supports: "Peruvian feature film, documentary, short", stage: "Development/Production", fundingForm: "Grant", eligibility: "Peruvian producers / qualifying co-productions", officialSite: "https://dafo.cultura.pe", notes: "Part of the Peruvian Ministry of Culture.", packType: "Public Agency Pack", primaryLanguage: "Spanish" },
  { country: "Costa Rica", organization: "El Fauno / Proartes â Fondo El Fauno", type: "National cultural fund", supports: "Costa Rican audiovisual development, production, post", stage: "Development/Production/Post-production", fundingForm: "Grant", eligibility: "Costa Rican producers / qualifying co-productions", officialSite: "https://www.centrodecine.go.cr/fauno", notes: "Operated by Centro Costarricense de ProducciÃ³n CinematogrÃ¡fica.", packType: "Public Agency Pack", primaryLanguage: "Spanish" },
  { country: "Dominican Republic", organization: "DGCINE â DirecciÃ³n General de Cine (Dominican Republic)", type: "National public agency", supports: "Dominican audiovisual sector + transferable tax credit (Law 108-10)", stage: "Development/Production", fundingForm: "Grant + transferable tax credit", eligibility: "Dominican productions / qualifying co-productions or international productions filming locally", officialSite: "https://www.dgcine.gob.do", notes: "Law 108-10 provides a 25 % transferable tax credit.", packType: "Tax Incentive Pack", primaryLanguage: "Spanish" },
...
function packTitle(row: FundingRow): string {
  return `${row.organization} â Application Pack`;
}
...
export async function seedGlobalFundingV678(db: any): Promise<void> {
  try {
    ...
    // array sits at index 0 of the destructured result â same pattern
    ...
    if (markerHit) {
      logger.info(
        `[AutoMigrate] v6.78 global funding seed already applied â skipping (${ROWS.length} sources already present).`,
      );
      return;
    }
    ...
    const total =
      ...
      "?";
    logger.info(
      `[AutoMigrate] v6.78 global film funding seed complete â attempted ${ROWS.length} inserts (${failed} errors); funding_sources now has ${total} total rows.`,
    );
  } catch (err: any) {
    logger.error(
