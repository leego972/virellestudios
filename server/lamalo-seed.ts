/**
  ...
  const womensFormal: SeedCollection = {
    ...
    items: [
      { name: "Lamalo Structured Blazer", description: "Sharp single-button blazer in Italian crepe with structured shoulders and a fitted waist.", category: "formalwear", subcategory: "blazers", genderFit: "female", colors: ["White","Camel","Black"], materials: ["Italian Crepe"], styleTags: ["blazer","structured","luxury"], leasePriceAud: 1800, retailPriceAud: 40000, referencePrompt: "Women's structured blazer white Italian crepe sharp", primaryImageUrl: "/lamalo/women-blazer.jpg" },
      { name: "Lamalo Wide-Leg Formal Trouser", description: "Wide-leg formal trouser in premium crepe with a high waist and clean-pressed front crease.", category: "bottoms", subcategory: "dress-trousers", genderFit: "female", colors: ["White","Black","Champagne"], materials: ["Premium Crepe"], styleTags: ["formal","wide-leg","luxury"], leasePriceAud: 1500, retailPriceAud: 25000, referencePrompt: "Women's wide leg formal trouser white premium crepe", primaryImageUrl: "/lamalo/women-wide-leg-pants.jpg" },
      { name: "Lamalo Pure Silk Blouse", description: "Pure silk blouse with mother-of-pearl buttons, a soft drape and a relaxed tuck-in silhouette.", category: "tops", subcategory: "blouses", genderFit: "female", colors: ["Ivory","Blush","White"], materials: ["100% Pure Silk"], styleTags: ["silk","blouse","luxury"], leasePriceAud: 1600, retailPriceAud: 20000, referencePrompt: "Women's pure silk blouse ivory elegant formal", primaryImageUrl: "/lamalo/women-silk-blouse.jpg" },
      { name: "Lamalo Cashmere Sweater", description: "Fine-gauge cashmere crew-neck sweater with a relaxed drape and minimal detailing.", category: "tops", subcategory: "knitwear", genderFit: "female", colors: ["Cream","Black","Navy"], materials: ["100% Cashmere"], styleTags: ["cashmere","luxury","knitwear"], leasePriceAud: 1800, retailPriceAud: 30000, referencePrompt: "Women's fine cashmere crew neck sweater cream", primaryImageUrl: "/lamalo/women-silk-blouse.jpg" },
      { name: "Lamalo Tailored Coat", description: "Long single-breasted coat in premium wool blend with a clean lapel and back vent.", category: "outerwear", subcategory: "coats", genderFit: "female", colors: ["Camel","Black","Navy"], materials: ["70% Wool","30% Polyester"], styleTags: ["coat","luxury","tailored"], leasePriceAud: 2500, retailPriceAud: 60000, referencePrompt: "Women's long tailored coat camel wool blend premium", primaryImageUrl: "/lamalo/women-blazer.jpg" },
      { name: "Lamalo Satin Slip Dress", description: "Bias-cut satin slip dress with thin adjustable straps and a subtle back split. Timeless elegance.", category: "dresses", subcategory: "evening-dresses", genderFit: "female", colors: ["Black","Ivory","Champagne"], materials: ["Polyester Satin"], styleTags: ["slip-dress","satin","evening"], leasePriceAud: 1500, retailPriceAud: 25000, referencePrompt: "Women's satin slip dress black bias cut elegant formal", primaryImageUrl: "/lamalo/women-linen-dress.jpg" },
      { name: "Lamalo Pleated Midi Skirt", description: "Pleated crepe midi skirt with an elasticated waist and a graceful swirl silhouette.", category: "bottoms", subcategory: "skirts", genderFit: "female", colors: ["Black","Ivory","Blush"], materials: ["Premium Crepe"], styleTags: ["pleated","midi","elegant"], leasePriceAud: 1400, retailPriceAud: 20000, referencePrompt: "Women's pleated midi skirt black crepe elegant", primaryImageUrl: "/lamalo/women-wide-leg-pants.jpg" },
    ],
  };
  ...
  const womensSwimwear: SeedCollection = {
    ...
    collectionPriceAud: 5500,
    items: [
      { name: "Lamalo Classic One-Piece", description: "Scoop-neck one-piece swimsuit with a low back and clean lines. Chlorine-resistant fabric.", category: "swimwear", subcategory: "one-piece", genderFit: "female", colors: ["Black","Cobalt Blue","Sage"], materials: ["80% Nylon","20% Elastane Chlorine-Resistant"], styleTags: ["one-piece","classic","elegant"], leasePriceAud: 800, retailPriceAud: 10000, referencePrompt: "Women's classic one piece swimsuit black low back elegant", primaryImageUrl: "/lamalo/swimwear-women-onepiece.jpg" },
      { name: "Lamalo Triangle Bikini", description: "Adjustable triangle top and low-rise brief bottom in recycled nylon. Minimal and versatile.", category: "swimwear", subcategory: "bikinis", genderFit: "female", colors: ["Cobalt Blue","Terracotta","Sage","Black"], materials: ["Recycled Nylon/Elastane"], styleTags: ["bikini","triangle","minimal"], leasePriceAud: 750, retailPriceAud: 9000, referencePrompt: "Women's triangle bikini set cobalt blue top and brief", primaryImageUrl: "/lamalo/swimwear-women-bikini.jpg" },
      { name: "Lamalo Modest Long-Sleeve Swimsuit", description: "Long-sleeve modest one-piece with UPF50+ protection. Full coverage, modern style.", category: "swimwear", subcategory: "one-piece", genderFit: "female", colors: ["Navy/White","Sage","Black"], materials: ["UPF50+ Nylon/Elastane"], styleTags: ["modest","UPF","coverage"], leasePriceAud: 900, retailPriceAud: 11000, referencePrompt: "Women's modest long sleeve swimsuit navy white UPF50", primaryImageUrl: "/lamalo/swimwear-women-modest.jpg" },
      { name: "Lamalo Ruched One-Piece", description: "Ruched one-piece with a flattering gathered front panel and adjustable straps.", category: "swimwear", subcategory: "one-piece", genderFit: "female", colors: ["Blush","Black","White"], materials: ["Nylon/Spandex"], styleTags: ["ruched","one-piece","flattering"], leasePriceAud: 850, retailPriceAud: 10500, referencePrompt: "Women's ruched one piece swimsuit blush gathered front", primaryImageUrl: "/lamalo/swimwear-women-onepiece.jpg" },
      { name: "Lamalo Sporty Bikini Set", description: "Sporty crop-top bikini with a supportive wired cup and matching high-waist brief.", category: "swimwear", subcategory: "bikinis", genderFit: "female", colors: ["Black","Cobalt Blue","White"], materials: ["Recycled Nylon/Elastane"], styleTags: ["bikini","sporty","high-waist"], leasePriceAud: 750, retailPriceAud: 9000, referencePrompt: "Women's sporty crop bikini set black high waist", primaryImageUrl: "/lamalo/swimwear-women-bikini.jpg" },
      { name: "Lamalo Floral Bikini", description: "Tropical floral-print bikini with an underwire push-up top and tie-side bottoms.", category: "swimwear", subcategory: "bikinis", genderFit: "female", colors: ["Tropical Print","Cobalt","Sage"], materials: ["Recycled Nylon/Elastane"], styleTags: ["bikini","floral","tropical"], leasePriceAud: 750, retailPriceAud: 9000, referencePrompt: "Women's tropical floral bikini cobalt blue tie side", primaryImageUrl: "/lamalo/swimwear-women-bikini.jpg" },
      { name: "Lamalo Swimwear Cover-Up", description: "Sheer cotton gauze cover-up dress with a V-neckline and side slits. Beach essential.", category: "swimwear", subcategory: "cover-ups", genderFit: "female", colors: ["White","Sand","Navy Stripe"], materials: ["Cotton Gauze"], styleTags: ["cover-up","beach","sheer"], leasePriceAud: 650, retailPriceAud: 8000, referencePrompt: "Women's cotton gauze beach cover up dress white sheer", primaryImageUrl: "/lamalo/women-linen-dress.jpg" },
    ],
  };
  ...
  const womensComfort: SeedCollection = {
    ...
    collectionPriceAud: 7500,
    items: [
      { name: "Lamalo Wrap Midi Dress", description: "Soft viscose wrap dress with a V-neckline and gentle floral print. Easy to put on, flattering on all shapes.", category: "dresses", subcategory: "midi-dresses", genderFit: "female", colors: ["Dusty Rose/Floral","Lavender","Navy"], materials: ["100% Viscose"], styleTags: ["wrap-dress","comfort","feminine"], leasePriceAud: 900, retailPriceAud: 11000, referencePrompt: "Women's elegant wrap midi dress dusty rose floral print modest", primaryImageUrl: "/lamalo/elderly-women-wrap-dress.jpg", sizeRange: "XS–3XL" },
      { name: "Lamalo Elastic-Waist Trouser", description: "Pull-on trouser with a full elastic waist in soft cotton. Comfortable and dignified all day.", category: "bottoms", subcategory: "trousers", genderFit: "female", colors: ["Pale Blue","Navy","Blush"], materials: ["65% Cotton","35% Polyester"], styleTags: ["comfort","elastic-waist","classic"], leasePriceAud: 700, retailPriceAud: 8500, referencePrompt: "Women's relaxed pull-on trouser elastic waist pale blue comfortable", primaryImageUrl: "/lamalo/elderly-women-elastic-trouser.jpg", sizeRange: "XS–3XL" },
      { name: "Lamalo Long Wrap Cardigan", description: "Flowing open-front cardigan in merino blend that wraps and ties. Exceptionally comfortable.", category: "tops", subcategory: "knitwear", genderFit: "female", colors: ["Blush","Grey","Sage"], materials: ["70% Merino Wool","30% Polyester"], styleTags: ["cardigan","wrap","cosy"], leasePriceAud: 1000, retailPriceAud: 13000, referencePrompt: "Women's warm open front long cardigan soft blush pink knit", primaryImageUrl: "/lamalo/elderly-women-long-cardigan.jpg", sizeRange: "XS–3XL" },
      { name: "Lamalo Button Blouse", description: "Button-front blouse in easy-care cotton with a soft drape and gentle collar. Timeless.", category: "tops", subcategory: "blouses", genderFit: "female", colors: ["Sky Blue","White","Blush"], materials: ["100% Easy-Care Cotton"], styleTags: ["blouse","button-front","classic"], leasePriceAud: 650, retailPriceAud: 8000, referencePrompt: "Women's classic button front blouse sky blue easy care", primaryImageUrl: "/lamalo/elderly-women-blouse.jpg", sizeRange: "XS–3XL" },
      { name: "Lamalo Quilted Zip Jacket", description: "Lightweight zip-front quilted jacket with easy-access pockets. Warm, neat and packable.", category: "outerwear", subcategory: "jackets", genderFit: "female", colors: ["Teal","Navy","Blush"], materials: ["Shell: Polyester","Fill: Polyester"], styleTags: ["quilted","jacket","practical"], leasePriceAud: 900, retailPriceAud: 11000, referencePrompt: "Women's lightweight quilted jacket teal zip up warm", primaryImageUrl: "/lamalo/elderly-women-quilted-jacket.jpg", sizeRange: "XS–3XL" },
      { name: "Lamalo Floral Cotton Nightgown", description: "Long cotton nightgown with a button-front neckline and soft floral print. Cosy and modest.", category: "nightwear", subcategory: "nightgowns", genderFit: "female", colors: ["White/Pink Floral","Blue/White"], materials: ["100% Cotton"], styleTags: ["nightgown","nightwear","comfort"], leasePriceAud: 600, retailPriceAud: 7000, referencePrompt: "Women's soft cotton floral nightgown white pink long modest", primaryImageUrl: "/lamalo/elderly-women-nightgown.jpg", sizeRange: "XS–3XL" },
      { name: "Lamalo A-Line Midi Skirt", description: "Classic A-line midi skirt in soft cotton-blend with a fully elasticated waist.", category: "bottoms", subcategory: "skirts", genderFit: "female", colors: ["Navy","Black","Blush"], materials: ["65% Cotton","35% Polyester"], styleTags: ["skirt","a-line","classic"], leasePriceAud: 650, retailPriceAud: 8000, referencePrompt: "Women's classic A-line skirt midi length navy blue", primaryImageUrl: "/lamalo/elderly-women-midi-skirt.jpg", sizeRange: "XS–3XL" },
      { name: "Lamalo Wool-Mix Coat", description: "Warm wool-mix coat with a classic lapel, button-front and side pockets. Smart and practical.", category: "outerwear", subcategory: "coats", genderFit: "female", colors: ["Camel","Navy","Charcoal"], materials: ["60% Wool","40% Polyester"], styleTags: ["coat","wool","classic"], leasePriceAud: 1500, retailPriceAud: 22000, referencePrompt: "Women's warm wool mix coat camel full length classic senior", primaryImageUrl: "/lamalo/elderly-women-wool-coat.jpg", sizeRange: "XS–3XL" },
      { name: "Lamalo Wide-Fit Walking Shoe", description: "Supportive wide-fit leather walking shoe with a cushioned insole and non-slip sole.", category: "footwear", subcategory: "walking-shoes", genderFit: "female", colors: ["White","Navy","Black"], materials: ["Leather Upper","Cushioned Insole"], styleTags: ["walking-shoe","comfortable","supportive"], leasePriceAud: 750, retailPriceAud: 10000, referencePrompt: "Women's comfortable wide fit walking shoe white leather supportive", primaryImageUrl: "/lamalo/elderly-women-walking-shoe.jpg", sizeRange: "UK 3–9 (Wide)" },
    ],
  };
  ...
  const kidsEveryday: SeedCollection = {
    ...
    items: [
      { name: "Lamalo Kids' Graphic Tee", description: "Soft organic cotton tee with a bold Lamalo graphic on the front. Machine washable and super soft.", category: "tops", subcategory: "t-shirts", genderFit: "kids", colors: ["Yellow","Red","Cobalt Blue","White"], materials: ["100% Organic Cotton"], styleTags: ["graphic-tee","kids","colourful"], leasePriceAud: 350, retailPriceAud: 4000, referencePrompt: "Children's colourful graphic tee yellow organic cotton", primaryImageUrl: "/lamalo/kids-graphic-tee.jpg", sizeRange: "2–3Y,3–4Y,4–5Y,5–6Y,6–7Y,7–8Y,8–9Y,9–10Y,10–11Y,11–12Y" },
      { name: "Lamalo Kids' School Polo", description: "Hardwearing pique cotton polo perfect for school or everyday wear. Easy-care fabric.", category: "tops", subcategory: "polos", genderFit: "kids", colors: ["White","Navy","Red","Cobalt"], materials: ["100% Cotton Pique"], styleTags: ["polo","school","smart"], leasePriceAud: 380, retailPriceAud: 4500, referencePrompt: "Children's classic school polo shirt white navy easy care", primaryImageUrl: "/lamalo/kids-polo-shirt.jpg", sizeRange: "2–3Y,3–4Y,4–5Y,5–6Y,6–7Y,7–8Y,8–9Y,9–10Y,10–11Y,11–12Y" },
      { name: "Lamalo Kids' Slim Denim", description: "Slim-fit stretch denim jeans for kids with an adjustable inner waist and reinforced knees.", category: "bottoms", subcategory: "jeans", genderFit: "kids", colors: ["Indigo","Mid-Wash","Black"], materials: ["Cotton/Elastane Denim"], styleTags: ["denim","kids","durable"], leasePriceAud: 550, retailPriceAud: 6500, referencePrompt: "Children's slim fit stretch denim jeans indigo adjustable waist", primaryImageUrl: "/lamalo/kids-denim-jeans.jpg", sizeRange: "2–3Y,3–4Y,4–5Y,5–6Y,6–7Y,7–8Y,8–9Y,9–10Y,10–11Y,11–12Y" },
      { name: "Lamalo Kids' Fleece Hoodie", description: "Cosy cotton-fleece hoodie with a kangaroo pouch pocket and flat-lock seams.", category: "tops", subcategory: "hoodies", genderFit: "kids", colors: ["Coral","Cobalt Blue","Black"], materials: ["80% Cotton","20% Polyester Fleece"], styleTags: ["hoodie","cosy","kids"], leasePriceAud: 550, retailPriceAud: 6500, referencePrompt: "Children's cosy fleece hoodie coral pink soft cotton", primaryImageUrl: "/lamalo/kids-fleece-hoodie.jpg", sizeRange: "2–3Y,3–4Y,4–5Y,5–6Y,6–7Y,7–8Y,8–9Y,9–10Y,10–11Y,11–12Y" },
      { name: "Lamalo Girls' Linen Dress", description: "Relaxed linen-cotton dress with flutter sleeves and a smocked waist. Perfect for warm days.", category: "dresses", subcategory: "casual-dresses", genderFit: "kids", colors: ["Pink","White","Sage"], materials: ["55% Linen","45% Cotton"], styleTags: ["dress","girls","linen"], leasePriceAud: 500, retailPriceAud: 6000, referencePrompt: "Children's linen summer dress pink light flutter sleeves", primaryImageUrl: "/lamalo/kids-linen-dress.jpg", sizeRange: "2–3Y,3–4Y,4–5Y,5–6Y,6–7Y,7–8Y,8–9Y,9–10Y,10–11Y,11–12Y" },
      { name: "Lamalo Kids' Canvas Sneaker", description: "Classic low-top canvas sneaker with a cushioned insole and flexible rubber sole.", category: "footwear", subcategory: "sneakers", genderFit: "kids", colors: ["White/Rainbow","White/Blue"], materials: ["Canvas Upper","Rubber Sole"], styleTags: ["sneaker","kids","casual"], leasePriceAud: 500, retailPriceAud: 6000, referencePrompt: "Children's canvas low-top sneaker white rainbow sole", primaryImageUrl: "/lamalo/kids-sneaker.jpg", sizeRange: "UK 6–2 (Kids)" },
      { name: "Lamalo Kids' Velcro Sandal", description: "Adjustable velcro sport sandal with cushioned footbed and a flexible EVA sole.", category: "footwear", subcategory: "sandals", genderFit: "kids", colors: ["Teal","White","Black"], materials: ["Synthetic Upper","EVA Sole"], styleTags: ["sandal","velcro","summer"], leasePriceAud: 420, retailPriceAud: 5000, referencePrompt: "Children's velcro sport sandal teal blue EVA sole", primaryImageUrl: "/lamalo/kids-sandal.jpg", sizeRange: "UK 6–2 (Kids)" },
      { name: "Lamalo Kids' Cotton Shorts", description: "Elasticated-waist cotton shorts for comfortable all-day wear. Machine washable.", category: "bottoms", subcategory: "shorts", genderFit: "kids", colors: ["Khaki","Navy","Grey"], materials: ["100% Cotton Twill"], styleTags: ["shorts","casual","comfortable"], leasePriceAud: 300, retailPriceAud: 3500, referencePrompt: "Children's casual cotton shorts khaki elasticated waist", primaryImageUrl: "/lamalo/kids-shorts.jpg", sizeRange: "2–3Y,3–4Y,4–5Y,5–6Y,6–7Y,7–8Y,8–9Y,9–10Y,10–11Y,11–12Y" },
    ],
  };
  ...
  const headwearCollection: SeedCollection = {
    ...
    collectionPriceAud: 3500,
    items: [
      { name: "Lamalo Structured Baseball Cap", description: "6-panel structured cap in cotton twill with an adjustable snapback closure and embroidered Lamalo logo.", category: "accessories", subcategory: "caps", genderFit: "unisex", colors: ["White","Black","Navy","Cobalt"], materials: ["100% Cotton Twill"], styleTags: ["baseball-cap","structured","casual"], leasePriceAud: 450, retailPriceAud: 5500, referencePrompt: "Structured baseball cap white cotton minimal embroidered logo snapback", primaryImageUrl: "/lamalo/hat-baseball-cap.jpg" },
      { name: "Lamalo Bucket Hat", description: "Relaxed woven-cotton bucket hat with a wide drooping brim and a woven label.", category: "accessories", subcategory: "hats", genderFit: "unisex", colors: ["Black","White","Sage","Cobalt"], materials: ["100% Cotton"], styleTags: ["bucket-hat","summer","casual"], leasePriceAud: 420, retailPriceAud: 5000, referencePrompt: "Cotton bucket hat black wide brim woven casual relaxed", primaryImageUrl: "/lamalo/hat-bucket.jpg" },
      { name: "Lamalo Wide-Brim Sun Hat", description: "Natural straw sun hat with a wide brim and a black grosgrain ribbon band. Summer essential.", category: "accessories", subcategory: "hats", genderFit: "unisex", colors: ["Natural Straw","White","Black"], materials: ["Natural Straw","Cotton Lining"], styleTags: ["sun-hat","straw","summer"], leasePriceAud: 550, retailPriceAud: 6500, referencePrompt: "Wide brim natural straw sun hat black ribbon band summer", primaryImageUrl: "/lamalo/hat-wide-brim.jpg" },
      { name: "Lamalo Ribbed Knit Beanie", description: "Classic ribbed merino-wool beanie with a folded cuff. Soft, warm and versatile.", category: "accessories", subcategory: "beanies", genderFit: "unisex", colors: ["Charcoal","Black","White","Burgundy"], materials: ["100% Merino Wool"], styleTags: ["beanie","merino","winter"], leasePriceAud: 380, retailPriceAud: 4500, referencePrompt: "Ribbed knit beanie charcoal merino wool folded cuff warm", primaryImageUrl: "/lamalo/hat-beanie.jpg" },
      { name: "Lamalo Dad Cap", description: "Unstructured low-profile 6-panel cap in washed cotton with a curved brim.", category: "accessories", subcategory: "caps", genderFit: "unisex", colors: ["White","Grey","Sage"], materials: ["Washed Cotton"], styleTags: ["dad-cap","unstructured","relaxed"], leasePriceAud: 420, retailPriceAud: 5000, referencePrompt: "Unstructured washed cotton dad cap white curved brim casual", primaryImageUrl: "/lamalo/hat-baseball-cap.jpg" },
      { name: "Lamalo Trucker Cap", description: "Classic 5-panel trucker cap with a foam front and mesh back for breathability.", category: "accessories", subcategory: "caps", genderFit: "unisex", colors: ["White/Mesh","Black/Mesh","Navy/Mesh"], materials: ["Cotton Front","Nylon Mesh Back"], styleTags: ["trucker","mesh","casual"], leasePriceAud: 420, retailPriceAud: 5000, referencePrompt: "Classic trucker cap white foam front mesh back breathable", primaryImageUrl: "/lamalo/hat-baseball-cap.jpg" },
      { name: "Lamalo Wool Flat Cap", description: "Traditional flat cap in herringbone wool blend with a fully lined interior.", category: "accessories", subcategory: "hats", genderFit: "unisex", colors: ["Beige Herringbone","Charcoal","Navy"], materials: ["80% Wool","20% Polyester"], styleTags: ["flat-cap","heritage","classic"], leasePriceAud: 500, retailPriceAud: 6000, referencePrompt: "Wool herringbone flat cap beige traditional lined interior", primaryImageUrl: "/lamalo/elderly-men-flat-cap.jpg" },
      { name: "Lamalo Wool Beret", description: "Classic wool felt beret with a central stalk and a comfortable inner band.", category: "accessories", subcategory: "hats", genderFit: "unisex", colors: ["Black","Camel","Burgundy"], materials: ["100% Wool Felt"], styleTags: ["beret","classic","artistic"], leasePriceAud: 450, retailPriceAud: 5500, referencePrompt: "Classic wool felt beret black French style artistic", primaryImageUrl: "/lamalo/hat-bucket.jpg" },
      { name: "Lamalo Performance Visor", description: "Open-crown visor in moisture-wicking fabric with UV protection and an adjustable back strap.", category: "accessories", subcategory: "caps", genderFit: "unisex", colors: ["White","Black","Cobalt"], materials: ["Performance Polyester"], styleTags: ["visor","sport","UV-protection"], leasePriceAud: 350, retailPriceAud: 4000, referencePrompt: "Performance sport visor white UV protection moisture wicking open crown", primaryImageUrl: "/lamalo/hat-baseball-cap.jpg" },
    ],
  };
