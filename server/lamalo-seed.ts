...
const womensEverydayItems: SeedItem[] = [
  ...
  ...cc({ name:"Lamalo Wrap Midi Skirt", description:"Wrap-front midi skirt in fluid fabric with slight flare.", category:"bottoms", subcategory:"skirts", genderFit:"female", materials:["100% Viscose"], styleTags:["skirt","midi","feminine","wrap"], referencePrompt:"Women's wrap-front midi skirt fluid slight flare feminine", primaryImageUrl:"/lamalo/elderly-women-midi-skirt.jpg" }, DRESS),
  ...cc({ name:"Lamalo Ribbed Tee", description:"Stretch-rib cotton tee in a fitted silhouette with a crew neck.", category:"tops", subcategory:"t-shirts", genderFit:"female", materials:["95% Cotton","5% Elastane"], styleTags:["tee","fitted","ribbed","essential"], referencePrompt:"Women's stretch-rib cotton crew-neck tee fitted silhouette", primaryImageUrl:"/lamalo/women-silk-blouse.jpg" }, TOPS),
  ...cc({ name:"Lamalo Classic Denim", description:"Mid-rise straight-leg denim with authentic five-pocket construction.", category:"bottoms", subcategory:"jeans", genderFit:"female", materials:["98% Cotton","2% Elastane"], styleTags:["denim","classic","everyday"], referencePrompt:"Women's mid-rise straight-leg denim jeans five-pocket classic", primaryImageUrl:"/lamalo/women-wide-leg-pants.jpg" }, DENIM),
  ...cc({ name:"Lamalo High-Waist Legging", description:"Full-length high-waist legging in sculpting four-way stretch fabric.", category:"bottoms", subcategory:"leggings", genderFit:"female", materials:["75% Nylon","25% Elastane"], styleTags:["leggings","everyday","comfort","fitted"], referencePrompt:"Women's full-length high-waist sculpting leggings four-way stretch", primaryImageUrl:"/lamalo/women-wide-leg-pants.jpg" }, ["Black","Navy","Charcoal","Forest Green","Burgundy","Cobalt Blue","Camel","Dusty Rose"]),
];
...
const womensActiveItems: SeedItem[] = [
  ...
  ...cc({ name:"Lamalo Women's Soccer Jersey", description:"Women's cut soccer jersey with moisture-wicking mesh panels and athletic fit.", category:"tops", subcategory:"sport-jerseys", genderFit:"female", materials:["100% Recycled Polyester"], styleTags:["soccer","sport","jersey","team"], referencePrompt:"Women's soccer jersey moisture-wicking mesh panels athletic fit", primaryImageUrl:"/lamalo/women-silk-blouse.jpg" }, SPORT),
  ...cc({ name:"Lamalo Women's Basketball Jersey", description:"Women's sleeveless basketball jersey with wide armholes and mesh fabrication.", category:"tops", subcategory:"sport-jerseys", genderFit:"female", materials:["100% Polyester Mesh"], styleTags:["basketball","sport","jersey","sleeveless"], referencePrompt:"Women's sleeveless basketball jersey mesh wide armhole", primaryImageUrl:"/lamalo/women-silk-blouse.jpg" }, SPORT),
];
...
const womensOriginalsItems: SeedItem[] = [
  ...
  ...cc({ name:"Lamalo Women's Athletic Skort", description:"Retro athletic skort with built-in shorts and pleated skirt overlay.", category:"bottoms", subcategory:"skorts", genderFit:"female", materials:["100% Polyester"], styleTags:["skort","retro","athletic","tennis"], referencePrompt:"Women's retro athletic skort built-in shorts pleated overlay", primaryImageUrl:"/lamalo/elderly-women-midi-skirt.jpg" }, ["White","Black","Navy","Cobalt Blue","Red","Forest Green","Gold","Burgundy"]),
];
...
const womensLuxuryItems: SeedItem[] = [
  ...
  ...cc({ name:"Lamalo Wide-Leg Formal Trouser", description:"High-rise wide-leg formal trouser in Italian fabric with front crease.", category:"bottoms", subcategory:"trousers", genderFit:"female", materials:["100% Italian Polyester"], styleTags:["formal","wide-leg","luxury"], referencePrompt:"Women's high-rise wide-leg formal trouser Italian fabric front crease", primaryImageUrl:"/lamalo/women-wide-leg-pants.jpg" }, ["Black","Navy","Camel","Cream","Charcoal","Cobalt Blue","Dusty Rose","Stone"]),
  ...cc({ name:"Lamalo Pure Silk Blouse", description:"Woven silk blouse with a V-neck and delicate button front.", category:"tops", subcategory:"blouses", genderFit:"female", materials:["100% Silk"], styleTags:["silk","luxury","feminine","blouse"], referencePrompt:"Women's pure silk woven blouse V-neck delicate button front", primaryImageUrl:"/lamalo/women-silk-blouse.jpg" }, ["White","Black","Dusty Rose","Cobalt Blue","Sage Green","Cream","Pale Gold","Lavender"]),
  ...cc({ name:"Lamalo Cashmere Sweater", description:"Fine-knit cashmere sweater with crew neck and relaxed fit.", category:"tops", subcategory:"knitwear", genderFit:"female", materials:["100% Cashmere"], styleTags:["cashmere","luxury","knitwear"], referencePrompt:"Women's fine-knit cashmere crew-neck sweater relaxed fit", primaryImageUrl:"/lamalo/women-silk-blouse.jpg" }, ["Camel","White","Black","Dusty Rose","Cobalt Blue","Sage Green","Cream","Burgundy"]),
...
const womensComfortItems: SeedItem[] = [
  ...
  ...cc({ name:"Lamalo Elastic-Waist Trouser", description:"Comfort trouser with full elastic waist, straight leg and side pockets.", category:"bottoms", subcategory:"trousers", genderFit:"female", materials:["65% Polyester","35% Cotton"], styleTags:["comfort","elastic","easy-fit","seniors"], referencePrompt:"Women's comfort elastic-waist straight-leg trouser easy fit", primaryImageUrl:"/lamalo/women-wide-leg-pants.jpg" }, BOTTOMS),
  ...
  ...cc({ name:"Lamalo A-Line Midi Skirt", description:"Pull-on A-line midi skirt with elasticated waist and fluid drape.", category:"bottoms", subcategory:"skirts", genderFit:"female", materials:["100% Polyester"], styleTags:["skirt","A-line","comfort","seniors","easy"], referencePrompt:"Women's pull-on A-line midi skirt elasticated waist fluid drape", primaryImageUrl:"/lamalo/elderly-women-midi-skirt.jpg" }, DRESS),
...
const kidsActiveItems: SeedItem[] = [
  ...cc({ name:"Lamalo Kids' Retro Tracksuit", description:"Two-piece kids' retro tracksuit with contrast stripe — zip top and elasticated pants.", category:"tops", subcategory:"tracksuits", genderFit:"unisex", materials:["100% Polyester Tricot"], styleTags:["kids","tracksuit","retro","sport"], referencePrompt:"Kids' retro two-piece tracksuit contrast stripe zip top elasticated pants", primaryImageUrl:"/lamalo/kids-fleece-hoodie.jpg" }, ["Navy/White","Red/White","Black/White","Green/White","Royal Blue/White","Burgundy/Gold","Grey/Black","Orange/White"]),
  ...cc({ name:"Lamalo Kids' Sport Shorts", description:"Lightweight kids' sport shorts with elastic waist and side pockets.", category:"bottoms", subcategory:"shorts", genderFit:"unisex", materials:["100% Polyester"], styleTags:["kids","sport","shorts","training"], referencePrompt:"Kids' lightweight sport shorts elastic waist side pockets", primaryImageUrl:"/lamalo/kids-denim-jeans.jpg" }, ["Black","Navy","Red","Forest Green","Royal Blue","Grey","Orange","White"]),
...
const bagsItems: SeedItem[] = [
  ...
  ...cc({ name:"Lamalo Leather Crossbody", description:"Compact zip-top crossbody in premium leather with adjustable strap.", category:"bags", subcategory:"crossbody", genderFit:"female", materials:["Premium Leather","Adjustable Strap"], styleTags:["crossbody","leather","compact","everyday"], referencePrompt:"Compact leather zip-top crossbody bag adjustable strap premium", primaryImageUrl:"/lamalo/bag-shoulder.jpg" }, NEUTRAL),
  ...cc({ name:"Lamalo Evening Clutch", description:"Slim envelope clutch in faux leather with wrist strap.", category:"bags", subcategory:"clutches", genderFit:"female", materials:["Faux Leather","Chain Wrist Strap"], styleTags:["clutch","evening","formal","slim"], referencePrompt:"Slim envelope clutch faux leather chain wrist strap evening formal", primaryImageUrl:"/lamalo/bag-shoulder.jpg" }, ["Black","Gold","Silver","Navy","Dusty Rose","Cobalt Blue","Champagne","Burgundy"]),
...
// ─────────────────────────────────────────────────────────────────────────────
  ...
  const teensItems: SeedItem[] = [
    ...cc({ name:"Lamalo Teens' Oversized Tee", description:"Dropped-shoulder oversized tee for teens in soft cotton jersey — effortlessly cool.", category:"tops", subcategory:"t-shirts", genderFit:"unisex", materials:["100% Cotton Jersey"], styleTags:["oversized","teens","casual","streetwear"], referencePrompt:"Teens' oversized dropped-shoulder cotton tee casual streetwear", primaryImageUrl:"/lamalo/men-polo-shirt.jpg", sizeRange:"XS–XL Teen" }, TOPS),
    ...
    ...cc({ name:"Lamalo Teens' Track Pants", description:"Slim tapered track pants with side stripe and elasticated ankle — sport meets street.", category:"bottoms", subcategory:"track-pants", genderFit:"unisex", materials:["80% Cotton","20% Polyester"], styleTags:["track-pants","teens","sport","street"], referencePrompt:"Teens' slim tapered track pants side stripe elasticated ankle sport street", primaryImageUrl:"/lamalo/men-jogger-pant.jpg", sizeRange:"XS–XL Teen" }, ["Black","Navy","Charcoal","Forest Green","Burgundy","Cobalt Blue","White","Olive"]),
    ...cc({ name:"Lamalo Girls' Crop Top", description:"Fitted crop tee with ribbed texture and a relaxed open-edge hem.", category:"tops", subcategory:"crop-tops", genderFit:"female", materials:["95% Cotton","5% Elastane"], styleTags:["crop-top","teens","girls","casual"], referencePrompt:"Teens' girls fitted ribbed crop top relaxed open-edge hem casual", primaryImageUrl:"/lamalo/women-silk-blouse.jpg", sizeRange:"XS–L Teen" }, ["White","Black","Blush Pink","Sage Green","Lavender","Cream","Dusty Rose","Navy"]),
    ...cc({ name:"Lamalo Teens' Mini Skirt", description:"Low-rise denim mini skirt with frayed hem — a teen classic.", category:"bottoms", subcategory:"skirts", genderFit:"female", materials:["100% Cotton Denim"], styleTags:["mini-skirt","teens","girls","denim","casual"], referencePrompt:"Teens' low-rise denim mini skirt frayed hem casual", primaryImageUrl:"/lamalo/women-wide-leg-pants.jpg", sizeRange:"XS–L Teen" }, DENIM),
  ];
...
export async function runLamaloSeed(
  ...
  log.info(`Lamalo Fashion seed complete — ${newCollections} new collections, ${totalItems} new items`);
    ...
    try {
      ...
      // Backfill retailPriceAud for items where INSERT IGNORE left it NULL
      await db.execute(sql`
        UPDATE wardrobeItems
        SET retailPriceAud = CASE LOWER(COALESCE(category, ''))
          WHEN 'tops'        THEN 100
