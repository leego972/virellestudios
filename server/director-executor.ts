    ...
    switch (toolName) {
      ...
      case "create_scene": {
        ...
        const scene = await db.createScene({
          ...
          timeOfDay: args.timeOfDay ? (args.timeOfDay as any) : null,
          weather: args.weather ? (args.weather as any) : null,
          lighting: args.lighting ? (args.lighting as any) : null,
          cameraAngle: args.cameraAngle ? (args.cameraAngle as any) : null,
