          ...
          (async () => {
            try {
              ...
              const extResult = await generateExtendedScene(byokKeys, {
                ...
                weather: (scene as any).weather || undefined,
            ...
            await Promise.allSettled(batch.map(async (scene) => {
              try {
                ...
                const extResult = await generateExtendedSceneBulkFal(bulkByokKeys, {
                  ...
                  negativePrompt: sceneNegativePrompt,
                  seed: sceneSeed,
                  sceneType: (scene as any).sceneType as "action" | "dialogue" | "emotional" | "horror" | "reveal" | "default" | undefined,
            ...
            await Promise.allSettled(batch.map(async (scene) => {
              try {
                ...
                const extResult = await generateExtendedScene(bulkByokKeys, {
                  ...
                  aiPromptOverride: bulkOtherPromptOverride,
                  negativePrompt: (scene as any).negativePrompt || getDefaultNegativePrompt(userTier as QualityTier),
                  seed: (scene as any).seed as number | undefined,
                  sceneType: (scene as any).sceneType as "action" | "dialogue" | "emotional" | "horror" | "reveal" | "default" | undefined,
        ...
        for (let sceneIdx = 0; sceneIdx < allScenes.length; sceneIdx++) {
          ...
          try {
            ...
            const videoPrompt = [
              ...
              (scene as any).emotionalBeat ? `Emotional beat: ${(scene as any).emotionalBeat}.` : "",
              ...
              scene.cameraAngle ? `Camera angle: ${scene.cameraAngle}.` : "",
              (scene as any).colorPalette ? `Color palette: ${(scene as any).colorPalette}.` : "",
              (scene as any).focalLength ? `Lens: ${(scene as any).focalLength}.` : "",
              (scene as any).depthOfField ? `Depth of field: ${(scene as any).depthOfField}.` : "",
              (scene as any).foregroundElements ? `Foreground: ${(scene as any).foregroundElements}.` : "",
              (scene as any).backgroundElements ? `Background: ${(scene as any).backgroundElements}.` : "",
            ...
            try {
              ...
              const extResult = await generateExtendedScene(byokKeys, {
                ...
                aiPromptOverride: (scene as any).aiPromptOverride as string | undefined,
                negativePrompt: (scene as any).negativePrompt || getDefaultNegativePrompt(userTier as QualityTier),
                seed: (scene as any).seed as number | undefined,
                sceneType: (scene as any).sceneType as "action" | "dialogue" | "emotional" | "horror" | "reveal" | "default" | undefined,
