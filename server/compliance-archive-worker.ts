...
async function runComplianceArchiveCycle(): Promise<void> {
...
export function startComplianceArchiveWorker(): void {
  ...
  logger.info(
    `[ComplianceArchive] starting site-wide 90-day archive scanner; interval=${SCAN_INTERVAL_MS}ms`,
  );
...
export { runComplianceArchiveCycle };
