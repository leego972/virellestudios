...
const STAGES: Stage[] = [
  ...
  },
  {
    ...
    icon: Users,
    hrefFor: (id) => `/projects/${id}#characters`,
  ...
  },
  {
    ...
    icon: Scissors,
    hrefFor: (id) => `/projects/${id}/nle-export`,
...
export function ProjectJourneyNav({
  ...
  return (
    <div className="space-y-6">
      <Card className="bg-gradient-to-br from-amber-50/5 via-card/50 to-card/50 border-amber-500/20">
