...
export function OnboardingModal({ forceShow = false, onClose }: OnboardingModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center sm:p-4 bg-black/70 backdrop-blur-sm">
      <div
        className="relative w-full sm:max-w-lg bg-[#0c0b18] border border-[rgba(255,255,255,0.08)] sm:rounded-2xl rounded-t-2xl shadow-2xl flex flex-col"
        ...
        <div className="px-6 pb-2 overflow-y-auto flex-1" style={{ minHeight: 0 }}>
          <div className="flex flex-col items-center text-center gap-4">
            ...
            <div>
              ...
              <h2 className="text-xl font-bold text-foreground mb-3 gradient-text-gold">{current.title}</h2>
          ...
          <div className="flex items-center gap-3">
            {!isFirst && (
              <button
                ...
                className="flex items-center gap-1 px-4 py-2.5 rounded-xl border border-[rgba(255,255,255,0.08)] text-sm text-muted-foreground hover:text-foreground hover:bg-surface transition-colors"
              >
