                ...
                <div className="flex max-w-2xl flex-wrap justify-center gap-2">
                  {suggestedPrompts.map((prompt, index) => (
                    <button
                      ...
                      disabled={isLoading}
                      className="rounded-lg border border-[rgba(255,255,255,0.07)] bg-[#0c0b18] px-4 py-2 text-sm transition-colors hover:bg-accent disabled:cursor-not-allowed disabled:opacity-50"
                    >
                      {prompt}
                    </button>
                  ))}
