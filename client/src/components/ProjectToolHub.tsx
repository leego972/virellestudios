  ...
  const groups: Group[] = [
    {
      ...
      tools: [
        ...
        { title: "Voice Studio", description: "Record, upload or ElevenLabs-clone voices for every character in your cast.", href: `/projects/${projectId}/voice-studio`, icon: Mic2, badge: "AI" },
        { title: "Script Translation", description: "Translate your screenplay to 13 languages — format, names and style preserved.", href: `/projects/${projectId}/script-translation`, icon: Globe, badge: "AI" },
      ],
    },
    {
      title: "2. Prepare",
      ...
      <CardContent className="p-5 space-y-5">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-2">
          <div>
            ...
            <h3 className="font-serif text-xl leading-tight gradient-text-gold">Plan → Create → Produce → Finish → Release</h3>
