  ...
  const groups: Group[] = [
    ...
    },
    {
      ...
      tools: [
        ...
        { title: "Location Scout", description: "Iconic preset locations, manual reference images, AI expansion and consistent scene locations.", href: `/projects/${projectId}/locations`, icon: Globe },
        ...
        { title: "Wardrobe Marketplace", description: "Buy virtual film-use clothing/accessories or live designer products that include the matching virtual item in inventory.", href: `/wardrobe-marketplace`, icon: Store, badge: "Buy" },
        { title: "Designer Studio", description: "Designer dashboard for virtual items, live products, item uploads, pricing, publishing and Stripe payouts.", href: `/designer/studio`, icon: Store, badge: "Designer" },
        { title: "Join as Designer", description: "Registration point for designers to sell virtual items or live products with included virtual inventory rights.", href: `/designer-register`, icon: Sparkles, badge: "Signup" },
