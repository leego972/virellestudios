...
export default function WhatsNewPanel() {
  ...
  if (!open) return null;
  return (
    <div className="rounded-xl border border-violet-500/30 bg-gradient-to-br from-violet-500/10 via-pink-500/5 to-amber-500/5 p-4 sm:p-5 mb-4 relative overflow-hidden">
      ...
      <div className="flex items-center gap-2 mb-3">
        ...
        <h3 className="text-sm font-semibold tracking-tight">What's new in Virelle Studios</h3>
      </div>
