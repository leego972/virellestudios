...
export function NextStageCTA({
  ...
  if (!next) {
    return (
      <Card className="mt-8 border-emerald-500/40 bg-gradient-to-br from-emerald-500/10 to-amber-500/10">
  ...
  return (
    <Card className="mt-8 border-primary/30 bg-gradient-to-br from-primary/5 to-primary/0">
      <CardContent className="p-4 sm:p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4 justify-between">
        <div className="flex items-start gap-3">
