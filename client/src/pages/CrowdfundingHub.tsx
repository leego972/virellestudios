...
function CrowdfundingHubInner() {
  ...
  // ââ Campaign mutations ââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  // ââ Platforms âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  // ââ AI Campaign Builder state âââââââââââââââââââââââââââââââââââââââââââââ
  ...
  // ââ Create modal state ââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  // ââ Launch modal state ââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  // ââ Director AI âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
    ...
    <div className="container max-w-6xl py-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          {platforms.length} platforms Â· launch-ready campaign copy, reward tiers, and pitch-video scripts.
        </p>
      </div>

      {/* ââ My Campaigns ââââââââââââââââââââââââââââââââââââââââââââââââââ */}
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
        ...
        <CardContent>
          {myCampaignsLoading ? (
            <div className="flex items-center gap-2 text-sm text-muted-foreground py-4">
              <Loader2 className="h-4 w-4 animate-spin text-amber-400" /> Loading campaignsâ¦
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <CardContent className="p-3 space-y-2 glass-card shadow-lg shadow-amber-500/5">
                      ...
                      {/* ââ Draft actions ââââââââââââââââââââââââââââââââââââ */}
                          ...
                          {!campaign.stripeConnectOnboarded ? (
                            <>
                              ...
                              >
                                ...
                                {isSettingUp ? "Redirectingâ¦" : "Set up payouts"}
                              </Button>
                            </>
                          ) : (
                            <>
                              <div className="flex items-center gap-1.5 text-xs text-emerald-400 bg-emerald-500/10 rounded px-2 py-1">
                                ...
                                Payouts configured Â· ready to launch
                              </div>
                              <Button
                                size="sm"
          ...
          <CardContent className="space-y-4 glass-card shadow-lg shadow-amber-500/5">
            <div className="grid md:grid-cols-2 gap-3">
              ...
              <div>
                ...
                <Input value={brief.genre} onChange={(e) => setBrief({ ...brief, genre: e.target.value })} placeholder="Drama, Sci-Fi, Horrorâ¦" />
              </div>
              <div>
                <Label className="text-xs">Audience</Label>
                <Input value={brief.audience} onChange={(e) => setBrief({ ...brief, audience: e.target.value })} placeholder="e.g. 25â45 indie film fans" />
              </div>
              <div>
              ...
              <div>
                ...
                <Select value={brief.duration} onValueChange={(v) => setBrief({ ...brief, duration: v })}>
                  <SelectTrigger><SelectValue /></SelectTrigger>
                  <SelectContent>
                    <SelectItem value="15">15 days â Sprint</SelectItem>
                    <SelectItem value="21">21 days â Short</SelectItem>
                    <SelectItem value="30">30 days â Standard</SelectItem>
                    <SelectItem value="45">45 days â Extended</SelectItem>
                    <SelectItem value="60">60 days â Long</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div className="md:col-span-2">
                <Label className="text-xs">Premise (1â3 sentences)</Label>
                <Textarea
                  rows={3}
                  value={brief.premise}
      ...
      {/* ââ Create Campaign Modal ââââââââââââââââââââââââââââââââââââââââââ */}
        ...
        <DialogContent className="max-w-lg">
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <Label className="text-xs">Genre</Label>
                <Input placeholder="Drama, Sci-Fiâ¦" value={newCampaign.genre} onChange={e => setNewCampaign(p => ({ ...p, genre: e.target.value }))} />
              </div>
            </div>
      ...
      {/* ââ Launch Campaign Modal ââââââââââââââââââââââââââââââââââââââââââ */}
            ...
            <div>
              ...
              <Select value={String(deadlineDays)} onValueChange={(v) => setDeadlineDays(parseInt(v))}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="45">45 days â Extended</SelectItem>
                  <SelectItem value="60">60 days â Long</SelectItem>
                  <SelectItem value="90">90 days â Maximum</SelectItem>
                </SelectContent>
              </Select>
            </div>
      ...
      {/* ââ Manage Campaign Modal ââââââââââââââââââââââââââââââââââââââââââ */}
