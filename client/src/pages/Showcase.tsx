...
/**
 * Showcase / Demo Reel â Public page to display VirElle Studios film quality.
...
export default function Showcase() {
  ...
  return (
    <div className="min-h-screen text-white relative overflow-hidden" style={{ background:"linear-gradient(135deg,#07070e 0%,#0c0b18 60%,#07070a 100%)" }}>
      ...
      <header className="relative z-10 pt-8 pb-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-neutral-400 max-w-2xl mx-auto mb-2">
            AI-Generated Cinema â Every Frame Crafted by Artificial Intelligence
          </p>
          <p className="text-sm text-neutral-500 max-w-xl mx-auto">
            Experience the future of filmmaking. These films were created entirely using VirElle Studios â
      ...
      {/* THE SHOWRUNNER â featured Virelle Studios showcase */}
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 pb-24">
        {isLoading ? (
          ...
          // Static sample showcase â displayed when no user films are published yet
          <div className="space-y-12">
            {[
              {
                id: "sample-opener",
                title: "Virelle Studios â Cinematic Opener",
                genre: "Brand Film",
                directorName: "VirElle Studios",
                plotSummary: "The official Virelle Studios brand opener â a white dove descends through god rays, lands on a polished silver shield, and triggers a breathtaking golden transformation as the VS emblem is revealed. Wings flapping, angelic choir, 16 seconds of pure cinematic identity. Generated entirely within the Virelle platform.",
                completedScenes: 3,
                resolution: "1080p",
                quality: "Cinematic",
                scenes: [
                  ...
                  },
                  {
                    ...
                    description: "The dove lands and everything it touches turns to pure 24k gold â shield, branches, emblem.",
                    videoUrl: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663418605762/virelle_studios_opener_final.mp4",
                    thumbnailUrl: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663418605762/hxRQQgsmyjgcByim.png",
                    duration: 6,
                    orderIndex: 1,
      ...
      {/* âââ Phase 3: Public Discovery Feed ââââââââââââââââââââââââââââââââ */}
...
/* âââ Film Card Component âââââââââââââââââââââââââââââââââââââââââââââââââââ */
...
/* âââ Video Player Component ââââââââââââââââââââââââââââââââââââââââââââââââ */
...
/* âââ Phase 3: Discovery Feed Component âââââââââââââââââââââââââââââââââââââââ */
...
function DiscoveryFeed() {
  ...
  return (
    <div>
      <SiteHead title="Public Showcase â Films & Reels" description="Watch films, reels, and promos created on Virelle Studios by indie filmmakers and major studios worldwide." />
      {/* Surface Tabs */}
 ...
 * ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ */
   ...
   * TheShowrunnerSection
   * Full cinematic showcase for THE SHOWRUNNER â premium black/gold styling.
      ...
      >
        ...
        >
          ...
          <div className="px-6 py-14 md:py-20 relative z-10">
            <div className="inline-flex items-center gap-2 mb-6 px-3 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-400 text-xs font-semibold uppercase tracking-wider">
              ...
              Featured Showcase Â· VirElle Studios Original
            </div>
            ...
            <div className="flex items-center justify-center flex-wrap gap-3 md:gap-6">
              {["9 SCENES", "4â5 MIN", "COMEDY Â· DRAMA", "MELBOURNE", "AI SHOWCASE"].map(
                (tag, i, arr) => (
                  <span key={tag} className="flex items-center gap-3 md:gap-6">
                    ...
                    {i < arr.length - 1 && (
                      <span className="text-amber-500/30 hidden sm:inline">Â·</span>
                    )}
                  </span>
                )
              )}
        ...
        <div className="rounded-lg border border-neutral-800 bg-neutral-950/80 p-5 mb-12 max-w-3xl mx-auto relative">
          <div className="absolute -top-2.5 left-6 px-2 bg-neutral-950 text-[10px] uppercase tracking-widest text-amber-400/70 font-semibold">
            Disclaimer Â· Appears after opener, before film
          </div>
        ...
        {/* ââ INCITING EMAIL FROM SAM ââ */}
  ...
  {showrunner.samEmail.body}
        ...
        {/* ââ FULL SCRIPT (COLLAPSIBLE) ââ */}
        <div className="mb-16">
          <div className="text-center mb-8">
            <div className="text-xs text-amber-400/70 uppercase tracking-widest mb-2 font-semibold">
              Short Film
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-white font-semibold">
                  {showrunner.fullScript.length} scenes â read the full script
                </span>
              </div>
              {scriptOpen ? (
        ...
        {/* ââ SIGNAL BLACK â SCI-FI NOIR (show within the show) ââ */}
        <div className="mb-16">
          <div className="text-center mb-6">
            <div className="text-xs text-amber-400/70 uppercase tracking-widest mb-2 font-semibold">
        ...
        <div className="mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-neutral-500 mt-2 max-w-xl mx-auto">
              Everything a show needs â built from one idea, no crew, no budget.
            </p>
          </div>
        ...
        {/* ââ SCENE GENERATION PROMPTS ââ */}
        <div className="mb-16">
          <div className="mb-6">
            <h3 className="text-xl font-bold tracking-tight">
            ...
            <p className="text-xs text-neutral-500 mt-1">
              Visual prompts for each scene â ready for generation.
            </p>
          </div>
        ...
        <div className="mb-16">
          <div className="flex items-start justify-between gap-4 mb-6 flex-wrap">
            <div>
              ...
              <p className="text-xs text-neutral-500 mt-1">
                No media produced yet â all ready for generation.
              </p>
            </div>
