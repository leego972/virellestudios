      ...
      <div className="max-w-5xl mx-auto space-y-6 py-6">
          ...
          <Tabs defaultValue="overview">
            ...
            <TabsContent value="world" className="mt-4">
              <Card><CardHeader><CardTitle className="text-sm flex items-center gap-2 gradient-text-gold glass-card"><Globe className="h-4 w-4 text-amber-400" />World Building</CardTitle></CardHeader><CardContent><p className="text-sm text-muted-foreground whitespace-pre-wrap">{activeSeries.worldBuilding || "No world building notes yet. Edit the bible to add them."}</p></CardContent></Card>
            </TabsContent>

            <TabsContent value="characters" className="mt-4">
              <Card><CardHeader><CardTitle className="text-sm flex items-center gap-2 gradient-text-gold glass-card"><Users className="h-4 w-4 text-amber-400" />Main Characters</CardTitle></CardHeader><CardContent><p className="text-sm text-muted-foreground whitespace-pre-wrap">{activeSeries.mainCharacters || "No character notes yet. Edit the bible to add them."}</p></CardContent></Card>
            </TabsContent>
