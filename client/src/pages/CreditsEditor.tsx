    ...
    <div className="min-h-screen" style={{ background:"linear-gradient(135deg,#07070e 0%,#0c0b18 60%,#07070a 100%)" }}>
        ...
        <div className="max-w-4xl mx-auto px-3 sm:px-4 py-3 flex items-center justify-between gap-2 flex-wrap">
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="text-base sm:text-lg font-semibold truncate gradient-text-gold">{project?.title} ÃÂ¢ÃÂÃÂ Credits</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-8">
        ...
        {(allCredits?.length || 0) > 0 && (
          <Card className="bg-black text-white border-0 glass-card shadow-lg shadow-amber-500/5 hover:shadow-amber-500/20 transition-shadow">
            <CardHeader className="pb-3 glass-card shadow-lg shadow-amber-500/5 hover:shadow-amber-500/20 transition-shadow">
              <CardTitle className="text-base text-center /80 gradient-text-gold glass-card shadow-lg shadow-amber-500/5 hover:shadow-amber-500/20 transition-shadow">Credits Preview</CardTitle>
            </CardHeader>
            <CardContent className="text-center space-y-6 py-8 glass-card shadow-lg shadow-amber-500/5 hover:shadow-amber-500/20 transition-shadow">
              {openingCredits.length > 0 && (
                <div className="space-y-4">
