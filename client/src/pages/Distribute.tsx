        ...
        <Card className="border-amber-500/20 bg-amber-500/5 glass-card shadow-lg shadow-amber-500/5 hover:shadow-amber-500/20 transition-shadow">
          <CardHeader className="pb-2 glass-card shadow-lg shadow-amber-500/5 hover:shadow-amber-500/20 transition-shadow">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-sm gradient-text-gold glass-card shadow-lg shadow-amber-500/5 hover:shadow-amber-500/20 transition-shadow">Film Page Analytics</CardTitle>
            </div>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader className="pb-3 glass-card shadow-lg shadow-amber-500/5 hover:shadow-amber-500/20 transition-shadow">
          <div className="flex items-center justify-between">
            <CardTitle className="text-base gradient-text-gold glass-card shadow-lg shadow-amber-500/5 hover:shadow-amber-500/20 transition-shadow">Distribution Readiness</CardTitle>
            <Badge
                  ...
                  <CardHeader className="pb-2 glass-card shadow-lg shadow-amber-500/5 hover:shadow-amber-500/20 transition-shadow">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <CardTitle className="text-sm gradient-text-gold glass-card shadow-lg shadow-amber-500/5 hover:shadow-amber-500/20 transition-shadow">{platform.label}</CardTitle>
                      </div>
                      {done && <Badge className="bg-green-600 text-xs">Done</Badge>}
                    </div>
                    <CardDescription className="text-xs glass-card shadow-lg shadow-amber-500/5 hover:shadow-amber-500/20 transition-shadow">{platform.description}</CardDescription>
                  </CardHeader>
        ...
        <TabsContent value="assets" className="space-y-4 mt-4">
          ...
          {promoAssets && (promoAssets as any[]).length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center border rounded-lg bg-muted/20">
              <Sparkles className="w-10 h-10 text-amber-400/70 mb-3" />
