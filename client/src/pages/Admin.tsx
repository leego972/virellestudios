      ...
      <div className="min-h-screen bg-black text-white p-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="bg-white/5 border-white/10 glass-card shadow-lg shadow-amber-500/5">
              <CardHeader><CardTitle className="text-base flex items-center gap-2 gradient-text-gold glass-card shadow-lg shadow-amber-500/5"><Shirt className="h-5 w-5 text-amber-400" />Seed Marketplace</CardTitle></CardHeader>
              <CardContent>
            ...
            <Card className="bg-white/5 border-white/10 glass-card shadow-lg shadow-amber-500/5">
              <CardHeader><CardTitle className="text-base flex items-center gap-2 gradient-text-gold glass-card shadow-lg shadow-amber-500/5"><DollarSign className="h-5 w-5 text-amber-400" />Seed Funding Sources</CardTitle></CardHeader>
              <CardContent>
            ...
            <Card className="bg-white/5 border-white/10 glass-card shadow-lg shadow-amber-500/5">
              <CardHeader><CardTitle className="text-base flex items-center gap-2 gradient-text-gold glass-card shadow-lg shadow-amber-500/5"><Rocket className="h-5 w-5 text-amber-400" />Seed Crowdfunding</CardTitle></CardHeader>
              <CardContent>
            ...
            <Card className="bg-white/5 border-white/10 glass-card shadow-lg shadow-amber-500/5">
              <CardHeader><CardTitle className="text-base flex items-center gap-2 gradient-text-gold glass-card shadow-lg shadow-amber-500/5"><Shirt className="h-5 w-5 text-purple-400" />Seed Executive Wardrobe</CardTitle></CardHeader>
              <CardContent>
            ...
            <Card className="bg-white/5 border-white/10 glass-card shadow-lg shadow-amber-500/5">
              <CardHeader><CardTitle className="text-base flex items-center gap-2 gradient-text-gold glass-card shadow-lg shadow-amber-500/5"><Star className="h-5 w-5 text-amber-400" />Seed Master Collections</CardTitle></CardHeader>
              <CardContent>
            ...
            <Card className="bg-white/5 border-white/10 glass-card shadow-lg shadow-amber-500/5">
              <CardHeader><CardTitle className="text-base flex items-center gap-2 gradient-text-gold glass-card shadow-lg shadow-amber-500/5"><Users className="h-5 w-5 text-blue-400" />Seed Signature Cast</CardTitle></CardHeader>
              <CardContent>
            ...
            <Card className="bg-white/5 border-white/10 glass-card shadow-lg shadow-amber-500/5">
              <CardHeader><CardTitle className="text-base flex items-center gap-2 gradient-text-gold glass-card shadow-lg shadow-amber-500/5"><Shield className="h-5 w-5 text-green-400" />Seed Uniforms</CardTitle></CardHeader>
              <CardContent>
            ...
            <Card className="bg-white/5 border-white/10 glass-card shadow-lg shadow-amber-500/5">
              <CardHeader><CardTitle className="text-base flex items-center gap-2 gradient-text-gold glass-card shadow-lg shadow-amber-500/5"><Users className="h-5 w-5 text-amber-400" />Beta Accounts</CardTitle></CardHeader>
              <CardContent>
          ...
          <div className="mt-6">
            <Button
              onClick={() => { if (confirm("Seed everything â marketplace, funding, and campaigns?")) seedEverything.mutate(); }}
