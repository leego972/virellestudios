          ...
          <Card className="mb-6 border-red-500/30 bg-red-500/5 shadow-lg shadow-red-500/5">
            ...
            <CardContent>
              <p className="mb-4 text-sm text-white/60">
                Review adult profiles, download private 90-day archive copies, apply legal holds,
                adjudicate blocked requests and manage confirmed blacklisted users.
              </p>
              <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                <Button
                  onClick={() => { window.location.href = "/virelle-broadcast-render?adminVault=1"; }}
