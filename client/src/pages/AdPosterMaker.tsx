            ...
            <TabsContent value="text" className="p-4 space-y-4 mt-0">
              ...
              {selectedElement && (
                <Card className="border-primary/20 bg-amber-400/5 glass-card shadow-lg shadow-amber-500/5 hover:shadow-amber-500/20 transition-shadow gold-glow">
                  ...
                  <CardContent className="space-y-3 px-3 pb-3 glass-card shadow-lg shadow-amber-500/5 hover:shadow-amber-500/20 transition-shadow">
                    <div>
        ...
        <DialogContent className="max-w-md glass-dark">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-muted/40 rounded-xl p-3 text-sm">
              <p className="font-medium">Output: <span className="text-amber-400">{config.width * exportScale}×{config.height * exportScale}px PNG</span></p>
