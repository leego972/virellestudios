...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Types ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Constants ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
const TEMPLATE_CONFIG: Record<TemplateType, { label: string; icon: React.ElementType; width: number; height: number; description: string; category: string; emoji: string }> = {
  "poster":             { label: "Movie Poster",      icon: RectangleHorizontal, width: 675,  height: 1000, description: "Classic 27ÃÂÃÂ40 portrait poster",            category: "Film",        emoji: "ÃÂ°ÃÂÃÂÃÂ¬" },
  "trailer-card":       { label: "Trailer Card",       icon: Clapperboard,        width: 1280, height: 720,  description: "YouTube/Vimeo trailer thumbnail",          category: "Film",        emoji: "ÃÂ°ÃÂÃÂÃÂÃÂ¯ÃÂ¸ÃÂ" },
  "dvd-cover":          { label: "DVD/Blu-ray",        icon: Disc3,               width: 780,  height: 1050, description: "Front cover with spine area",              category: "Film",        emoji: "ÃÂ°ÃÂÃÂÃÂ¿" },
  "letterbox":          { label: "Letterbox",          icon: Film,                width: 1200, height: 500,  description: "Cinematic widescreen banner",              category: "Film",        emoji: "ÃÂ°ÃÂÃÂÃÂ½ÃÂ¯ÃÂ¸ÃÂ" },
  "press-kit":          { label: "Press Kit",          icon: FileText,            width: 900,  height: 1200, description: "Professional media press layout",          category: "Film",        emoji: "ÃÂ°ÃÂÃÂÃÂ" },
  "withoutabox-poster": { label: "Festival Poster",    icon: Ticket,              width: 675,  height: 1000, description: "FilmFreeway / WithoutABox submission",     category: "Film",        emoji: "ÃÂ°ÃÂÃÂÃÂ" },
  "ig-feed":            { label: "IG Feed (4:5)",      icon: Square,              width: 1080, height: 1350, description: "Instagram feed post ÃÂ¢ÃÂÃÂ optimal 4:5 ratio",   category: "Instagram",   emoji: "ÃÂ°ÃÂÃÂÃÂ¸" },
  "ig-square":          { label: "IG Square (1:1)",    icon: Square,              width: 1080, height: 1080, description: "Instagram square post",                   category: "Instagram",   emoji: "ÃÂ¢ÃÂ¬ÃÂ" },
  "ig-story":           { label: "IG Story",           icon: Smartphone,          width: 1080, height: 1920, description: "Instagram Story ÃÂ¢ÃÂÃÂ 9:16 vertical",           category: "Instagram",   emoji: "ÃÂ°ÃÂÃÂÃÂ±" },
  "ig-reels":           { label: "IG Reels Cover",     icon: Smartphone,          width: 1080, height: 1920, description: "Reels cover thumbnail ÃÂ¢ÃÂÃÂ 9:16",            category: "Instagram",   emoji: "ÃÂ°ÃÂÃÂÃÂµ" },
  "tiktok-vertical":    { label: "TikTok Video",       icon: Smartphone,          width: 1080, height: 1920, description: "TikTok video ad ÃÂ¢ÃÂÃÂ 9:16 vertical",         category: "TikTok",      emoji: "ÃÂ°ÃÂÃÂÃÂµ" },
  "tiktok-thumbnail":   { label: "TikTok Thumbnail",   icon: Square,              width: 1080, height: 1080, description: "TikTok profile/cover thumbnail",           category: "TikTok",      emoji: "ÃÂ°ÃÂÃÂÃÂ¼ÃÂ¯ÃÂ¸ÃÂ" },
  "fb-feed":            { label: "FB Feed Ad",         icon: Monitor,             width: 1200, height: 628,  description: "Facebook feed image ad ÃÂ¢ÃÂÃÂ 1.91:1",        category: "Facebook",    emoji: "ÃÂ°ÃÂÃÂÃÂ" },
  "fb-story":           { label: "FB Story",           icon: Smartphone,          width: 1080, height: 1920, description: "Facebook Story ÃÂ¢ÃÂÃÂ 9:16 vertical",          category: "Facebook",    emoji: "ÃÂ°ÃÂÃÂÃÂ±" },
  "fb-cover":           { label: "FB Page Cover",      icon: Monitor,             width: 1640, height: 624,  description: "Facebook Page cover photo",               category: "Facebook",    emoji: "ÃÂ°ÃÂÃÂÃÂ¼ÃÂ¯ÃÂ¸ÃÂ" },
  "discord-banner":     { label: "Discord Banner",     icon: Monitor,             width: 960,  height: 540,  description: "Discord server banner ÃÂ¢ÃÂÃÂ 16:9",           category: "Discord",     emoji: "ÃÂ°ÃÂÃÂÃÂ¬" },
  "discord-card":       { label: "Discord Card",       icon: Square,              width: 800,  height: 450,  description: "Discord announcement embed card",         category: "Discord",     emoji: "ÃÂ°ÃÂÃÂÃÂ¢" },
  "yt-thumbnail":       { label: "YT Thumbnail",       icon: Monitor,             width: 1280, height: 720,  description: "YouTube video thumbnail ÃÂ¢ÃÂÃÂ 16:9",         category: "YouTube",     emoji: "ÃÂ¢ÃÂÃÂ¶ÃÂ¯ÃÂ¸ÃÂ" },
  "yt-shorts":          { label: "YT Shorts",          icon: Smartphone,          width: 1080, height: 1920, description: "YouTube Shorts ÃÂ¢ÃÂÃÂ 9:16 vertical",          category: "YouTube",     emoji: "ÃÂ°ÃÂÃÂÃÂ²" },
  "yt-channel-art":     { label: "YT Channel Art",     icon: Monitor,             width: 2560, height: 1440, description: "YouTube channel banner art",               category: "YouTube",     emoji: "ÃÂ°ÃÂÃÂÃÂ¨" },
  "social-square":      { label: "Social Square",      icon: Square,              width: 800,  height: 800,  description: "Generic square social post",              category: "Marketing",   emoji: "ÃÂ°ÃÂÃÂÃÂ£" },
  "social-story":       { label: "Social Story",       icon: Smartphone,          width: 540,  height: 960,  description: "Generic story format",                   category: "Marketing",   emoji: "ÃÂ°ÃÂÃÂÃÂ±" },
  "social-ad":          { label: "Social Ad",          icon: Megaphone,           width: 1080, height: 1080, description: "High-res social media ad",                category: "Marketing",   emoji: "ÃÂ°ÃÂÃÂÃÂ¢" },
  "banner":             { label: "Banner",             icon: Monitor,             width: 1280, height: 720,  description: "YouTube thumbnail, website header",       category: "Marketing",   emoji: "ÃÂ°ÃÂÃÂÃÂ¥ÃÂ¯ÃÂ¸ÃÂ" },
  "billboard":          { label: "Billboard",          icon: Megaphone,           width: 1200, height: 400,  description: "Ultra-wide outdoor advertising",          category: "Marketing",   emoji: "ÃÂ°ÃÂÃÂÃÂºÃÂ¯ÃÂ¸ÃÂ" },
  "event-flyer":        { label: "Event Flyer",        icon: Ticket,              width: 600,  height: 900,  description: "Premiere, screening, festival",           category: "Marketing",   emoji: "ÃÂ°ÃÂÃÂÃÂÃÂ¯ÃÂ¸ÃÂ" },
  "influencer-kit":     { label: "Influencer Kit",     icon: Sparkles,            width: 1080, height: 1080, description: "Influencer outreach square card",         category: "Marketing",   emoji: "ÃÂ¢ÃÂÃÂ¨" },
  "album-art":          { label: "Soundtrack Art",     icon: Music,               width: 800,  height: 800,  description: "Soundtrack or score album cover",         category: "Other",       emoji: "ÃÂ°ÃÂÃÂÃÂµ" },
};
...
const BADGE_PRESETS: { type: BadgeOverlay["type"]; label: string; color: string; bgColor: string; emoji: string }[] = [
  { type: "now-streaming",    label: "NOW STREAMING",     color: "#ffffff", bgColor: "#e50914", emoji: "ÃÂ¢ÃÂÃÂ¶ÃÂ¯ÃÂ¸ÃÂ" },
  { type: "award-winner",     label: "AWARD WINNER",      color: "#000000", bgColor: "#ffd700", emoji: "ÃÂ°ÃÂÃÂÃÂ" },
  { type: "official-selection", label: "OFFICIAL SELECTION", color: "#ffffff", bgColor: "#1a1a2e", emoji: "ÃÂ°ÃÂÃÂÃÂ¬" },
  { type: "coming-soon",      label: "COMING SOON",       color: "#ffffff", bgColor: "#0a0a0a", emoji: "ÃÂ°ÃÂÃÂÃÂ" },
  { type: "limited-release",  label: "LIMITED RELEASE",   color: "#ffffff", bgColor: "#7c3aed", emoji: "ÃÂ°ÃÂÃÂÃÂ" },
  { type: "watch-now",        label: "WATCH NOW",         color: "#000000", bgColor: "#f59e0b", emoji: "ÃÂ°ÃÂÃÂÃÂ¥" },
];
...
function getDefaultTextElements(templateType: TemplateType): TextElement[] {
  ...
  if (["poster", "dvd-cover", "press-kit", "event-flyer"].includes(templateType)) {
    base.push(
      ...
      {
        id: generateId(), text: "Directed by ÃÂ¢ÃÂÃÂ¢ Produced by ÃÂ¢ÃÂÃÂ¢ Starring", x: w / 2, y: h * 0.93,
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ History Hook ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Component ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
function AdPosterMakerInner() {
  ...
  return (
    <div className="min-h-screen" style={{ background:"linear-gradient(135deg,#07070e 0%,#0c0b18 60%,#07070a 100%)" }}>
      {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Hero Header ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Professional film marketing assets ÃÂ¢ÃÂÃÂ posters, ads, video content & brand kits
            </p>
          </div>
      ...
      {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Main Layout ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
      <div className="flex flex-col lg:flex-row gap-0 h-[calc(100vh-180px)] overflow-hidden">

        {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Canvas Area ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
        <div className="flex-1 flex flex-col bg-[#0a0a0a] overflow-hidden">
          {/* Canvas toolbar */}
          <div className="flex items-center justify-between px-4 py-2 border-b border-white/5">
            <div className="flex items-center gap-2">
              <Badge variant="outline" className="text-xs border-white/10 text-white/60">{config.label} ÃÂ¢ÃÂÃÂ {config.width}ÃÂÃÂ{config.height}</Badge>
        ...
        <div className="w-full lg:w-[380px] border-l border-border/50 bg-card overflow-y-auto flex-shrink-0">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full">
            ...
            {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Design Tab ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
                ...
                <div className="grid grid-cols-1 gap-1.5 mt-2 max-h-[260px] overflow-y-auto pr-0.5">
                  {filteredTemplates.map(([type, cfg]) => (
                    ...
                    >
                      ...
                      <Badge variant="outline" className="text-[10px] shrink-0 border-border/50">{cfg.width}ÃÂÃÂ{cfg.height}</Badge>
                    </button>
                  ))}
                </div>
              </div>
            ...
            {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Text Tab ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
              ...
              {selectedElement && (
                <Card className="border-primary/20 bg-amber-400/5 glass-card">
                  <CardHeader className="pb-2 pt-3 px-3 glass-card">
                    <CardTitle className="text-xs font-semibold text-amber-400 uppercase tracking-wider gradient-text-gold glass-card">Edit Selected Layer</CardTitle>
                  </CardHeader>
            ...
            {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Style Tab ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
                ...
                {poster.gradient.enabled && (
                  <div className="space-y-3 mt-2">
                    ...
                    {poster.gradient.type === "linear" && (
                      <div>
                        <Label className="text-xs">Angle: {poster.gradient.angle}ÃÂÃÂ°</Label>
                  ...
                  {[
                    ...
                    <div key={key}>
                      <Label className="text-xs flex items-center gap-1">
                        <Icon className="h-3 w-3" /> {label}: {poster.filters[key]}{key === "blur" ? "px" : key === "hueRotate" ? "ÃÂÃÂ°" : "%"}
                      </Label>
            ...
            {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Publish Tab ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
            <TabsContent value="publish" className="p-4 mt-0">
              <PublishTab currentTemplate={poster.templateType} />
            </TabsContent>

            {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ More Tab ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
      ...
      {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Export Dialog ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
          ...
          <div className="space-y-4">
            <div>
              ...
              <Select value={exportScale.toString()} onValueChange={(v) => setExportScale(Number(v))}>
                ...
                <SelectContent>
                  <SelectItem value="1">1ÃÂÃÂ ÃÂ¢ÃÂÃÂ {config.width}ÃÂÃÂ{config.height}px (Preview)</SelectItem>
                  <SelectItem value="2">2ÃÂÃÂ ÃÂ¢ÃÂÃÂ {config.width * 2}ÃÂÃÂ{config.height * 2}px (Recommended)</SelectItem>
                  <SelectItem value="3">3ÃÂÃÂ ÃÂ¢ÃÂÃÂ {config.width * 3}ÃÂÃÂ{config.height * 3}px (Print Quality)</SelectItem>
                  <SelectItem value="4">4ÃÂÃÂ ÃÂ¢ÃÂÃÂ {config.width * 4}ÃÂÃÂ{config.height * 4}px (Ultra HD)</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="bg-muted/40 rounded-xl p-3 text-sm">
              <p className="font-medium">Output: <span className="text-amber-400">{config.width * exportScale}ÃÂÃÂ{config.height * exportScale}px PNG</span></p>
              <p className="text-xs text-muted-foreground mt-1">Template: {config.label} ÃÂ¢ÃÂÃÂ {config.description}</p>
            </div>
          </div>
          <DialogFooter>
      ...
      {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ QR Code Dialog ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
      ...
      {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Tagline Variants Dialog ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
      ...
      {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Brand Kit Dialog ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Publish Tab ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
const PLATFORM_META: Record<string, { name: string; icon: string; color: string; maxFileSizeMB: number; formats: string; notes: string }> = {
  instagram: { name: "Instagram", icon: "ÃÂ°ÃÂÃÂÃÂ¸", color: "border-pink-500/30 bg-pink-500/5",    maxFileSizeMB: 8,   formats: "JPG, PNG", notes: "Max 8 MB. 1080px wide. Ratios: 1:1, 4:5, 9:16." },
  tiktok:    { name: "TikTok",    icon: "ÃÂ°ÃÂÃÂÃÂµ", color: "border-cyan-500/30 bg-cyan-500/5",    maxFileSizeMB: 20,  formats: "JPG, PNG, MP4", notes: "Max 20 MB. Videos: 9:16, up to 60s. Min 720p." },
  facebook:  { name: "Facebook",  icon: "ÃÂ°ÃÂÃÂÃÂ", color: "border-blue-500/30 bg-blue-500/5",    maxFileSizeMB: 30,  formats: "JPG, PNG", notes: "Max 30 MB. Feed: 1.91:1. Stories: 9:16." },
  discord:   { name: "Discord",   icon: "ÃÂ°ÃÂÃÂÃÂ¬", color: "border-indigo-500/30 bg-indigo-500/5", maxFileSizeMB: 8,   formats: "JPG, PNG, GIF", notes: "Max 8 MB. Banner: 960ÃÂÃÂ540. Embeds: 16:9." },
  youtube:   { name: "YouTube",   icon: "ÃÂ¢ÃÂÃÂ¶ÃÂ¯ÃÂ¸ÃÂ", color: "border-red-500/30 bg-red-500/5",      maxFileSizeMB: 2,   formats: "JPG, PNG", notes: "Thumbnails: max 2 MB, 1280ÃÂÃÂ720." },
};
                ...
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-1.5 flex-wrap">
                      ...
                      {isCurrentOptimal && (
                        <Badge className="text-[10px] bg-amber-500/20 text-amber-400 border-amber-500/30 h-4">ÃÂ¢ÃÂÃÂ Optimal</Badge>
                      )}
                    </div>
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Festival & Distribution Tab ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ

const FESTIVAL_PLATFORMS = [
  { name: "FilmFreeway",     icon: "ÃÂ°ÃÂÃÂÃÂ", description: "World's leading festival submission platform. 10,000+ festivals.", url: "https://filmfreeway.com",      type: "submission" },
  { name: "Festhome",        icon: "ÃÂ°ÃÂÃÂÃÂ", description: "5,000+ festivals worldwide with easy online submissions.",         url: "https://festhome.com",         type: "submission" },
  { name: "Vimeo On Demand", icon: "ÃÂ°ÃÂÃÂÃÂ¡", description: "Self-distribute directly to audiences. Set your own price.",       url: "https://vimeo.com/ondemand",   type: "distribution" },
  { name: "Reelport",        icon: "ÃÂ°ÃÂÃÂÃÂ¦", description: "European film distribution and festival submission platform.",     url: "https://www.reelport.com",     type: "distribution" },
];
    ...
    <div className="space-y-4">
          ...
          {["submission", "distribution"].map((type) => (
            <div key={type}>
              <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider mb-1.5">
                {type === "submission" ? "ÃÂ°ÃÂÃÂÃÂ Festival Submissions" : "ÃÂ°ÃÂÃÂÃÂ¡ Self-Distribution"}
              </p>
              <div className="space-y-1.5">
      ...
      <div>
        ...
        <div className="space-y-1.5 mt-2">
          {[
            { item: "Movie Poster (27ÃÂÃÂ40)", template: "poster" },
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Influencer Kit Tab ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
function InfluencerKitTab({ projectTitle, projectGenre, projectLogline }: { projectTitle?: string; projectGenre?: string; projectLogline?: string }) {
  ...
  const kitSections = generatedKit ? [
    { label: "Social Caption", key: "caption" as const, icon: "ÃÂ°ÃÂÃÂÃÂ¸" },
    { label: "Hashtags", key: "hashtags" as const, icon: "#ÃÂ¯ÃÂ¸ÃÂÃÂ¢ÃÂÃÂ£" },
    { label: "Email Pitch", key: "emailPitch" as const, icon: "ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ" },
    { label: "LinkedIn Post", key: "linkedinPost" as const, icon: "ÃÂ°ÃÂÃÂÃÂ¼" },
    ...(generatedKit.pressRelease ? [{ label: "Press Release", key: "pressRelease" as const, icon: "ÃÂ°ÃÂÃÂÃÂ°" }] : []),
  ] : [];
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Utility ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
