...
const STEPS = [
  {
    ...
    description: "Start with a title, genre, and a short description of your film or scene. You can be as detailed or as brief as you like ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Virelle's AI adapts to your level of direction.",
    details: [
      "Describe your story in plain language ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ no technical knowledge required",
    ...
    icon: FileText,
    color: "amber",
    time: "5ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ15 minutes",
  },
  {
    number: "02",
    title: "AI Generates Your Screenplay",
    description: "Virelle's AI Script Writer breaks your concept into a full screenplay ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ scenes, dialogue, stage directions, and character arcs ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ all faithful to your original vision.",
    details: [
    ...
    icon: BookOpen,
    color: "amber",
    time: "1ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ3 minutes",
  },
  {
    number: "03",
    ...
    icon: Image,
    color: "purple",
    time: "2ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ5 minutes per scene",
  },
  {
    number: "04",
    title: "Generate Scene Videos",
    description: "Convert each scene into a cinematic video clip using your choice of AI video provider ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Runway, fal.ai, or Google Veo 3. Each clip is generated to your exact specifications.",
    details: [
      "Choice of Runway Gen-4, fal.ai, or Google Veo 3",
      "Bring your own API keys ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ your generation costs, your control",
      "Up to 4K resolution, 24/30/60fps",
      "Scene-to-scene character and visual continuity",
    ],
    icon: Video,
    color: "blue",
    time: "30ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ120 seconds per scene",
  },
  {
    number: "05",
...
const DELIVERABLES = [
  ...
  { icon: Mic, label: "Voice Acting Tracks", desc: "Individual character audio files ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ 35 emotion states, per-emotion ElevenLabs tuning" },
...
const OWNERSHIP = [
  {
    ...
    desc: "All outputs ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ scripts, images, video clips, soundtracks, and assembled films ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ are yours. Virelle does not claim any rights to content generated on your account.",
    icon: Shield,
  },
  {
  ...
  },
  {
    ...
    desc: "Virelle uses a BYOK (Bring Your Own Key) model for video generation. Your Runway, fal.ai, or Google Veo 3 API keys are used directly ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Virelle never marks up your generation costs.",
    icon: Star,
  },
  {
    title: "Revision policy",
    desc: "You can regenerate any scene, rewrite any dialogue, or re-score any sequence at any time. Credits are consumed per generation ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ unused credits roll over for 90 days.",
    icon: RefreshCw,
  },
];
...
const WORKFLOWS = [
  {
    title: "Self-Directed",
    desc: "You control every decision. Virelle executes your instructions precisely ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ no unsolicited creative changes.",
    icon: Wand2,
    color: "amber",
  },
  {
    title: "AI-Assisted",
    desc: "Grant creative leeway and Virelle's AI acts as a co-director ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ suggesting scene improvements, visual upgrades, and pacing adjustments.",
    icon: Sparkles,
    color: "purple",
  },
  {
...
export default function HowItWorks() {
  ...
  return (
    <div className="min-h-screen text-foreground" style={{ background:"linear-gradient(135deg,#07070e 0%,#0c0b18 60%,#07070a 100%)" }}>
      <SiteHead title="How It Works ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Virelle Studios" description="See how Virelle Studios turns your concept into a complete film in minutes ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ script, storyboard, characters, sound, subtitles, and funding application in one platform." />
      {/* Nav */}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 text-center border-b border-border/40">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg text-foreground/70 leading-relaxed mb-8">
            A professional AI-assisted production workflow ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ from your first idea to a finished, distributable film. Every step is under your direction.
          </p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold mb-4 text-gold-shimmer">The Production Pipeline</h2>
            <p className="text-foreground/60 max-w-xl mx-auto">Six stages from concept to finished film. You control the pace ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ move through stages in sequence or jump back to refine any step.</p>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-card/30 border-y border-border/40">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-foreground/60">Choose how much creative control you hand to the AI ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ or keep it all yourself.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {WORKFLOWS.map((w) => {
              ...
              return (
                <Card key={w.title} className="bg-card/50 border-border/50 glass-card shadow-lg shadow-amber-500/5 hover:shadow-amber-500/20 transition-shadow gold-glow">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-gold-shimmer">What You Receive</h2>
            <p className="text-foreground/60 max-w-xl mx-auto">Every project produces a full suite of production-ready assets ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ not just video clips.</p>
          </div>
            ...
            {DELIVERABLES.map((d) => {
              ...
              return (
                <div key={d.label} className="p-5 rounded-xl border border-border/50 bg-card/40 hover:border-amber-500/30 transition-colors">
                  ...
                  <h4 className="font-semibold text-sm mb-1 gradient-text-gold">{d.label}</h4>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-card/30 border-y border-border/40">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-gold-shimmer">Ownership & Rights</h2>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-foreground/70 leading-relaxed mb-4">
                  Virelle uses a <strong>Bring Your Own Key</strong> model for AI video generation. You connect your own Runway, fal.ai, or Google Veo 3 API account in Settings. When you generate a video, Virelle sends the request directly to your API account ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ you pay your provider's rates, not ours.
                </p>
                <p className="text-foreground/70 leading-relaxed mb-4">
                  This means your video generation costs are transparent, predictable, and never marked up. Virelle credits cover the platform's AI features ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ script writing, image generation, chat, analysis ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ not the video generation itself.
                </p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 text-center border-t border-border/40">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl font-bold mb-4 text-gold-shimmer">Ready to start your first film?</h2>
