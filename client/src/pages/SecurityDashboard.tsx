...
export default function SecurityDashboard() {
  ...
  return (
    <div className="min-h-screen space-y-6 pb-8 px-4 py-4" style={{ background:"linear-gradient(135deg,#07070e 0%,#0c0b18 60%,#07070a 100%)" }}>
      {/* Header */}
      ...
      {statsQuery.isLoading ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          ...
          <Card className="border-border/50 bg-card/80 col-span-2 glass-card shadow-lg shadow-amber-500/5 hover:shadow-amber-500/20 transition-shadow">
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
