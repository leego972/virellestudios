    ...
    <div className="max-w-6xl mx-auto p-8 text-white min-h-screen" style={{ background:"linear-gradient(135deg,#07070e 0%,#0c0b18 60%,#07070a 100%)" }}>
      ...
      <div className="flex gap-4 mb-8">
        <button 
          ...
          className={`px-6 py-2 rounded-full font-bold transition-all ${view === "gallery" ? "bg-blue-600 text-white" : "bg-zinc-900 text-zinc-500 hover:bg-amber-500/10"}`}
        >
          My Locations
        </button>
        <button 
          ...
          className={`px-6 py-2 rounded-full font-bold transition-all ${view === "upload" && !selectedLocationId ? "bg-blue-600 text-white" : "bg-zinc-900 text-zinc-500 hover:bg-amber-500/10"}`}
        >
          New Recreation
        </button>
      </div>
