  ...
  const PRODUCTION_PHASES = [
    {
      ...
      color: "amber", border: "border-amber-500/25", bg: "bg-amber-500/5", head: "text-amber-400", glow: "rgba(245,196,66,0.08)",
      tools: [
    ...
    {
      id: "preproduction", phase: "02", label: "Pre-Production", emoji: "🎬",
    ...
    {
      id: "casting", phase: "03", label: "Casting & Crew", emoji: "🎭",
    ...
    {
      id: "production", phase: "04", label: "Production", emoji: "🎥",
    ...
    {
      id: "postproduction", phase: "05", label: "Post-Production", emoji: "✨",
      ...
      tools: [
        ...
        { label: "Opening Sequence", description: "Crawl · Narrator · Titles", icon: Film, path: (id: number) => `/projects/${id}/opening-sequence`, needsProject: true, badge: "NEW" },
      ] as PhaseTool[],
    },
    {
      id: "finishing", phase: "06", label: "Finishing", emoji: "🎞️",
    ...
    {
      id: "marketing", phase: "07", label: "Marketing", emoji: "📣",
      ...
      tools: [
        ...
        { label: "Social Cuts", description: "Reels · TikTok · YouTube", icon: Share2, path: (id: number) => `/projects/${id}/social-cuts`, needsProject: true },
      ...
      <div className="max-w-7xl mx-auto space-y-8 pb-12">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-2 shrink-0">
            {user && ["indie","amateur","independent","creator","studio","industry","beta"].includes((user as any).subscriptionTier || "") && (
              <Button variant="outline" onClick={() => setLocation("/funding")} className="gap-2 border-amber-500/40 text-amber-500 hover:bg-amber-500/10 hover:text-amber-400" size="sm">
        ...
        {providers !== undefined && !hasApiKey && (
          <div className="flex items-start gap-3 rounded-xl border border-amber-500/40 bg-amber-500/10 px-4 py-3.5">
            ...
            <Button size="sm" variant="outline" className="border-amber-500/40 text-amber-700 dark:text-amber-300 hover:bg-amber-500/10 text-xs shrink-0" onClick={() => setLocation("/settings?tab=api-keys")}>
                  ...
                  return (
                    <Link key={s.key} href={s.hrefFor(p.id)} className="shrink-0">
                      <div className={`h-9 px-2.5 rounded-lg flex items-center gap-1.5 text-xs font-medium border transition-colors ${
                        ...
                        : status === "active" ? "border-primary/60 bg-primary/15 text-primary"
                ...
                <CardContent className="p-6 flex flex-col items-center text-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1.5 max-w-xs mx-auto leading-relaxed">
                      Name your project, choose a genre, build characters, write scenes — Virelle's pipeline guides you from concept to screen.
                    </p>
                  </div>
              ...
              <div className="mt-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  {recentCompleted.map((p) => (
                    <Card key={p.id} className="cursor-pointer hover:border-primary/30 transition-all bg-card/40" onClick={() => setLocation(`/projects/${p.id}`)}>
                  ...
                  return (
                    ...
                    <div key={item.id} className="flex items-start gap-3 py-2.5 px-3 rounded-lg hover:bg-muted/30 transition-colors cursor-pointer" onClick={() => setLocation(`/projects/${item.id}`)}>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[10px] text-muted-foreground mt-0.5">{item.action} · {timeAgo(item.updatedAt)}</p>
                      </div>
                    </div>
                  );
                })}
