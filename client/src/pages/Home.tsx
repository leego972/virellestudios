import { useAuth } from "@/_core/hooks/useAuth";
  ...
  const PRODUCTION_PHASES = [
    {
      id: "development", phase: "01", label: "Development", emoji: "ÃÂ°ÃÂÃÂÃÂ",
    ...
    {
      id: "preproduction", phase: "02", label: "Pre-Production", emoji: "ÃÂ°ÃÂÃÂÃÂ¬",
    ...
    {
      id: "casting", phase: "03", label: "Casting & Crew", emoji: "ÃÂ°ÃÂÃÂÃÂ­",
    ...
    {
      id: "production", phase: "04", label: "Production", emoji: "ÃÂ°ÃÂÃÂÃÂ¥",
    ...
    {
      id: "postproduction", phase: "05", label: "Post-Production", emoji: "ÃÂ¢ÃÂÃÂ¨",
      ...
      tools: [
        ...
        { label: "Opening Sequence", description: "Crawl ÃÂÃÂ· Narrator ÃÂÃÂ· Titles", icon: Film, path: (id: number) => `/projects/${id}/opening-sequence`, needsProject: true, badge: "NEW" },
      ] as PhaseTool[],
    },
    {
      id: "finishing", phase: "06", label: "Finishing", emoji: "ÃÂ°ÃÂÃÂÃÂÃÂ¯ÃÂ¸ÃÂ",
    ...
    {
      id: "marketing", phase: "07", label: "Marketing", emoji: "ÃÂ°ÃÂÃÂÃÂ£",
      ...
      tools: [
        ...
        { label: "Social Cuts", description: "Reels ÃÂÃÂ· TikTok ÃÂÃÂ· YouTube", icon: Share2, path: (id: number) => `/projects/${id}/social-cuts`, needsProject: true },
    ...
    {
      id: "distribution", phase: "08", label: "Distribution", emoji: "ÃÂ°ÃÂÃÂÃÂ",
  ...
  export default function Home() {
    ...
    useEffect(() => {
      ...
      if (params.get("subscription") === "success") { toast.success("ÃÂ°ÃÂÃÂÃÂ¬ Welcome to Virelle Studios! Your membership is now active."); window.history.replaceState({}, "", "/"); }
    }, []);
      ...
      <div className="max-w-7xl mx-auto space-y-8 pb-12">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-1 text-sm">Your AI film production studio ÃÂ¢ÃÂÃÂ let's make something great.</p>
          </div>
          ...
          <div className="flex items-start gap-3 rounded-xl border border-amber-500/40 bg-amber-400/10 px-4 py-3.5">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-700 dark:text-amber-200/70 mt-0.5 leading-relaxed">
                Virelle uses your own AI provider keys (Runway ML, fal.ai, Sora, etc.) ÃÂ¢ÃÂÃÂ you only pay for what you generate.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-primary/30 bg-gradient-to-br from-primary/5 to-primary/0 p-4 sm:p-5 space-y-4">
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">Stage {currentStage} of 8 ÃÂ¢ÃÂÃÂ {cur.title}</p>
                </div>
                <Link href={next.hrefFor(p.id)}><Button className="min-h-[40px] gap-2 whitespace-nowrap">{currentStage === 8 ? "Plan release" : `Continue ÃÂ¢ÃÂÃÂ Stage ${next.number}`}</Button></Link>
              </div>
        ...
        <div>
          <div className="flex flex-wrap items-center justify-between gap-4 mb-5">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">Every tool in your studio ÃÂ¢ÃÂÃÂ from concept to distribution</p>
            </div>
            <div className="flex items-center gap-3">
              ...
              {projects && projects.length > 0 && (
                <div className="flex items-center gap-2">
                  ...
                  >
                    <option value="">ÃÂ¢ÃÂÃÂ select project ÃÂ¢ÃÂÃÂ</option>
            ...
            {isLoading ? (
                ...
                <CardContent className="p-6 flex flex-col items-center text-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1.5 max-w-xs mx-auto leading-relaxed">
                      Name your project, choose a genre, build characters, write scenes ÃÂ¢ÃÂÃÂ Virelle's pipeline guides you from concept to screen.
                    </p>
                  </div>
              ...
              <div className="space-y-3">
                {inProgressProjects.map((project) => (
                  <Card key={project.id} className="cursor-pointer hover:border-amber-400/40 transition-all hover:shadow-sm bg-card/60 glass-card" onClick={() => setLocation(`/projects/${project.id}`)}>
              ...
              <div className="mt-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  {recentCompleted.map((p) => (
                    <Card key={p.id} className="cursor-pointer hover:border-primary/30 transition-all bg-card/40 glass-card" onClick={() => setLocation(`/projects/${p.id}`)}>
                  ...
                  return (
                    ...
                    <div key={item.id} className="flex items-start gap-3 py-2.5 px-3 rounded-lg hover:bg-muted/30 transition-colors cursor-pointer" onClick={() => setLocation(`/projects/${item.id}`)}>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[10px] text-muted-foreground mt-0.5">{item.action} ÃÂÃÂ· {timeAgo(item.updatedAt)}</p>
                      </div>
                    </div>
                  );
                })}
