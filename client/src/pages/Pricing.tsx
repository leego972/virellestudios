...
const CREDIT_PACKS = [
  { id: "topup_10",   credits: 100,   price: 900,    perCredit: 0.09,  label: "Starter" },
  { id: "topup_50",   credits: 500,   price: 3900,   perCredit: 0.078, label: "Producer" },
  { id: "topup_100",  credits: 1500,  price: 9900,   perCredit: 0.066, label: "Director" },
  { id: "topup_200",  credits: 5000,  price: 29900,  perCredit: 0.060, label: "Studio" },
  { id: "topup_500",  credits: 15000, price: 79900,  perCredit: 0.053, label: "Blockbuster", popular: true },
  { id: "topup_1000", credits: 50000, price: 199900, perCredit: 0.040, label: "Mogul" },
];

const CREDIT_COSTS = [
  { action: "Create New Project", cost: 0, icon: "📁" },
  { action: "Generate Film (AI Scene Breakdown)", cost: 5, icon: "🎬" },
  { action: "Generate Scene Video (≤45s)", cost: 50, icon: "🎥" },
  { action: "Regenerate Scene Video", cost: 40, icon: "🔄" },
  { action: "Generate Preview Image", cost: 2, icon: "🖼️" },
  { action: "Bulk Generate All Previews (per scene)", cost: 2, icon: "📸" },
  { action: "Bulk Generate All Videos (per scene)", cost: 50, icon: "📹" },
  { action: "Virelle AI Chat (per message)", cost: 1, icon: "💬" },
  { action: "AI Script Writer", cost: 10, icon: "📝" },
  { action: "AI Storyboard Generation", cost: 10, icon: "🎨" },
            ...
            <div className="mt-8 p-5 rounded-xl border border-border/50 bg-card/40">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 text-center">
                {[
                  ...
                  { tier: "Independent", credits: 500, monthly: 9900, perCredit: 0.09, color: "text-amber-400" },
                  { tier: "Creator", credits: 1500, monthly: 24900, perCredit: 0.066, color: "text-cyan-400" },
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-zinc-800">
                {[
                  ...
                  { feature: "Monthly Price", independent: "$99", creator: "$249", studio: "$499", industry: "$999" },
                  { feature: "Annual Price", independent: "$990", creator: "$2,490", studio: "$4,990", industry: "$9,990" },
                  { feature: "Monthly Credits", amateur: "100", independent: "500", creator: "1,500", studio: "4,000", industry: "12,000" },
                  ...
                  { feature: "Ad & Poster Maker", amateur: false, independent: true, creator: true, studio: true, industry: true },
                  { feature: "Platform Templates (Instagram, TikTok, Facebook, Discord, YouTube)", amateur: false, independent: true, creator: true, studio: true, industry: true },
                  { feature: "Direct Publish to Social Platforms", amateur: false, independent: true, creator: true, studio: true, industry: true },
                  { feature: "Connected Platform Accounts", amateur: false, independent: "2 platforms", creator: "3 platforms", studio: "5 platforms", industry: "Unlimited" },
                  { feature: "AI Video Ad Generation", amateur: false, independent: true, creator: true, studio: true, industry: true },
                  { feature: "Press Kit Builder", amateur: false, independent: true, creator: true, studio: true, industry: true },
                  { feature: "Billboard & Outdoor Ad Templates", amateur: false, independent: true, creator: true, studio: true, industry: true },
                  { feature: "Festival & Distribution Hub (FilmFreeway, WithoutABox)", amateur: false, independent: true, creator: true, studio: true, industry: true },
                  { feature: "Influencer Outreach Kit Generator", amateur: false, independent: true, creator: true, studio: true, industry: true },
