            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-zinc-800">
                {[
                  ...
                  { feature: "Script Writer", free: true, pro: true, industry: true },
                  { feature: "Storyboard", free: true, pro: true, industry: true },
                  { feature: "AI Character Generation", free: true, pro: true, industry: true },
                  { feature: "AI Script Generation", free: true, pro: true, industry: true },
                  { feature: "AI Dialogue Generation", free: true, pro: true, industry: true },
                  ...
                  { feature: "Bulk Generate", free: false, pro: true, industry: true },
                  ...
                  { feature: "AI Budget Generation", free: false, pro: true, industry: true },
                  { feature: "AI Subtitle Generation", free: false, pro: true, industry: true },
                  { feature: "AI Location Suggestions", free: false, pro: true, industry: true },
                  { feature: "Collaboration", free: false, pro: "5 members", industry: "Unlimited" },
                  { feature: "HD Export (1080p)", free: false, pro: true, industry: true },
                  { feature: "Ultra HD Export (4K)", free: false, pro: false, industry: true },
                ].map((row, i) => (
