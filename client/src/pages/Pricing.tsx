      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 relative z-10">
        ...
        <div className="text-center mb-8 sm:mb-12">
          <div className="flex items-center justify-center gap-3 mb-4">
            <img src="/vs-watermark.png" alt="Virelle Studios" className="h-14 w-14 rounded-lg" />
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-zinc-800">
                {[
                  ...
                  { feature: "Ad & Poster Maker", amateur: false, independent: false, creator: false, studio: true, industry: true },
                  { feature: "Platform Templates (Instagram, TikTok, Facebook, Discord, YouTube)", amateur: false, independent: false, creator: false, studio: true, industry: true },
                  { feature: "Direct Publish to Social Platforms", amateur: false, independent: false, creator: false, studio: true, industry: true },
                  { feature: "Connected Platform Accounts", amateur: false, independent: false, creator: false, studio: "3 platforms", industry: "Unlimited" },
                  { feature: "AI Video Ad Generation", amateur: false, independent: false, creator: false, studio: true, industry: true },
                  { feature: "Press Kit Builder", amateur: false, independent: false, creator: true, studio: true, industry: true },
                  { feature: "Billboard & Outdoor Ad Templates", amateur: false, independent: false, creator: true, studio: true, industry: true },
                  { feature: "Festival & Distribution Hub (FilmFreeway, WithoutABox)", amateur: false, independent: false, creator: false, studio: true, industry: true },
                  { feature: "Influencer Outreach Kit Generator", amateur: false, independent: false, creator: false, studio: true, industry: true },
