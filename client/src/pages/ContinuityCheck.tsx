...
import { Loader2, ArrowLeft, ShieldCheck, AlertTriangle, AlertCircle, Info, Sparkles, Download } from "lucide-react";
            ...
            {report && (
              <Button variant="outline" size="sm" onClick={() => {
                const lines: string[] = [
                  ...
                  ``,
                  `Issues: ${highCount} High, ${medCount} Medium, ${lowCount} Low`,
                  `${'='.repeat(60)}`,
                  ``
                ];
                report.issues.forEach((issue, idx) => {
                  lines.push(`[${issue.severity.toUpperCase()}] ${issue.category}`);
                  lines.push(`Scenes: ${issue.scenes}`);
                ...
                a.href = url;
                a.download = `${(project?.title || 'continuity').replace(/[^a-zA-Z0-9]/g, '_')}_continuity_report.txt`;
                a.click();
