...
export default function TermsOfService() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#07070e] via-[#0c0b18] to-[#07070a]  bg-background text-foreground relative" style={{ background: 'linear-gradient(135deg,#07070e 0%,#0c0b18 60%,#07070a 100%)' }}>
      <VSWatermark />
        ...
        <div className="space-y-10 text-sm leading-relaxed text-muted-foreground">
          ...
          <section>
            ...
            <p>
              ...
              refund must be submitted via email to{" "}              <a href="mailto:studiosvirelle@gmail.com" className="text-amber-400 hover:text-amber-300 underline">
          ...
          <section>
            ...
            <p>
              ...
              descriptive email to{" "}              <a href="mailto:studiosvirelle@gmail.com" className="text-amber-400 hover:text-amber-300 underline">
                studiosvirelle@gmail.com
              </a>{" "}
