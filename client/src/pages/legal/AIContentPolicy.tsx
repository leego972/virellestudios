    ...
    <div className="min-h-screen bg-background text-foreground" style={{ background: 'linear-gradient(135deg,#07070e 0%,#0c0b18 60%,#07070a 100%)' }}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-3xl font-bold tracking-tight gradient-text-gold">AI Content Policy</h1>
        </div>
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3 gradient-text-gold">1. Ownership of AI-Generated Content</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3 gradient-text-gold">2. AI Minor Protection System</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3 gradient-text-gold">3. Character Consistency and Face DNA</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3 gradient-text-gold">4. Content Moderation</h2>
            <p className="text-muted-foreground mb-3">
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3 gradient-text-gold">5. Third-Party AI Provider Policies</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3 gradient-text-gold">6. Disclosure of AI-Generated Content</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3 gradient-text-gold">7. Contact</h2>
            <p className="text-muted-foreground">
