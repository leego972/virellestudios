    ...
    <div className="min-h-screen bg-gradient-to-br from-[#07070e] via-[#0c0b18] to-[#07070a]  bg-background text-foreground" style={{ background: 'linear-gradient(135deg,#07070e 0%,#0c0b18 60%,#07070a 100%)' }}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-gold-shimmer text-gold-shimmer">Acceptable Use Policy</h1>
        </div>
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3 gradient-text-gold gradient-text-gold">Overview</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3 gradient-text-gold gradient-text-gold">Permitted Uses</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3 gradient-text-gold gradient-text-gold">Absolutely Prohibited — Zero Tolerance</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3 gradient-text-gold gradient-text-gold">Prohibited Uses</h2>
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3 gradient-text-gold gradient-text-gold">Minor Characters in Sensitive Scenes</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3 gradient-text-gold gradient-text-gold">Reporting Violations</h2>
            <p className="text-muted-foreground">
              To report a violation of this AUP, contact <a href="mailto:studiosvirelle@gmail.com" className="text-amber-400 hover:underline">studiosvirelle@gmail.com</a>. For urgent child safety concerns, contact NCMEC directly at 1-800-THE-LOST or CyberTipline.org.
            </p>
          </section>
