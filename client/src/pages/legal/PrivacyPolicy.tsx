      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              For privacy-related inquiries: <a href="mailto:studiosvirelle@gmail.com" className="text-primary hover:underline">studiosvirelle@gmail.com</a><br />For legal matters: <a href="mailto:studiosvirelle@gmail.com" className="text-primary hover:underline">studiosvirelle@gmail.com</a><br />For support: <a href="mailto:studiosvirelle@gmail.com" className="text-primary hover:underline">studiosvirelle@gmail.com</a>
            </p>
          </section>
