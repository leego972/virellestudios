...
const PRICING = [
  ...
  },
  {
    ...
    desc: "Full production pipeline with video generation. 1,500 credits/month included.",
    features: [
  ...
  },
  {
    ...
    desc: "Advanced production suite with VFX and API access. 5,000 credits/month included.",
    features: [
  ...
  },
  {
    ...
    desc: "Full enterprise power with no limits. 15,000 credits/month included.",
    features: [
