...
/* Gold watermark ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ large, fixed, perfectly centered, stays on screen while scrolling */
  ...
  return (
    <div className="min-h-screen text-white selection:bg-amber-500/30 relative" style={{ background: 'linear-gradient(135deg,#07070e 0%,#0c0b18 60%,#07070a 100%)' }}>
      <SiteHead
        ...
        description="Virelle Studios ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ script to screen in one platform. AI casting, scenes, scoring, VFX, distribution, and grant funding for indie filmmakers and major studios."
      ...
      {/* ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Navigation ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ */}
      ...
      <main>
        {/* ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ 1. Hero Section ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ */}
        <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xs text-white/30 mb-10 -mt-6 tracking-wide">
              7-day free trial ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· No credit card required ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Cancel anytime
            </p>
            ...
            {/* Product stats ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ verifiable platform facts */}
        ...
        {/* ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ 1.5 The Showrunner Showcase Proof ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ */}
          <section
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="flex justify-center mb-8">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/25 text-amber-400 text-xs font-semibold uppercase tracking-wider">
                  ...
                  Featured Showcase ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· The Showrunner
                </div>
              </div>

              {/* Headline */}
              <div className="text-center mb-10">
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter mb-5 leading-tight gradient-text-gold">
              ...
              {/* Proof line ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ high-contrast quote card */}
              <div
        ...
        {/* ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ 1b. Platform Stats / Trust Strip ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ */}
        <section className="py-12 px-4 sm:px-6 lg:px-8 border-y border-white/[0.06] bg-white/[0.015]">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10 text-center mb-8">
              {([
                { stat: "5+",   label: "AI video providers",   sub: "Runway ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Sora ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Veo3 ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Kling ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· fal.ai" },
        ...
        {/* ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ 2. How It Works ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ */}
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold tracking-tight gradient-text-gold">
                Concept to Complete Film ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ{" "}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                { step: "03", time: "3ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ8 hrs", title: "Scenes Generate", desc: "60ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ90 scenes rendered with clip chaining, voice acting, and an original score.", color: "blue" },
        ...
        {/* ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ 2b. Get Your API Keys ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ provider shortcuts ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ */}
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="mt-3 text-sm text-white/50 max-w-xl mx-auto">
                Register, grab your keys from the links below, paste them in Settings ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ API Keys. You pay the AI providers directly at cost ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ no Virelle markup.
              </p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {([
                { name: "fal.ai",         tag: "Video ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Recommended",  note: "~$0.40/clip ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Fastest setup",       url: "https://fal.ai/dashboard/keys",                   color: "emerald", required: false },
                { name: "ElevenLabs",     tag: "Voice & SFX ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Required", note: "Free tier ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ required for all sound", url: "https://elevenlabs.io/app/settings/api-keys",   color: "violet",  required: true  },
                { name: "Runway",         tag: "Video ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Premium",       note: "~$0.50/clip ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Cinematic quality",   url: "https://app.runwayml.com/settings",               color: "blue",    required: false },
                { name: "OpenAI",         tag: "Script Writing",        note: "~$0.01/scene ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· GPT-4o",            url: "https://platform.openai.com/api-keys",            color: "amber",   required: false },
            ...
            <p className="text-center text-xs text-white/20 mt-6">
              Keys are stored encrypted and never shared. Add or update them anytime in Settings ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ API Keys.
            </p>
          </div>
        </section>

        {/* ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ 3. Two Core Use Cases ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ */}
              ...
              <Card className="bg-white/[0.03] border-white/10 hover:border-amber-500/40 transition-all duration-300 group overflow-hidden glass-card shadow-lg shadow-amber-500/5">
                ...
                <CardContent className="p-8 glass-card shadow-lg shadow-amber-500/5">
                  ...
                  <p className="text-sm text-white/60 leading-relaxed mb-6">
                    Describe your movie concept and Virelle generates the entire film ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ screenplay, 60ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ90 cinematic scenes with clip chaining, AI voice-acted dialogue, original soundtrack, and scene-to-scene continuity.
                  </p>
                  <div className="space-y-3 mb-8">
                    {["Up to 90-minute feature films", "4ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ8 AI video clips per scene, stitched seamlessly", "AI voice acting for all dialogue with 35 emotions", "AI-generated film score matched to every scene", "Character consistency across all scenes via DNA Lock"].map(f => (
        ...
        {/* ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ 3b. Signature Cast Teaser ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ */}
        <section className="py-24 px-4 sm:px-6 lg:px-8 bg-black border-t border-white/10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4 gradient-text-gold">
        ...
        {/* ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ 4. Key Differentiators ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ */}
        <section className="py-24 px-4 sm:px-6 lg:px-8 bg-black">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold tracking-tight gradient-text-gold">Professional Infrastructure.</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="p-8 rounded-3xl border border-white/10 bg-white/[0.02]">
                ...
                <p className="text-sm text-white/50 leading-relaxed">Your AI keys, your costs. Connect fal.ai, Runway, ElevenLabs, OpenAI and more ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Virelle orchestrates them without any markup. You pay providers directly.counts (Runway, Sora, fal.ai) for zero markup on generation costs.</p>
              </div>
              <div className="p-8 rounded-3xl border border-white/10 bg-white/[0.02]">
                ...
                {/* ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ 4b. Clips are not a production ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ */}
            ...
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-white/50 max-w-2xl mx-auto text-sm leading-relaxed">
                  AI video generators can create individual shots. Virelle is built for the full production workflow ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ story, cast, scene continuity, trailer structure, poster direction, music notes, funding targets, and export-ready production packages.
                </p>
              </div>
        ...
        {/* ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ 4c. What filmmakers build ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ */}
          <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/[0.015] border-t border-white/10">
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-12">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold tracking-tight gradient-text-gold">What filmmakers build here</h2>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  {
                    type: "Indie Short",
                    tag: "5ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ12 min",
                    ring: false,
                  ...
                  {
                    type: "Series Pilot",
                    tag: "22ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ45 min",
                    ring: true,
                  ...
                  },
                  {
                    ...
                    tag: "15ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ60 sec",
                    ring: false,
            ...
            {/* ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ 5. Pricing Preview ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ */}
        <section id="pricing" className="py-24 px-4 sm:px-6 lg:px-8 bg-white/[0.02] border-t border-white/10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="mt-3 text-sm text-white/50">7-day free trial on all plans. Bring your own API keys ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ you pay providers directly, no markup.</p>
            </div>
            ...
            <div className="text-center mt-6">
              <button onClick={() => setLocation("/pricing")} className="text-sm font-bold text-amber-400 hover:text-amber-300 transition-colors">
                View Full Pricing & Feature Comparison ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ
              </button>
            </div>
          </div>
        </section>

        {/* ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ 6. Download App Section ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ */}
        <section className="py-24 px-4 sm:px-6 lg:px-8 border-t border-white/10 bg-black">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white/60 mb-10 max-w-xl mx-auto">
              The full Virelle Studios experience on iOS and Android. Monitor renders, review scenes, manage projects, and export ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ all from your phone.
            </p>
            ...
            <p className="text-xs text-white/30 mt-6">7-day free trial included. Connect your own AI keys (fal.ai, ElevenLabs, OpenAI, etc.) ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Virelle never charges you for AI usage.</p>
          </div>
        </section>

        {/* ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ 7. FAQ ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ */}
        <section className="py-24 px-4 sm:px-6 lg:px-8 border-t border-white/10 bg-black">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold tracking-tight gradient-text-gold">Frequently Asked Questions</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                { title: "How long does it take?", answer: "A full 90-minute film takes 4ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ8 hours to generate from a written concept. Individual scenes generate in 3ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ6 minutes each." },
                ...
                { title: "Is there a mobile app?", answer: "Yes ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Virelle Studios for iOS is live on the App Store. The Android app and a native desktop client are in active development. Your subscription works across every platform, and the web app at virelle.life is fully responsive in the meantime." },
              ].map(q => (
                <div key={q.title}>
          ...
          {/* ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Lamalo Virtual Wardrobe ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ */}
            ...
            <div className="relative z-10 max-w-6xl mx-auto">
              ...
              <div className="flex justify-center mb-6">
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/25 text-amber-400 text-xs font-black uppercase tracking-widest">
                  ...
                  Lamalo Fashion ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ In-House Virtual Label
                </div>
              </div>

              {/* Main headline */}
              <div className="text-center mb-16">
                <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tighter leading-none mb-6 gradient-text-gold">
                  Clothing built <br />
                ...
                <p className="text-base sm:text-lg text-white/50 max-w-2xl mx-auto leading-relaxed">
                  ...
                  and it works ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ once. By scene 40, that jacket has drifted to burgundy. By scene 60, it's maroon. By scene 80, it's gone.
                ...
                {[
                  {
                    ...
                    body: "Every Lamalo item ships with a precise visual specification ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ fabric, cut, silhouette, and exact colour ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ baked directly into the generation pipeline. The AI isn't guessing. It knows exactly what it's supposed to render.",
                    accent: "amber",
                  },
                  {
                    icon: "ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¨",
                    title: "Each colour is a separate purchase",
                    body: "A white tee and a black tee are two distinct items in the catalogue. When you assign a colour to a character, the AI locks that exact shade across every scene they appear in ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ no drift, no interpretation, no surprises.",
                    accent: "purple",
                  },
                  {
                    icon: "ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¬",
                    title: "Automatic scene-to-scene continuity",
                    body: "Assign an outfit to a character and it follows them through the entire film. Scene 3 to scene 87 ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ same jacket, same colour, same fit. Our pipeline injects a Costume Lock into every generation call so the AI never forgets.",
                    accent: "blue",
                  },
                ].map((p) => (
                  <div
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                  {/* Left ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ copy */}
                  <div className="p-8 md:p-10 flex flex-col justify-center">
                    <p className="text-xs font-black uppercase tracking-widest text-amber-400/60 mb-3">23 collections ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· 1,400+ items</p>
                    ...
                    <p className="text-sm text-white/50 leading-relaxed mb-6">
                      Everyday basics, performance sport (soccer, basketball, hockey, AFL, football), formalwear, swimwear, footwear, eyewear, watches, and accessories ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ each piece AI-designed and pre-tested for consistent on-screen rendering across skin tones and lighting conditions.
                    </p>
                  ...
                  {/* Right ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ item sample grid */}
                  <div className="border-t md:border-t-0 md:border-l border-amber-500/10 p-6 grid grid-cols-3 gap-2 content-start">
                    {[
                      { label: "Menswear", tag: "Shirts ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Trousers ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Footwear", color: "from-blue-900/40 to-blue-800/20" },
                      { label: "Womenswear", tag: "Dresses ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Blouses ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Footwear", color: "from-purple-900/40 to-purple-800/20" },
                      { label: "Kids / Teens", tag: "All ages ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Footwear included", color: "from-teal-900/40 to-teal-800/20" },
                      { label: "Costume / Professional", tag: "Police ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Nurse ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Firefighter ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Ambo", color: "from-orange-900/40 to-orange-800/20" },
                      { label: "Accessories", tag: "Jewellery ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Sunglasses ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Handbags", color: "from-yellow-900/40 to-yellow-800/20" },
                    ].map((cat) => (
                      <div
                        key={cat.label}
              ...
              <div className="rounded-2xl border border-white/8 bg-white/[0.02] p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-white/45 leading-relaxed max-w-2xl">
                    Upload your collection to the Virelle marketplace and we run every item through the same production-grade optimisation process ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ reference prompt calibration, colour variant separation, and scene continuity integration. Your customers get the same locked, drift-free results as Lamalo. Premium rendering, your brand.
                  </p>
                </div>
                <button
                  onClick={() => setLocation("/designer-register")}
                ...
                >
                  ...
                  {/* ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ 7.5 ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Founding Designer Partner Program ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ */}
            ...
            <div className="relative z-10 max-w-6xl mx-auto">
              ...
              <div className="text-center mb-16">
                <div className="inline-flex items-center gap-2 bg-amber-500/15 border border-amber-500/40 rounded-full px-4 py-1.5 text-amber-400 text-xs font-black uppercase tracking-widest mb-6">
                  {foundingStatus?.foundingActive === false
                      ? "ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Founding Program Closed ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Now Standard Membership"
                      : foundingStatus?.spotsRemaining !== undefined
                        ? `ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Founding Partner ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ ${foundingStatus.spotsRemaining} of ${foundingStatus.totalSpots} spots left`
                        : "ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Limited ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Founding Designer Partner Program"}
                </div>
                ...
                <p className="text-lg text-white/50 max-w-2xl mx-auto leading-relaxed">
                  For the first group of approved designers, Virelle.life is offering an exclusive founding membership ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ
              ...
              <div className="flex justify-center mb-16">
                <div className="relative bg-gradient-to-br from-amber-500/10 to-amber-900/5 border border-amber-500/30 rounded-3xl px-16 py-10 text-center shadow-2xl shadow-amber-500/5">
                  ...
                  {foundingStatus?.foundingActive === false
                      ? "Standard annual membership ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Cancel anytime"
                      : "Founding price ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· First year only ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Renews at standard rate ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Cancel anytime"}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-16">
                {([
                  { icon: "ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ°", title: "50% Off First Year", desc: "A$150 instead of A$299 ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ your lowest cost to enter the marketplace ever." },
                  { icon: "ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ", title: "95% of Every Lease", desc: "Keep 95 cents from every dollar earned. Just a 5% platform commission." },
                  { icon: "ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ­ÃÂÃÂÃÂÃÂ", title: "Priority Placement", desc: "Founding designers appear first in the directory ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ ahead of all standard members." },
                  { icon: "ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¬", title: "Featured Spotlights", desc: "Your brand featured across Virelle.life campaigns and production newsletters." },
                  { icon: "ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ", title: "Pieces or Collections", desc: "Upload individual items or entire collections ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ mix and match as you like." },
                  { icon: "ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¤ÃÂÃÂÃÂÃÂ", title: "Early AI Access", desc: "First access to AI-assisted production briefs and automated wardrobe casting calls." },
                  { icon: "ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ", title: "Production Credits", desc: "Get credited when your pieces are used in eligible Virelle.life productions." },
                  { icon: "ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ", title: "Global Reach, Day One", desc: "Discoverable by film productions worldwide from the moment you publish." },
                ] as const).map((b) => (
              ...
              <div className="text-center mb-24">
                ...
                >
                Apply as Founding Partner ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ {foundingStatus?.foundingActive === false ? "A$299/yr" : "A$150/yr"}
                </Button>
                <p className="text-white/30 text-xs mt-4">
                  Limited spots ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· First come, first served ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ· Direct Stripe Connect bank payouts
                </p>
              </div>

              {/* For productions ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ compact divider */}
              <div className="border-t border-white/8 pt-16 flex flex-col sm:flex-row items-center justify-between gap-6">
                <div>
                  ...
                  <p className="text-white/40 text-sm mt-1">
                    Lease designer collections ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ they appear in your characters for AI scene generation.
                  </p>
                </div>
                <Button
                  onClick={() => setLocation("/wardrobe-marketplace")}
        ...
        {/* ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ 8. Final CTA ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ */}
        <section className="relative py-32 px-4 sm:px-6 lg:px-8 overflow-hidden border-t border-white/10 bg-black">
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center">
            <h2 className="text-4xl sm:text-6xl font-black tracking-tighter mb-8 gradient-text-gold">READY TO PRODUCE?</h2>
      ...
      <footer className="py-12 px-4 sm:px-6 lg:px-8 border-t border-white/10 bg-black">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <p className="text-[10px] text-white/30 font-medium">ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ© 2026 Virelle Studios. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
