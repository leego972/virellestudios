      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 space-y-20">
        ...
        <section>
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold mb-3 gradient-text-gold">ÃÂ°ÃÂÃÂÃÂ± Mobile App</h2>
        ...
        <section>
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold mb-3 gradient-text-gold">ÃÂ°ÃÂÃÂÃÂ¥ÃÂ¯ÃÂ¸ÃÂ Desktop App</h2>
