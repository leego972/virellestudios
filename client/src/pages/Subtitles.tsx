        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="mb-6 border border-border/50 bg-background/50">
              <TabsTrigger value="standard" className="gap-2 text-xs data-[state=active]:text-amber-400">
                <Captions className="h-3.5 w-3.5" />Standard Subtitles
              </TabsTrigger>
              <TabsTrigger value="deaf" className="gap-2 text-xs data-[state=active]:text-amber-400">
              ...
              <TabsTrigger value="signlanguage" className="gap-2 text-xs data-[state=active]:text-amber-400">
