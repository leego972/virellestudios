...
export default function FilmPage() {
  ...
  // Phase 2: Related films from the showcase (no input ÃÂ¢ÃÂÃÂ slice client-side)
  ...
  useEffect(() => {
    ...
    const title = fp.title || "Film ÃÂ¢ÃÂÃÂ VirElle Studios";
    ...
    document.title = `${title} ÃÂ¢ÃÂÃÂ VirElle Studios`;
    ...
    <div className="min-h-screen text-white" style={{ background:"linear-gradient(135deg,#07070e 0%,#0c0b18 60%,#07070a 100%)" }}>
      ...
      {!fp.isPublic && (
        <div className="sticky top-0 z-50 flex items-center justify-center gap-2 bg-amber-500 text-black text-sm font-semibold py-2 px-4">
          ...
          <Badge className="bg-black text-amber-400 text-xs">Draft ÃÂ¢ÃÂÃÂ not yet public</Badge>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-10 md:p-14 max-w-5xl">
          ...
          {fp.movieDuration && (
            <div className="flex items-center gap-1.5 text-xs text-zinc-500 mt-1.5">
              ...
              <span className="mx-1">ÃÂÃÂ·</span>
      ...
      {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ CONTENT ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
      <div className="max-w-4xl mx-auto px-4 py-8 sm:py-12 space-y-10">
        ...
        {fp.showCreatorName && fp.creatorName && (
          <div className="flex items-center gap-4 p-5 rounded-2xl bg-zinc-900/80 border border-zinc-800">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-zinc-500">Filmmaker ÃÂÃÂ· VirElle Studios</p>
            </div>
            {fp.creatorSlug && (
        ...
        {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Traffic Loop: Related Films ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
              ...
              {relatedFilms
                ...
                .map((f: any) => (
                  <Link key={f.slug} href={`/films/${f.slug}`}>
                    <Card className="bg-zinc-900 border-zinc-800 hover:border-zinc-600 transition-all hover:-translate-y-0.5 cursor-pointer overflow-hidden glass-card shadow-lg shadow-amber-500/5">
        ...
        {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Traffic Loop: Create your own CTA ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
        <div className="rounded-2xl border border-amber-500/20 bg-amber-500/5 p-6 sm:p-8 text-center space-y-4">
          ...
          <p className="text-zinc-400 text-sm max-w-md mx-auto">
            This film was made entirely with VirElle Studios ÃÂ¢ÃÂÃÂ AI-powered filmmaking from script to screen.
        ...
        <div className="flex items-center justify-between text-xs text-zinc-700 pt-2">
          <span>Made with VirElle Studios ÃÂÃÂ· AI-Generated Cinema</span>
          <a
      ...
      {/* MediaPlayer ÃÂ¢ÃÂÃÂ opens when Watch Film or a scene video is clicked */}
      {activeMedia && (
        <MediaPlayer
          movie={activeMedia}
          playlist={playlist}
