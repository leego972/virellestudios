      ...
      <div className="flex items-center justify-between px-2 md:px-4 py-2 md:py-2.5 border-b border-amber-500/20 bg-zinc-950/80 backdrop-blur shrink-0">
        ...
        <div className="flex items-center gap-1.5 md:gap-2 shrink-0">
          ...
          <Button
            size="sm"
            variant="outline"
            className="h-7 text-xs gap-1.5 hidden md:flex hover:border-amber-500/50 hover:text-amber-400"
            ...
            <div className="flex items-center gap-2 px-3 py-1.5 border-b border-amber-500/20 bg-zinc-900/60 shrink-0 overflow-x-auto">
              ...
              {activeCut && (
                <>
                  ...
                  {!activeCut.isLocked && (
                    <Button size="sm" variant="outline" className="h-6 text-xs px-2 shrink-0 border-emerald-500/40 text-emerald-400 hover:border-amber-500/50 hover:text-amber-400"
                  ...
                  <Button size="sm" variant="outline" className="h-6 text-xs px-2 shrink-0 border-violet-500/40 text-violet-400 hover:border-amber-500/50 hover:text-amber-400"
          ...
          <div className="flex items-center justify-between px-2 md:px-4 py-1.5 md:py-2 bg-zinc-950 border-b border-amber-500/20 shrink-0">
            ...
            <div className="flex items-center gap-1 md:gap-2">
              {isMobile && selectedScene && (
                <Button variant="outline" size="sm" className="h-6 text-[10px] gap-1 px-2 hover:border-amber-500/50 hover:text-amber-400" onClick={() => setMobileInspectorOpen(true)}>
              ...
              >
                ...
                {scenes.length === 0 ? (
                  <div className="flex flex-col items-center justify-center w-full gap-2 text-zinc-600 py-8">
                    ...
                    <Button size="sm" variant="outline" className="text-xs hover:border-amber-500/50 hover:text-amber-400" onClick={() => navigate(`/projects/${projectId}/scenes`)}>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <Button
                          size="sm"
                          variant="outline"
                          className="h-8 text-xs gap-1.5 hover:border-amber-500/50 hover:text-amber-400"
                          onClick={() => {
                        ...
                        <Button
                          size="sm"
                          variant="outline"
                          className="h-8 text-xs gap-1.5 text-red-400 hover:text-red-300 border-red-500/20 hover:border-red-500/40 hover:border-amber-500/50 hover:text-amber-400"
                  ...
                  {panelMode === "inspector" && (
                    <>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <Button size="sm" variant="outline" className="h-8 text-xs gap-1.5 hover:border-amber-500/50 hover:text-amber-400" onClick={() => navigate(`/projects/${projectId}/scenes`)}>
                          <Settings2 className="w-3 h-3" /> Edit
                        </Button>
                        <Button size="sm" variant="outline" className="h-8 text-xs gap-1.5 hover:border-amber-500/50 hover:text-amber-400" onClick={() => duplicateScene(selectedIdx!)}>
                          <Copy className="w-3 h-3" /> Duplicate
                        </Button>
                        <Button size="sm" variant="outline" className="h-8 text-xs gap-1.5 text-red-400 border-red-500/20 hover:border-amber-500/50 hover:text-amber-400" onClick={() => setDeleteConfirmIdx(selectedIdx!)}>
