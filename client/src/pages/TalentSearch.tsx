import { useState, useEffect } from "react";
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Pricing constants (mirrors server config) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Actor roster ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  const SIGNATURE_CAST = [
    // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ MALE LEADS ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    {
      id: "julian-vance",
      name: "Julian Vance",
      tier: "flagship",
      ...
      age: "32ÃÂ¢ÃÂÃÂ42",
      build: "Lean, 6'1\"",
      hair: "Dark, worn longer ÃÂ¢ÃÂÃÂ swept or loose",
      eyes: "Grey-green",
    ...
    },
    {
      ...
      age: "35ÃÂ¢ÃÂÃÂ48",
      build: "Average build. The kind of person you'd forget in a crowd ÃÂ¢ÃÂÃÂ intentionally.",
    ...
    // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ FEMALE LEADS ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    {
      ...
      age: "28ÃÂ¢ÃÂÃÂ42",
      build: "Tall, composed. 5'10\"",
      hair: "Platinum blonde, severe ÃÂ¢ÃÂÃÂ always intentional",
      eyes: "Ice blue",
      ...
      signatureScenes: ["The board meeting takeover", "When she finally smiles ÃÂ¢ÃÂÃÂ and it's worse", "The moment she decides"],
    ...
    },
    {
      ...
      age: "25ÃÂ¢ÃÂÃÂ38",
      build: "Graceful, expressive. 5'7\"",
      hair: "Dark, wavy ÃÂ¢ÃÂÃÂ often loose",
      eyes: "Warm brown",
    ...
    },
    {
      ...
      hair: "Black, straight ÃÂ¢ÃÂÃÂ cut with geometric precision",
      ...
      technicalNotes: "Works best in clean, minimalist lighting. Strong in static locked shots ÃÂ¢ÃÂÃÂ movement is purposeful.",
    ...
    // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ CHARACTER ACTORS ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    {
      id: "viktor-vale",
      name: "Viktor Vale",
      tier: "premium",
    ...
    // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ TWIN UNIT ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    {
      id: "gallagher-twins",
      ...
      age: "25ÃÂ¢ÃÂÃÂ35",
      build: "Same frame. Different energy entirely.",
      hair: "Auburn, but styled differently ÃÂ¢ÃÂÃÂ that's the first clue",
      eyes: "Hazel ÃÂ¢ÃÂÃÂ the tell is in what they do with them",
      ...
      emotionalRange: "Identical faces carrying completely opposite souls ÃÂ¢ÃÂÃÂ the dramatic engine is the gap between them",
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Plan ÃÂ¢ÃÂÃÂ tier access (mirrors server) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  ...
  const LICENSE_OPTIONS: { type: LicenseType; label: string; description: string }[] = [
    { type: "creator",    label: "Creator License",    description: "One public creator release ÃÂ¢ÃÂÃÂ indie film, YouTube, festival submission, or social release." },
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Accent colour helpers ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  ...
  // Actor portrait ÃÂ¢ÃÂÃÂ photorealistic with gradient fallback
  ...
  export default function TalentSearch() {
    ...
    // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Stripe checkout mutation ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    ...
    // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Handle Stripe return URL ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    useEffect(() => {
    ...
    return (
      <div className="min-h-screen bg-zinc-950 text-white">
        {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Unlock success banner ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
        {unlockSuccess && (
          ...
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-zinc-500">
                  {SIGNATURE_CAST.length} premium digital actors ÃÂÃÂ· Continuity-tuned ÃÂÃÂ· Promo-ready
                </p>
              </div>
              ...
              <div className="mb-3 flex items-center gap-2 text-xs">
                {actorsQuery.isLoading ? (
                  <span className="flex items-center gap-1.5 text-zinc-600">
                    <RefreshCw className="w-3.5 h-3.5 animate-spin" />Loading your access levelÃÂ¢ÃÂÃÂ¦
                  </span>
                ) : planAccess.length > 0 ? (
            ...
            <div className="flex flex-wrap gap-3">
              <div className="relative flex-1 min-w-[200px]">
                ...
                <Input placeholder="Search by name, archetype, nationality, or vibeÃÂ¢ÃÂÃÂ¦"
                  ...
                  <CardContent className="p-0 glass-card shadow-lg shadow-amber-500/5">
                    ...
                    <div className="p-4 space-y-2">
                      <div>
                        ...
                        <p className="text-xs text-zinc-500">{actor.nationality} ÃÂÃÂ· {actor.age}</p>
                      </div>
                      ...
                      <div className="flex gap-2 pt-1">
                        {state === "plan_included" || state === "unlocked" ? (
                          ...
                          <Button size="sm" className="flex-1 bg-zinc-800 hover:bg-amber-500/10 text-white text-xs font-semibold h-7 border border-white/10"
                            ...
                            <Lock className="w-3 h-3 mr-1" />Unlock ÃÂ¢ÃÂÃÂ A${basePrice}
                          </Button>
                        )}
        ...
        {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ UNLOCK MODAL ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
        {unlockActor && (
            ...
            <DialogContent className="bg-zinc-900 border border-white/10 text-white max-w-lg">
              ...
              <div className="space-y-5 mt-2">
                    ...
                    {LICENSE_OPTIONS.map((opt) => {
                      ...
                      return (
                        <button key={opt.type}
                          ...
                          {opt.type === "episodic" && <p className="text-xs text-zinc-600 mt-1">4ÃÂÃÂ single-project price</p>}
                        </button>
                      );
                    })}
                  </div>
                ...
                <div className="rounded-lg border border-white/5 bg-zinc-950/60 p-3 space-y-1.5">
                  ...
                  <div className="flex items-start gap-2 text-xs text-zinc-500">
                    <XCircle className="w-3.5 h-3.5 text-red-400 mt-0.5 shrink-0" />Pornography, explicit sex acts, adult-industry use ÃÂ¢ÃÂÃÂ strictly prohibited
                  </div>
                </div>
                ...
                {!user ? (
                  ...
                  <div className="flex gap-3">
                    <Button className="flex-1 bg-amber-500 hover:bg-amber-400 text-black font-semibold"
                      ...
                      {isCheckingOut ? "Opening checkoutÃÂ¢ÃÂÃÂ¦" : `License for Project ÃÂ¢ÃÂÃÂ A$${getPrice(unlockActor.tier, selectedLicense)}`}
                    </Button>
        ...
        {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ ACTOR PROFILE DIALOG ÃÂ¢ÃÂÃÂ Hollywood Casting Card ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
        {selectedActor && (
          <Dialog open={!!selectedActor} onOpenChange={() => setSelectedActor(null)}>
            <DialogContent className="bg-zinc-950 border border-white/8 text-white max-w-4xl max-h-[95vh] overflow-y-auto p-0">
              ...
              {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Hero Section: Portrait + Identity Banner ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
              <div className="relative">
                {/* Hero Portrait */}
              ...
              {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Body Content ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
              <div className="px-6 pb-8 space-y-7 mt-2">

                {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ HOOK / Logline ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
                ...
                {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ PHYSICAL IDENTITY ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
                <div>
                ...
                {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ SCREEN PRESENCE / PERFORMANCE PROFILE ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
                <div>
                ...
                {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ SIGNATURE SCENES ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
                    ...
                    <div className="space-y-2">
                      {(selectedActor.signatureScenes as string[]).map((scene: string) => (
                        <div key={scene} className="flex items-start gap-3 rounded-lg bg-zinc-900/40 border border-white/5 px-4 py-2.5">
                          <span className={`text-lg ${selectedAccent?.text ?? "text-amber-400"} leading-none mt-0.5`}>ÃÂ¢ÃÂÃÂº</span>
                ...
                {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ GENRES + BEST FOR ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
                <div>
                ...
                {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ CHEMISTRY / PAIRINGS ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
                ...
                {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ IDENTITY CONSISTENCY NOTE ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
                <div className={`rounded-xl border ${selectedAccent?.border ?? "border-amber-500/20"} ${selectedAccent?.bg ?? "bg-amber-500/5"} p-4`}>
                  ...
                  <p className="text-sm text-zinc-400 leading-relaxed">
                    ...
                    Character names, roles, and costumes may change ÃÂ¢ÃÂÃÂ the actor's face, build, and physical signature remain locked.
                    This enables coherent multi-scene and series-level casting with no continuity drift.
                  </p>
                </div>

                {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ SUPPORTING PORTRAIT GALLERY ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
                        ...
                        <div key={variant} className="space-y-1.5">
                          <div className="aspect-[3/4] rounded-lg overflow-hidden bg-zinc-900 border border-white/5">
                            <img
                              ...
                              alt={`${selectedActor.name} ÃÂ¢ÃÂÃÂ ${variant}`}
                              className="w-full h-full object-cover object-top"
                ...
                {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ LICENSING / ACCESS ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
                <div>
                    ...
                    <div className="px-5 py-4 border-b border-white/5">
                      {getEntitlementState(selectedActor) === "plan_included" ? (
                        ...
                        <div className="flex items-center gap-2 text-amber-400">
                          ...
                          <p className="text-sm font-medium">Individually unlocked ÃÂ¢ÃÂÃÂ ready to cast</p>
                        </div>
                      ) : (
                        <div className="flex items-center gap-2 text-zinc-400">
                          <Lock className="w-4 h-4 shrink-0" />
                          <p className="text-sm">Requires unlock ÃÂÃÂ· from <span className="text-white font-semibold">A${BASE_PRICE[selectedActor.tier]}</span></p>
                        </div>
                      )}
                    </div>
                ...
                {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ CTA BUTTONS ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
                <div className="flex gap-3 pt-1">
                  {getEntitlementState(selectedActor) === "plan_included" || getEntitlementState(selectedActor) === "unlocked" ? (
                    ...
                    <Button className="flex-1 bg-[#D4AF37] hover:bg-[#b8960c] text-black font-semibold"
                      ...
                      Unlock Actor ÃÂ¢ÃÂÃÂ from A${BASE_PRICE[selectedActor.tier]}
                    </Button>
                  )}
