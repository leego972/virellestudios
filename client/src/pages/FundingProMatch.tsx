  ...
  return (
    <div className="min-h-screen pb-10" style={{ background:"linear-gradient(135deg,#07070e 0%,#0c0b18 60%,#07070a 100%)" }}>
      ...
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-2xl font-bold gradient-text-gold">Funding — Pro Match & Tracker</h1>
        ...
        {draft && (
          <div className="space-y-2">
            {Object.entries(draft).map(([k, v]: [string, any]) => (
              <div key={k}><Label className="text-xs uppercase tracking-wider text-muted-foreground">{k.replace(/([A-Z])/g, " $1")}</Label>
