import { useState, useEffect } from "react";
  ...
  export default function SmallBusinessesPage() {
    ...
    const handleCta = () => {
      ...
      const dest = `/register?utm_source=${utm.utmSource ?? "small-business-video"}&utm_medium=${utm.utmMedium ?? "landing"}&utm_campaign=${utm.utmCampaign ?? "small-business-video-beta"}&utm_content=hero_cta`;
...
without the agency price tag
          ...
          <p className="text-xl text-neutral-400 max-w-2xl mx-auto mb-10">
            VirÉlle Studios gives small businesses the same video production power as Fortune 500 brands — at a fraction of the cost. Create TV commercials, social ads, and product demos yourself.
          </p>
        ...
        <section className="px-6 py-16 max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div key={0} className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 hover:border-neutral-700 transition-colors">
              ...
              <h3 className="font-semibold text-white mb-2">TV Commercials</h3>
              <p className="text-sm text-neutral-400">Produce broadcast-quality 30-second TV spots with AI-generated visuals, voiceover, and music.</p>
            </div>
            ...
            <div key={1} className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 hover:border-neutral-700 transition-colors">
              ...
              <h3 className="font-semibold text-white mb-2">Social Media Ads</h3>
              <p className="text-sm text-neutral-400">Create scroll-stopping Instagram, TikTok, and Facebook video ads in minutes — not days.</p>
            </div>
            ...
            <div key={2} className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 hover:border-neutral-700 transition-colors">
              ...
              <h3 className="font-semibold text-white mb-2">Product Demo Videos</h3>
              <p className="text-sm text-neutral-400">Show your product in action with cinematic demo videos that convert browsers into buyers.</p>
            </div>
          </div>
        </section>
        ...
        <section className="px-6 py-16 bg-neutral-900/50">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-5xl font-bold text-amber-500 my-6">$8,500/year saved</p>
            <p className="text-lg text-neutral-400">vs. hiring a local video production company for 6 ads per year at market rate.</p>
          </div>
        </section>
