import { useState, useEffect } from "react";
  ...
  export default function CreativeAgenciesPage() {
    ...
    const handleCta = () => {
      ...
      const dest = `/register?utm_source=${utm.utmSource ?? "agencies"}&utm_medium=${utm.utmMedium ?? "landing"}&utm_campaign=${utm.utmCampaign ?? "agencies-beta"}&utm_content=hero_cta`;
...
content for your clients
          ...
          <p className="text-xl text-neutral-400 max-w-2xl mx-auto mb-10">
            VirÉlle Studios is the unfair advantage for creative agencies. Generate campaign videos, brand films, social content, and TV spots in hours — not weeks. White-label ready.
          </p>
          ...
          <div className="flex items-center justify-center gap-6 text-sm text-neutral-500">
            ...
            <span className="flex items-center gap-1.5"><CheckCircle2 className="w-4 h-4 text-green-500" /> White-label ready</span>
          </div>
        </section>
        ...
        <section className="px-6 py-16 max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div key={0} className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 hover:border-neutral-700 transition-colors">
              ...
              <h3 className="font-semibold text-white mb-2">Campaign Video Factory</h3>
              <p className="text-sm text-neutral-400">Generate 30 unique video variations per campaign brief. A/B test messaging at zero marginal cost.</p>
            </div>
            ...
            <div key={1} className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 hover:border-neutral-700 transition-colors">
              ...
              <p className="text-sm text-neutral-400">Show clients exactly what their campaign will look like before you spend a dollar on production.</p>
            </div>
            ...
            <div key={2} className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 hover:border-neutral-700 transition-colors">
              ...
              <h3 className="font-semibold text-white mb-2">Multi-Format Delivery</h3>
              <p className="text-sm text-neutral-400">Export your video in every format and ratio — social, broadcast, digital OOH — simultaneously.</p>
            </div>
          </div>
        </section>
        ...
        <section className="px-6 py-16 bg-neutral-900/50">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-5xl font-bold text-amber-500 my-6">10× faster delivery</p>
            <p className="text-lg text-neutral-400">Agencies using VirÉlle ship video deliverables 10× faster than traditional production pipelines.</p>
          </div>
        </section>
