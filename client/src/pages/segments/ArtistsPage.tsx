import { useState, useEffect } from "react";
  ...
  export default function VisualArtistsPage() {
    ...
    const handleCta = () => {
      logEvent.mutate({ eventType: "cta_click", segment: SEGMENT, page: "/artists", ...utm });
      const dest = `/register?utm_source=${utm.utmSource ?? "artists"}&utm_medium=${utm.utmMedium ?? "landing"}&utm_campaign=${utm.utmCampaign ?? "artists-beta"}&utm_content=hero_cta`;
    ...
    const handleEmailSubmit = (e: React.FormEvent) => {
      e.preventDefault();
      if (!email) return;
      logEvent.mutate({ eventType: "signup", segment: SEGMENT, page: "/artists", metadata: { email }, ...utm });
      setSubmitted(true);
      ...
      <div className="min-h-screen bg-neutral-950 text-white">
        ...
        <section className="px-6 py-24 max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6">
            Turn your art into
cinematic films — instantly
          </h1>
          <p className="text-xl text-neutral-400 max-w-2xl mx-auto mb-10">
            VirÉlle Studios gives visual artists a full AI film studio. Animate your illustrations, create portfolio reels, and produce studio-quality ads — all from your existing artwork.
          </p>
        ...
        <section className="px-6 py-16 max-w-5xl mx-auto">
          <h2 className="text-2xl font-bold text-center mb-12 text-neutral-100">Built for Visual Artists</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div key={0} className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 hover:border-neutral-700 transition-colors">
              ...
              <p className="text-sm text-neutral-400">Transform static illustrations into stunning cinematic sequences that stop thumbs and win clients.</p>
            </div>
            ...
            <div key={1} className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 hover:border-neutral-700 transition-colors">
              ...
              <h3 className="font-semibold text-white mb-2">Art-to-Ad Conversion</h3>
              <p className="text-sm text-neutral-400">Generate social media ads from your artwork in minutes. Instagram reels, TikTok clips, YouTube bumpers.</p>
            </div>
            ...
            <div key={2} className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 hover:border-neutral-700 transition-colors">
              ...
              <h3 className="font-semibold text-white mb-2">Commission Pitches</h3>
              <p className="text-sm text-neutral-400">Produce professional pitch videos for potential clients — show your style, not just tell it.</p>
            </div>
          </div>
        </section>
        ...
        <section className="px-6 py-16 bg-neutral-900/50">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-5xl font-bold text-amber-500 my-6">$12,000/year saved</p>
            <p className="text-lg text-neutral-400">vs. hiring a video production agency to produce 12 promo reels per year at market rate.</p>
          </div>
        </section>
