import { useState, useEffect } from "react";
  ...
  export default function ContentCreatorsPage() {
    ...
    const handleCta = () => {
      ...
      const dest = `/register?utm_source=${utm.utmSource ?? "creators"}&utm_medium=${utm.utmMedium ?? "landing"}&utm_campaign=${utm.utmCampaign ?? "creators-beta"}&utm_content=hero_cta`;
...
cinematic AI production
          ...
          <p className="text-xl text-neutral-400 max-w-2xl mx-auto mb-10">
            VirÉlle Studios gives YouTube creators, podcasters, and influencers a professional film studio in the browser. Create stunning intros, trailers, and brand deals content that stands out.
          </p>
        ...
        <section className="px-6 py-16 max-w-5xl mx-auto">
          <h2 className="text-2xl font-bold text-center mb-12 text-neutral-100">Built for Content Creators</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div key={1} className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 hover:border-neutral-700 transition-colors">
              ...
              <h3 className="font-semibold text-white mb-2">Sponsored Content</h3>
              <p className="text-sm text-neutral-400">Produce brand-deal content that satisfies sponsors and keeps your audience engaged — at scale.</p>
            </div>
            ...
            <div key={2} className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 hover:border-neutral-700 transition-colors">
              ...
              <h3 className="font-semibold text-white mb-2">Short Film Content</h3>
              <p className="text-sm text-neutral-400">Tell bigger stories. Create scripted short films and YouTube Originals-style content with AI.</p>
            </div>
          </div>
        </section>
        ...
        <section className="px-6 py-16 bg-neutral-900/50">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-neutral-400">vs. hiring a video editor and motion designer to produce regular channel content.</p>
          </div>
        </section>
