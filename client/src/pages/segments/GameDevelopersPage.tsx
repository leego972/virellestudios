import { useState, useEffect } from "react";
  ...
  export default function GameDevelopersPage() {
    ...
    const handleCta = () => {
      ...
      const dest = `/register?utm_source=${utm.utmSource ?? "game-trailers"}&utm_medium=${utm.utmMedium ?? "landing"}&utm_campaign=${utm.utmCampaign ?? "game-trailers-beta"}&utm_content=hero_cta`;
      ...
      <div className="min-h-screen bg-neutral-950 text-white">
        ...
        <section className="px-6 py-24 max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6">
            Cinematic game trailers that
actually sell your game
          </h1>
          <p className="text-xl text-neutral-400 max-w-2xl mx-auto mb-10">
            VirÉlle Studios helps indie game studios produce hype trailers, announcement teases, and publisher pitch videos — without a cinematics budget. From concept to cut in hours.
          </p>
          ...
          <div className="flex items-center justify-center gap-6 text-sm text-neutral-500">
            ...
            <span className="flex items-center gap-1.5"><CheckCircle2 className="w-4 h-4 text-green-500" /> Steam-ready trailers</span>
          </div>
        </section>
        ...
        <section className="px-6 py-16 max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div key={0} className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 hover:border-neutral-700 transition-colors">
              ...
              <h3 className="font-semibold text-white mb-2">Launch Trailers</h3>
              <p className="text-sm text-neutral-400">Generate cinematic launch trailers with your game's art style, music, and story — no motion capture required.</p>
            </div>
            ...
            <div key={1} className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 hover:border-neutral-700 transition-colors">
              ...
              <h3 className="font-semibold text-white mb-2">Publisher Pitch Decks</h3>
              <p className="text-sm text-neutral-400">Combine your gameplay footage with AI-generated pitch materials for investor and publisher meetings.</p>
            </div>
            ...
            <div key={2} className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 hover:border-neutral-700 transition-colors">
              ...
              <p className="text-sm text-neutral-400">Create mystery announcement trailers and community hype videos that drive wishlists on Steam.</p>
            </div>
          </div>
        </section>
        ...
        <section className="px-6 py-16 bg-neutral-900/50">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-neutral-400">vs. outsourcing a cinematic trailer to a game trailer studio for a typical indie title.</p>
          </div>
        </section>
