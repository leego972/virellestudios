    ...
    <div className="min-h-screen text-foreground" style={{ background:"linear-gradient(135deg,#07070e 0%,#0c0b18 60%,#07070a 100%)" }}>
            ...
            return (
              <div key={seg.id} id={seg.id} className={`flex flex-col ${isEven ? "lg:flex-row" : "lg:flex-row-reverse"} gap-10 items-start`}>
                ...
                <div className="flex-1">
                  ...
                  <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-gold-shimmer">{seg.title}</h2>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl font-bold mb-4 text-gold-shimmer">Not sure which plan fits your workflow?</h2>
