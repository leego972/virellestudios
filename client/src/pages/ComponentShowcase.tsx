          ...
          <section className="space-y-4">
            ...
            <Tabs defaultValue="account" className="w-full">
              <TabsList className="grid w-full grid-cols-1 sm:grid-cols-3">
                <TabsTrigger value="account" className="data-[state=active]:text-amber-400 data-[state=active]:border-amber-500/50">Account</TabsTrigger>
                <TabsTrigger value="password" className="data-[state=active]:text-amber-400 data-[state=active]:border-amber-500/50">Password</TabsTrigger>
              ...
              <CardContent className="pt-6">
                <div className="flex flex-wrap gap-4">
                  ...
                  <Drawer>
                    ...
                    <DrawerContent>
                      <DrawerHeader>
                        <DrawerTitle className="gradient-text-gold">Are you absolutely sure?</DrawerTitle>
                        <DrawerDescription>
