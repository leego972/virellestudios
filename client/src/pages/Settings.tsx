...
export default function Settings() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 p-4 md:p-6 min-h-screen" style={{ background:"linear-gradient(135deg,#07070e 0%,#0c0b18 60%,#07070a 100%)" }}>
      ...
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold flex items-center gap-3 text-gold-shimmer">
      ...
      <Tabs value={settingsTab} onValueChange={(v) => {
        ...
        <TabsContent value="profile" className="space-y-6 mt-6">
          ...
          {/* Adult Studio verification is handled only by the dedicated identity gate. */}
        ...
        <TabsContent value="security" className="space-y-6 mt-6">
          ...
          <Card className="border-muted glass-card shadow-lg shadow-amber-500/5 hover:shadow-amber-500/20 transition-shadow">
        ...
        <TabsContent value="api-keys" className="space-y-6 mt-6">
          ...
          <Card className="border-amber-500/30 bg-gradient-to-br from-amber-500/10 to-amber-600/5 glass-card shadow-lg shadow-amber-500/5 hover:shadow-amber-500/20 transition-shadow">
            <CardHeader>
          ...
          <Card className="border-purple-500/30 bg-gradient-to-br from-purple-500/10 to-purple-600/5 glass-card shadow-lg shadow-amber-500/5 hover:shadow-amber-500/20 transition-shadow">
            <CardHeader>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Powers script writing, scene breakdowns, the Director's Assistant chat, and acts as a graceful storyboard fallback when video providers fail. <strong className="text-amber-300">Venice AI is preferred</strong> — it's tried before any other LLM provider.
            </p>
            <Card className="border from-violet-500/20 to-purple-600/10 border-violet-500/30 bg-gradient-to-br glass-card shadow-lg shadow-amber-500/5 hover:shadow-amber-500/20 transition-shadow">
              <CardHeader className="pb-3">
          ...
          <div>
            ...
            <Card className="border from-amber-500/20 to-amber-600/10 border-amber-500/30 bg-gradient-to-br glass-card shadow-lg shadow-amber-500/5 hover:shadow-amber-500/20 transition-shadow">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  <CardTitle className="flex items-center gap-2 text-lg gradient-text-gold">
                    <span className="text-xl">🍌</span>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={s.n} className="flex gap-3 items-start">
                    ...
                    <p className="text-sm text-muted-foreground"><strong className="text-amber-300">{s.t}</strong> — {s.d}</p>
                  </div>
                ))}
              </div>
            </CardContent>
          ...
          {hasCastAccess && (
            <div className="pl-6 flex flex-wrap gap-1.5 pt-1">
              {planAccess.includes("standard") && (
                <Badge className="bg-amber-500/10 text-amber-400 border border-amber-500/20/30 text-xs">Standard</Badge>
              )}
