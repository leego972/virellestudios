...
const PROVIDER_ICONS: Record<string, string> = {
  runway: "ÃÂ°ÃÂÃÂÃÂ¬", fal: "ÃÂ¢ÃÂÃÂ¡", replicate: "ÃÂ°ÃÂÃÂÃÂ", openai: "ÃÂ°ÃÂÃÂ¤ÃÂ", luma: "ÃÂ°ÃÂÃÂÃÂ", huggingface: "ÃÂ°ÃÂÃÂ¤ÃÂ",
  elevenlabs: "ÃÂ°ÃÂÃÂÃÂÃÂ¯ÃÂ¸ÃÂ", suno: "ÃÂ°ÃÂÃÂÃÂµ", seedance: "ÃÂ°ÃÂÃÂÃÂ", google: "ÃÂ°ÃÂÃÂÃÂ", veo3: "ÃÂ°ÃÂÃÂÃÂ¥", did: "ÃÂ°ÃÂÃÂ§ÃÂ",
};
...
const COUNTRIES = [
  { code: "AF", name: "Afghanistan", flag: "ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂ«" },
  { code: "AL", name: "Albania", flag: "ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂ±" },
  { code: "DZ", name: "Algeria", flag: "ÃÂ°ÃÂÃÂÃÂ©ÃÂ°ÃÂÃÂÃÂ¿" },
  { code: "AD", name: "Andorra", flag: "ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂ©" },
  { code: "AO", name: "Angola", flag: "ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂ´" },
  { code: "AG", name: "Antigua and Barbuda", flag: "ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂ¬" },
  { code: "AR", name: "Argentina", flag: "ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂ·" },
  { code: "AM", name: "Armenia", flag: "ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂ²" },
  { code: "AU", name: "Australia", flag: "ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂº" },
  { code: "AT", name: "Austria", flag: "ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂ¹" },
  { code: "AZ", name: "Azerbaijan", flag: "ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂ¿" },
  { code: "BS", name: "Bahamas", flag: "ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ¸" },
  { code: "BH", name: "Bahrain", flag: "ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ­" },
  { code: "BD", name: "Bangladesh", flag: "ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ©" },
  { code: "BB", name: "Barbados", flag: "ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ§" },
  { code: "BY", name: "Belarus", flag: "ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ¾" },
  { code: "BE", name: "Belgium", flag: "ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂª" },
  { code: "BZ", name: "Belize", flag: "ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ¿" },
  { code: "BJ", name: "Benin", flag: "ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ¯" },
  { code: "BT", name: "Bhutan", flag: "ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ¹" },
  { code: "BO", name: "Bolivia", flag: "ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ´" },
  { code: "BA", name: "Bosnia and Herzegovina", flag: "ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ¦" },
  { code: "BW", name: "Botswana", flag: "ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ¼" },
  { code: "BR", name: "Brazil", flag: "ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ·" },
  { code: "BN", name: "Brunei", flag: "ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ³" },
  { code: "BG", name: "Bulgaria", flag: "ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ¬" },
  { code: "BF", name: "Burkina Faso", flag: "ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ«" },
  { code: "BI", name: "Burundi", flag: "ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ®" },
  { code: "CV", name: "Cabo Verde", flag: "ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ»" },
  { code: "KH", name: "Cambodia", flag: "ÃÂ°ÃÂÃÂÃÂ°ÃÂ°ÃÂÃÂÃÂ­" },
  { code: "CM", name: "Cameroon", flag: "ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ²" },
  { code: "CA", name: "Canada", flag: "ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ¦" },
  { code: "CF", name: "Central African Republic", flag: "ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ«" },
  { code: "TD", name: "Chad", flag: "ÃÂ°ÃÂÃÂÃÂ¹ÃÂ°ÃÂÃÂÃÂ©" },
  { code: "CL", name: "Chile", flag: "ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ±" },
  { code: "CN", name: "China", flag: "ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ³" },
  { code: "CO", name: "Colombia", flag: "ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ´" },
  { code: "KM", name: "Comoros", flag: "ÃÂ°ÃÂÃÂÃÂ°ÃÂ°ÃÂÃÂÃÂ²" },
  { code: "CG", name: "Congo", flag: "ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ¬" },
  { code: "CR", name: "Costa Rica", flag: "ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ·" },
  { code: "HR", name: "Croatia", flag: "ÃÂ°ÃÂÃÂÃÂ­ÃÂ°ÃÂÃÂÃÂ·" },
  { code: "CU", name: "Cuba", flag: "ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂº" },
  { code: "CY", name: "Cyprus", flag: "ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ¾" },
  { code: "CZ", name: "Czech Republic", flag: "ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ¿" },
  { code: "DK", name: "Denmark", flag: "ÃÂ°ÃÂÃÂÃÂ©ÃÂ°ÃÂÃÂÃÂ°" },
  { code: "DJ", name: "Djibouti", flag: "ÃÂ°ÃÂÃÂÃÂ©ÃÂ°ÃÂÃÂÃÂ¯" },
  { code: "DM", name: "Dominica", flag: "ÃÂ°ÃÂÃÂÃÂ©ÃÂ°ÃÂÃÂÃÂ²" },
  { code: "DO", name: "Dominican Republic", flag: "ÃÂ°ÃÂÃÂÃÂ©ÃÂ°ÃÂÃÂÃÂ´" },
  { code: "EC", name: "Ecuador", flag: "ÃÂ°ÃÂÃÂÃÂªÃÂ°ÃÂÃÂÃÂ¨" },
  { code: "EG", name: "Egypt", flag: "ÃÂ°ÃÂÃÂÃÂªÃÂ°ÃÂÃÂÃÂ¬" },
  { code: "SV", name: "El Salvador", flag: "ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ»" },
  { code: "GQ", name: "Equatorial Guinea", flag: "ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ¶" },
  { code: "ER", name: "Eritrea", flag: "ÃÂ°ÃÂÃÂÃÂªÃÂ°ÃÂÃÂÃÂ·" },
  { code: "EE", name: "Estonia", flag: "ÃÂ°ÃÂÃÂÃÂªÃÂ°ÃÂÃÂÃÂª" },
  { code: "SZ", name: "Eswatini", flag: "ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ¿" },
  { code: "ET", name: "Ethiopia", flag: "ÃÂ°ÃÂÃÂÃÂªÃÂ°ÃÂÃÂÃÂ¹" },
  { code: "FJ", name: "Fiji", flag: "ÃÂ°ÃÂÃÂÃÂ«ÃÂ°ÃÂÃÂÃÂ¯" },
  { code: "FI", name: "Finland", flag: "ÃÂ°ÃÂÃÂÃÂ«ÃÂ°ÃÂÃÂÃÂ®" },
  { code: "FR", name: "France", flag: "ÃÂ°ÃÂÃÂÃÂ«ÃÂ°ÃÂÃÂÃÂ·" },
  { code: "GA", name: "Gabon", flag: "ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ¦" },
  { code: "GM", name: "Gambia", flag: "ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ²" },
  { code: "GE", name: "Georgia", flag: "ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂª" },
  { code: "DE", name: "Germany", flag: "ÃÂ°ÃÂÃÂÃÂ©ÃÂ°ÃÂÃÂÃÂª" },
  { code: "GH", name: "Ghana", flag: "ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ­" },
  { code: "GR", name: "Greece", flag: "ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ·" },
  { code: "GD", name: "Grenada", flag: "ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ©" },
  { code: "GT", name: "Guatemala", flag: "ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ¹" },
  { code: "GN", name: "Guinea", flag: "ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ³" },
  { code: "GW", name: "Guinea-Bissau", flag: "ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ¼" },
  { code: "GY", name: "Guyana", flag: "ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ¾" },
  { code: "HT", name: "Haiti", flag: "ÃÂ°ÃÂÃÂÃÂ­ÃÂ°ÃÂÃÂÃÂ¹" },
  { code: "HN", name: "Honduras", flag: "ÃÂ°ÃÂÃÂÃÂ­ÃÂ°ÃÂÃÂÃÂ³" },
  { code: "HU", name: "Hungary", flag: "ÃÂ°ÃÂÃÂÃÂ­ÃÂ°ÃÂÃÂÃÂº" },
  { code: "IS", name: "Iceland", flag: "ÃÂ°ÃÂÃÂÃÂ®ÃÂ°ÃÂÃÂÃÂ¸" },
  { code: "IN", name: "India", flag: "ÃÂ°ÃÂÃÂÃÂ®ÃÂ°ÃÂÃÂÃÂ³" },
  { code: "ID", name: "Indonesia", flag: "ÃÂ°ÃÂÃÂÃÂ®ÃÂ°ÃÂÃÂÃÂ©" },
  { code: "IR", name: "Iran", flag: "ÃÂ°ÃÂÃÂÃÂ®ÃÂ°ÃÂÃÂÃÂ·" },
  { code: "IQ", name: "Iraq", flag: "ÃÂ°ÃÂÃÂÃÂ®ÃÂ°ÃÂÃÂÃÂ¶" },
  { code: "IE", name: "Ireland", flag: "ÃÂ°ÃÂÃÂÃÂ®ÃÂ°ÃÂÃÂÃÂª" },
  { code: "IL", name: "Israel", flag: "ÃÂ°ÃÂÃÂÃÂ®ÃÂ°ÃÂÃÂÃÂ±" },
  { code: "IT", name: "Italy", flag: "ÃÂ°ÃÂÃÂÃÂ®ÃÂ°ÃÂÃÂÃÂ¹" },
  { code: "JM", name: "Jamaica", flag: "ÃÂ°ÃÂÃÂÃÂ¯ÃÂ°ÃÂÃÂÃÂ²" },
  { code: "JP", name: "Japan", flag: "ÃÂ°ÃÂÃÂÃÂ¯ÃÂ°ÃÂÃÂÃÂµ" },
  { code: "JO", name: "Jordan", flag: "ÃÂ°ÃÂÃÂÃÂ¯ÃÂ°ÃÂÃÂÃÂ´" },
  { code: "KZ", name: "Kazakhstan", flag: "ÃÂ°ÃÂÃÂÃÂ°ÃÂ°ÃÂÃÂÃÂ¿" },
  { code: "KE", name: "Kenya", flag: "ÃÂ°ÃÂÃÂÃÂ°ÃÂ°ÃÂÃÂÃÂª" },
  { code: "KI", name: "Kiribati", flag: "ÃÂ°ÃÂÃÂÃÂ°ÃÂ°ÃÂÃÂÃÂ®" },
  { code: "KW", name: "Kuwait", flag: "ÃÂ°ÃÂÃÂÃÂ°ÃÂ°ÃÂÃÂÃÂ¼" },
  { code: "KG", name: "Kyrgyzstan", flag: "ÃÂ°ÃÂÃÂÃÂ°ÃÂ°ÃÂÃÂÃÂ¬" },
  { code: "LA", name: "Laos", flag: "ÃÂ°ÃÂÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ¦" },
  { code: "LV", name: "Latvia", flag: "ÃÂ°ÃÂÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ»" },
  { code: "LB", name: "Lebanon", flag: "ÃÂ°ÃÂÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ§" },
  { code: "LS", name: "Lesotho", flag: "ÃÂ°ÃÂÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ¸" },
  { code: "LR", name: "Liberia", flag: "ÃÂ°ÃÂÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ·" },
  { code: "LY", name: "Libya", flag: "ÃÂ°ÃÂÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ¾" },
  { code: "LI", name: "Liechtenstein", flag: "ÃÂ°ÃÂÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ®" },
  { code: "LT", name: "Lithuania", flag: "ÃÂ°ÃÂÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ¹" },
  { code: "LU", name: "Luxembourg", flag: "ÃÂ°ÃÂÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂº" },
  { code: "MG", name: "Madagascar", flag: "ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ¬" },
  { code: "MW", name: "Malawi", flag: "ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ¼" },
  { code: "MY", name: "Malaysia", flag: "ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ¾" },
  { code: "MV", name: "Maldives", flag: "ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ»" },
  { code: "ML", name: "Mali", flag: "ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ±" },
  { code: "MT", name: "Malta", flag: "ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ¹" },
  { code: "MH", name: "Marshall Islands", flag: "ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ­" },
  { code: "MR", name: "Mauritania", flag: "ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ·" },
  { code: "MU", name: "Mauritius", flag: "ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂº" },
  { code: "MX", name: "Mexico", flag: "ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ½" },
  { code: "FM", name: "Micronesia", flag: "ÃÂ°ÃÂÃÂÃÂ«ÃÂ°ÃÂÃÂÃÂ²" },
  { code: "MD", name: "Moldova", flag: "ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ©" },
  { code: "MC", name: "Monaco", flag: "ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ¨" },
  { code: "MN", name: "Mongolia", flag: "ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ³" },
  { code: "ME", name: "Montenegro", flag: "ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂª" },
  { code: "MA", name: "Morocco", flag: "ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ¦" },
  { code: "MZ", name: "Mozambique", flag: "ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ¿" },
  { code: "MM", name: "Myanmar", flag: "ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ²" },
  { code: "NA", name: "Namibia", flag: "ÃÂ°ÃÂÃÂÃÂ³ÃÂ°ÃÂÃÂÃÂ¦" },
  { code: "NR", name: "Nauru", flag: "ÃÂ°ÃÂÃÂÃÂ³ÃÂ°ÃÂÃÂÃÂ·" },
  { code: "NP", name: "Nepal", flag: "ÃÂ°ÃÂÃÂÃÂ³ÃÂ°ÃÂÃÂÃÂµ" },
  { code: "NL", name: "Netherlands", flag: "ÃÂ°ÃÂÃÂÃÂ³ÃÂ°ÃÂÃÂÃÂ±" },
  { code: "NZ", name: "New Zealand", flag: "ÃÂ°ÃÂÃÂÃÂ³ÃÂ°ÃÂÃÂÃÂ¿" },
  { code: "NI", name: "Nicaragua", flag: "ÃÂ°ÃÂÃÂÃÂ³ÃÂ°ÃÂÃÂÃÂ®" },
  { code: "NE", name: "Niger", flag: "ÃÂ°ÃÂÃÂÃÂ³ÃÂ°ÃÂÃÂÃÂª" },
  { code: "NG", name: "Nigeria", flag: "ÃÂ°ÃÂÃÂÃÂ³ÃÂ°ÃÂÃÂÃÂ¬" },
  { code: "NO", name: "Norway", flag: "ÃÂ°ÃÂÃÂÃÂ³ÃÂ°ÃÂÃÂÃÂ´" },
  { code: "OM", name: "Oman", flag: "ÃÂ°ÃÂÃÂÃÂ´ÃÂ°ÃÂÃÂÃÂ²" },
  { code: "PK", name: "Pakistan", flag: "ÃÂ°ÃÂÃÂÃÂµÃÂ°ÃÂÃÂÃÂ°" },
  { code: "PW", name: "Palau", flag: "ÃÂ°ÃÂÃÂÃÂµÃÂ°ÃÂÃÂÃÂ¼" },
  { code: "PA", name: "Panama", flag: "ÃÂ°ÃÂÃÂÃÂµÃÂ°ÃÂÃÂÃÂ¦" },
  { code: "PG", name: "Papua New Guinea", flag: "ÃÂ°ÃÂÃÂÃÂµÃÂ°ÃÂÃÂÃÂ¬" },
  { code: "PY", name: "Paraguay", flag: "ÃÂ°ÃÂÃÂÃÂµÃÂ°ÃÂÃÂÃÂ¾" },
  { code: "PE", name: "Peru", flag: "ÃÂ°ÃÂÃÂÃÂµÃÂ°ÃÂÃÂÃÂª" },
  { code: "PH", name: "Philippines", flag: "ÃÂ°ÃÂÃÂÃÂµÃÂ°ÃÂÃÂÃÂ­" },
  { code: "PL", name: "Poland", flag: "ÃÂ°ÃÂÃÂÃÂµÃÂ°ÃÂÃÂÃÂ±" },
  { code: "PT", name: "Portugal", flag: "ÃÂ°ÃÂÃÂÃÂµÃÂ°ÃÂÃÂÃÂ¹" },
  { code: "QA", name: "Qatar", flag: "ÃÂ°ÃÂÃÂÃÂ¶ÃÂ°ÃÂÃÂÃÂ¦" },
  { code: "RO", name: "Romania", flag: "ÃÂ°ÃÂÃÂÃÂ·ÃÂ°ÃÂÃÂÃÂ´" },
  { code: "RU", name: "Russia", flag: "ÃÂ°ÃÂÃÂÃÂ·ÃÂ°ÃÂÃÂÃÂº" },
  { code: "RW", name: "Rwanda", flag: "ÃÂ°ÃÂÃÂÃÂ·ÃÂ°ÃÂÃÂÃÂ¼" },
  { code: "KN", name: "Saint Kitts and Nevis", flag: "ÃÂ°ÃÂÃÂÃÂ°ÃÂ°ÃÂÃÂÃÂ³" },
  { code: "LC", name: "Saint Lucia", flag: "ÃÂ°ÃÂÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ¨" },
  { code: "VC", name: "Saint Vincent and the Grenadines", flag: "ÃÂ°ÃÂÃÂÃÂ»ÃÂ°ÃÂÃÂÃÂ¨" },
  { code: "WS", name: "Samoa", flag: "ÃÂ°ÃÂÃÂÃÂ¼ÃÂ°ÃÂÃÂÃÂ¸" },
  { code: "SM", name: "San Marino", flag: "ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ²" },
  { code: "ST", name: "Sao Tome and Principe", flag: "ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ¹" },
  { code: "SA", name: "Saudi Arabia", flag: "ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ¦" },
  { code: "SN", name: "Senegal", flag: "ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ³" },
  { code: "RS", name: "Serbia", flag: "ÃÂ°ÃÂÃÂÃÂ·ÃÂ°ÃÂÃÂÃÂ¸" },
  { code: "SC", name: "Seychelles", flag: "ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ¨" },
  { code: "SL", name: "Sierra Leone", flag: "ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ±" },
  { code: "SG", name: "Singapore", flag: "ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ¬" },
  { code: "SK", name: "Slovakia", flag: "ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ°" },
  { code: "SI", name: "Slovenia", flag: "ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ®" },
  { code: "SB", name: "Solomon Islands", flag: "ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ§" },
  { code: "SO", name: "Somalia", flag: "ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ´" },
  { code: "ZA", name: "South Africa", flag: "ÃÂ°ÃÂÃÂÃÂ¿ÃÂ°ÃÂÃÂÃÂ¦" },
  { code: "SS", name: "South Sudan", flag: "ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ¸" },
  { code: "ES", name: "Spain", flag: "ÃÂ°ÃÂÃÂÃÂªÃÂ°ÃÂÃÂÃÂ¸" },
  { code: "LK", name: "Sri Lanka", flag: "ÃÂ°ÃÂÃÂÃÂ±ÃÂ°ÃÂÃÂÃÂ°" },
  { code: "SD", name: "Sudan", flag: "ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ©" },
  { code: "SR", name: "Suriname", flag: "ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ·" },
  { code: "SE", name: "Sweden", flag: "ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂª" },
  { code: "CH", name: "Switzerland", flag: "ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ­" },
  { code: "SY", name: "Syria", flag: "ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ¾" },
  { code: "TW", name: "Taiwan", flag: "ÃÂ°ÃÂÃÂÃÂ¹ÃÂ°ÃÂÃÂÃÂ¼" },
  { code: "TJ", name: "Tajikistan", flag: "ÃÂ°ÃÂÃÂÃÂ¹ÃÂ°ÃÂÃÂÃÂ¯" },
  { code: "TZ", name: "Tanzania", flag: "ÃÂ°ÃÂÃÂÃÂ¹ÃÂ°ÃÂÃÂÃÂ¿" },
  { code: "TH", name: "Thailand", flag: "ÃÂ°ÃÂÃÂÃÂ¹ÃÂ°ÃÂÃÂÃÂ­" },
  { code: "TL", name: "Timor-Leste", flag: "ÃÂ°ÃÂÃÂÃÂ¹ÃÂ°ÃÂÃÂÃÂ±" },
  { code: "TG", name: "Togo", flag: "ÃÂ°ÃÂÃÂÃÂ¹ÃÂ°ÃÂÃÂÃÂ¬" },
  { code: "TO", name: "Tonga", flag: "ÃÂ°ÃÂÃÂÃÂ¹ÃÂ°ÃÂÃÂÃÂ´" },
  { code: "TT", name: "Trinidad and Tobago", flag: "ÃÂ°ÃÂÃÂÃÂ¹ÃÂ°ÃÂÃÂÃÂ¹" },
  { code: "TN", name: "Tunisia", flag: "ÃÂ°ÃÂÃÂÃÂ¹ÃÂ°ÃÂÃÂÃÂ³" },
  { code: "TR", name: "Turkey", flag: "ÃÂ°ÃÂÃÂÃÂ¹ÃÂ°ÃÂÃÂÃÂ·" },
  { code: "TM", name: "Turkmenistan", flag: "ÃÂ°ÃÂÃÂÃÂ¹ÃÂ°ÃÂÃÂÃÂ²" },
  { code: "TV", name: "Tuvalu", flag: "ÃÂ°ÃÂÃÂÃÂ¹ÃÂ°ÃÂÃÂÃÂ»" },
  { code: "UG", name: "Uganda", flag: "ÃÂ°ÃÂÃÂÃÂºÃÂ°ÃÂÃÂÃÂ¬" },
  { code: "UA", name: "Ukraine", flag: "ÃÂ°ÃÂÃÂÃÂºÃÂ°ÃÂÃÂÃÂ¦" },
  { code: "AE", name: "United Arab Emirates", flag: "ÃÂ°ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂÃÂª" },
  { code: "GB", name: "United Kingdom", flag: "ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ§" },
  { code: "US", name: "United States", flag: "ÃÂ°ÃÂÃÂÃÂºÃÂ°ÃÂÃÂÃÂ¸" },
  { code: "UY", name: "Uruguay", flag: "ÃÂ°ÃÂÃÂÃÂºÃÂ°ÃÂÃÂÃÂ¾" },
  { code: "UZ", name: "Uzbekistan", flag: "ÃÂ°ÃÂÃÂÃÂºÃÂ°ÃÂÃÂÃÂ¿" },
  { code: "VU", name: "Vanuatu", flag: "ÃÂ°ÃÂÃÂÃÂ»ÃÂ°ÃÂÃÂÃÂº" },
  { code: "VE", name: "Venezuela", flag: "ÃÂ°ÃÂÃÂÃÂ»ÃÂ°ÃÂÃÂÃÂª" },
  { code: "VN", name: "Vietnam", flag: "ÃÂ°ÃÂÃÂÃÂ»ÃÂ°ÃÂÃÂÃÂ³" },
  { code: "YE", name: "Yemen", flag: "ÃÂ°ÃÂÃÂÃÂ¾ÃÂ°ÃÂÃÂÃÂª" },
  { code: "ZM", name: "Zambia", flag: "ÃÂ°ÃÂÃÂÃÂ¿ÃÂ°ÃÂÃÂÃÂ²" },
  { code: "ZW", name: "Zimbabwe", flag: "ÃÂ°ÃÂÃÂÃÂ¿ÃÂ°ÃÂÃÂÃÂ¼" },
];
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 p-4 md:p-6 min-h-screen" style={{ background:"linear-gradient(135deg,#07070e 0%,#0c0b18 60%,#07070a 100%)" }}>
      ...
      <Tabs value={settingsTab} onValueChange={(v) => {
        ...
        {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Profile Tab ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="h-9 text-sm bg-background/50 border border-input rounded-md px-3 w-full"
                  >
                    <option value="en">ÃÂ°ÃÂÃÂÃÂºÃÂ°ÃÂÃÂÃÂ¸ English</option>
                    <option value="he">ÃÂ°ÃÂÃÂÃÂ®ÃÂ°ÃÂÃÂÃÂ± ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¨ÃÂÃÂÃÂÃÂª (Hebrew)</option>
                    <option value="ar">ÃÂ°ÃÂÃÂÃÂ¸ÃÂ°ÃÂÃÂÃÂ¦ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¹ÃÂÃÂ±ÃÂÃÂ¨ÃÂÃÂÃÂÃÂ© (Arabic)</option>
                    <option value="fr">ÃÂ°ÃÂÃÂÃÂ«ÃÂ°ÃÂÃÂÃÂ· FranÃÂÃÂ§ais</option>
                    <option value="es">ÃÂ°ÃÂÃÂÃÂªÃÂ°ÃÂÃÂÃÂ¸ EspaÃÂÃÂ±ol</option>
                    <option value="de">ÃÂ°ÃÂÃÂÃÂ©ÃÂ°ÃÂÃÂÃÂª Deutsch</option>
                    <option value="zh">ÃÂ°ÃÂÃÂÃÂ¨ÃÂ°ÃÂÃÂÃÂ³ ÃÂ¤ÃÂ¸ÃÂ­ÃÂ¦ÃÂÃÂ (Chinese)</option>
                    <option value="ja">ÃÂ°ÃÂÃÂÃÂ¯ÃÂ°ÃÂÃÂÃÂµ ÃÂ¦ÃÂÃÂ¥ÃÂ¦ÃÂÃÂ¬ÃÂ¨ÃÂªÃÂ (Japanese)</option>
                    <option value="ko">ÃÂ°ÃÂÃÂÃÂ°ÃÂ°ÃÂÃÂÃÂ· ÃÂ­ÃÂÃÂÃÂªÃÂµÃÂ­ÃÂ¬ÃÂÃÂ´ (Korean)</option>
                    <option value="pt">ÃÂ°ÃÂÃÂÃÂ§ÃÂ°ÃÂÃÂÃÂ· PortuguÃÂÃÂªs</option>
                    <option value="ru">ÃÂ°ÃÂÃÂÃÂ·ÃÂ°ÃÂÃÂÃÂº ÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂºÃÂÃÂ¸ÃÂÃÂ¹</option>
                    <option value="hi">ÃÂ°ÃÂÃÂÃÂ®ÃÂ°ÃÂÃÂÃÂ³ ÃÂ ÃÂ¤ÃÂ¹ÃÂ ÃÂ¤ÃÂ¿ÃÂ ÃÂ¤ÃÂ¨ÃÂ ÃÂ¥ÃÂÃÂ ÃÂ¤ÃÂ¦ÃÂ ÃÂ¥ÃÂ (Hindi)</option>
                    <option value="tr">ÃÂ°ÃÂÃÂÃÂ¹ÃÂ°ÃÂÃÂÃÂ· TÃÂÃÂ¼rkÃÂÃÂ§e</option>
                    <option value="it">ÃÂ°ÃÂÃÂÃÂ®ÃÂ°ÃÂÃÂÃÂ¹ Italiano</option>
                  </select>
                </div>
                <div className="space-y-1.5">
            ...
            <CardContent>
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs text-muted-foreground">
                  Member since {profile?.createdAt ? new Date(profile.createdAt).toLocaleDateString() : "ÃÂ¢ÃÂÃÂ"}
                </span>
              </div>
            </CardContent>
          </Card>
        ...
        {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Security Tab ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Your API keys are encoded and stored securely. They are never exposed in the frontend ÃÂ¢ÃÂÃÂ only
        ...
        {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Billing Tab ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
        <TabsContent value="billing" className="space-y-6 mt-6">
          <BillingTab profile={profile} />
        </TabsContent>

        {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ API Keys Tab ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
        <TabsContent value="api-keys" className="space-y-6 mt-6">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Sign up with a video provider below. Your key is billed directly to you ÃÂ¢ÃÂÃÂ we never charge for API usage.</p>
                  </div>
                </div>
                <div className="flex gap-3">
            ...
            <CardContent>
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="p-4 rounded-lg border border-blue-500/20 bg-blue-500/5">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-2xl">ÃÂ¢ÃÂÃÂ¡</span>
                    <div>
          ...
          {/* Language Model (LLM) API Key ÃÂ¢ÃÂÃÂ Venice */}
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Powers script writing, scene breakdowns, the Director's Assistant chat, and acts as a graceful storyboard fallback when video providers fail. <strong className="text-foreground">Venice AI is preferred</strong> ÃÂ¢ÃÂÃÂ it's tried before any other LLM provider.
            </p>
            <Card className="border from-violet-500/20 to-purple-600/10 border-violet-500/30 bg-gradient-to-br glass-card shadow-lg shadow-amber-500/5">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  <CardTitle className="flex items-center gap-2 text-lg gradient-text-gold">
                    <span className="text-xl">ÃÂ°ÃÂÃÂÃÂ£</span>
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center gap-2 text-xs text-muted-foreground">
                  ...
                  <span className="mx-1">ÃÂ¢ÃÂÃÂ¢</span>
                  <span>Pricing: Pro plan includes API credits; pay-as-you-go available</span>
                </div>
                <div className="flex gap-2">
                  <Input type="password" placeholder={configuredKeys['venice' as keyof typeof configuredKeys] ? "ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢" : "Paste your Venice AI API key here..."} value={keyInputs['venice'] || ''} onChange={(e) => setKeyInputs((prev) => ({ ...prev, venice: e.target.value }))} className="font-mono text-sm" />
                ...
                return (
                  <Card key={provider.id} className={`border ${colorClass} bg-gradient-to-br`}>
                    <CardHeader className="pb-3">
                      <div className="flex items-center justify-between">
                        <CardTitle className="flex items-center gap-2 text-lg gradient-text-gold">
                          <span className="text-xl">{PROVIDER_ICONS[provider.id] || "ÃÂ°ÃÂÃÂÃÂ"}</span>
                          {provider.name}
                    ...
                    <CardContent className="space-y-3">
                      ...
                      <div className="flex gap-2">
                        <Input type="password" placeholder={isConfigured ? "ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢" : `Paste your ${provider.name} API key here...`} value={inputValue} onChange={(e) => setKeyInputs((prev) => ({ ...prev, [provider.id]: e.target.value }))} className="font-mono text-sm" />
          ...
          <div>
            ...
            <Card className="border from-amber-500/20 to-amber-600/10 border-amber-500/30 bg-gradient-to-br glass-card shadow-lg shadow-amber-500/5">
              <CardHeader className="pb-3">
                ...
                <CardDescription>Nano Banana 2 &amp; Nano Banana Pro ÃÂ¢ÃÂÃÂ Google's native image generation with accurate text rendering, photorealistic quality, and up to 4K resolution.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="flex items-center gap-2 text-xs text-muted-foreground">
                  <Info className="w-3 h-3" />
                ...
                <div className="flex gap-2">
                  <Input type="password" placeholder={configuredKeys['google' as keyof typeof configuredKeys] ? "ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢" : "Paste your Google Gemini API key here..."} value={keyInputs['google'] || ''} onChange={(e) => setKeyInputs((prev) => ({ ...prev, google: e.target.value }))} className="font-mono text-sm" />
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={s.n} className="flex gap-3 items-start">
                    ...
                    <p className="text-sm text-muted-foreground"><strong className="text-foreground">{s.t}</strong> ÃÂ¢ÃÂÃÂ {s.d}</p>
                  </div>
                ))}
              </div>
            </CardContent>
        ...
        {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Connected Platforms Tab ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ BillingTab Component ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
        ...
        <CardContent>
          <div className="flex items-center gap-3">
            <span className="text-2xl font-bold text-amber-400">
              {profile?.role === "admin" ? "ÃÂ¢ÃÂÃÂ" : (profile?.credits ?? 0).toLocaleString()}
            </span>
  ...
  return (
    <Card className="bg-card/50 glass-card shadow-lg shadow-amber-500/5">
      ...
      <CardContent className="space-y-4">
        ...
        {/* Individual licenses section ÃÂ¢ÃÂÃÂ live data */}
        ...
        <div className="rounded-lg border border-white/5 bg-zinc-950/40 p-3 space-y-1">
          ...
          <div className="flex items-start gap-2 text-xs text-zinc-600">
            ...
            Pornographic content, explicit sex acts, adult-industry use ÃÂ¢ÃÂÃÂ prohibited
          </div>
        </div>
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ ACTIVE TALENT LICENSES LIST (live tRPC data) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
          ...
          <div key={i} className="rounded-lg border border-white/5 bg-zinc-950/40 p-3 flex items-center justify-between gap-3">
            <div className="min-w-0">
              ...
              <p className="text-xs text-zinc-500">
                {e.licenseType} license{e.projectId ? ` ÃÂÃÂ· Project ${e.projectId}` : ""}
              </p>
            </div>
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {status?.lastError && (
                        <p className="text-xs text-red-400 mt-1">ÃÂ¢ÃÂÃÂ ÃÂ¯ÃÂ¸ÃÂ {status.lastError}</p>
                      )}
