          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {articles.map((article) => (
              <Link key={article.id} href={`/blog/${article.slug}`}>
                <article className="group glass-card/5 rounded-xl overflow-hidden border border-amber-500/20 hover:border-amber-500/30 transition-all hover:shadow-amber-500/20 hover:glass-card/[0.07] cursor-pointer h-full flex flex-col">
